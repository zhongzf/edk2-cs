...
public unsafe partial class EFI
{
  ...
  ///
  public static EFI_GUID EFI_PEI_RECOVERY_BLOCK_IO_PPI_GUID => new GUID(
...
public unsafe struct EFI_PEI_LBA { ulong Value; public static implicit operator EFI_PEI_LBA(ulong value) => new EFI_PEI_LBA() { Value = value }; public static implicit operator ulong(EFI_PEI_LBA value) => value.Value; }

///
/// EFI_PEI_BLOCK_DEVICE_TYPE
///
public enum EFI_PEI_BLOCK_DEVICE_TYPE
{
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PEI_BLOCK_IO_MEDIA
{
  ///
  /// The type of media device being referenced by DeviceIndex.
  ///
  public EFI_PEI_BLOCK_DEVICE_TYPE DeviceType;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PEI_RECOVERY_BLOCK_IO_PPI
{
  ///
  /// Gets the number of block I/O devices that the specific block driver manages.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PEI_RECOVERY_BLOCK_IO_PPI* /*This*/,/* OUT */ulong* /*NumberBlockDevices*/, EFI_STATUS> /*EFI_PEI_GET_NUMBER_BLOCK_DEVICES*/ GetNumberOfBlockDevices;

  ///
  /// Gets the specified media information.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PEI_RECOVERY_BLOCK_IO_PPI* /*This*/,/* IN */ulong /*DeviceIndex*/,/* OUT */EFI_PEI_BLOCK_IO_MEDIA* /*MediaInfo*/, EFI_STATUS> /*EFI_PEI_GET_DEVICE_MEDIA_INFORMATION*/ GetBlockDeviceMediaInfo;

  ///
  /// Reads the requested number of blocks from the specified block device.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PEI_RECOVERY_BLOCK_IO_PPI* /*This*/,/* IN */ulong /*DeviceIndex*/,/* IN */EFI_PEI_LBA /*StartLBA*/,/* IN */ulong /*BufferSize*/,/* OUT */void* /*Buffer*/, EFI_STATUS> /*EFI_PEI_READ_BLOCKS*/ ReadBlocks;
}
