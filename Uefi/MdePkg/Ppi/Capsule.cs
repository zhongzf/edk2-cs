...
public unsafe partial class EFI
{
  ...
  ///
  public static EFI_GUID EFI_PEI_CAPSULE_PPI_GUID => new GUID(
...
public unsafe struct EFI_PEI_CAPSULE_PPI
{
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN OUT */void** /*MemoryBase*/,/* IN OUT */ulong* /*MemSize*/, EFI_STATUS> /*EFI_PEI_CAPSULE_COALESCE*/ Coalesce;
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/, EFI_STATUS> /*EFI_PEI_CAPSULE_CHECK_CAPSULE_UPDATE*/ CheckCapsuleUpdate;
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */void* /*CapsuleBase*/,/* IN */ulong /*CapsuleSize*/, EFI_STATUS> /*EFI_PEI_CAPSULE_CREATE_STATE*/ CreateState;
}
