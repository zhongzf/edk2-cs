...
{
  public static EFI_GUID EFI_GET_PCD_INFO_PPI_GUID => new GUID(0xa60c6b59, 0xe459, 0x425d, 0x9c, 0x69, 0xb, 0xcc, 0x9c, 0xb2, 0x7d, 0x81);
...
public unsafe struct EFI_GET_PCD_INFO_PPI
{
  ///
  /// Retrieve additional information associated with a PCD.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* OUT */EFI_PCD_INFO* /*PcdInfo*/, EFI_STATUS> /*EFI_GET_PCD_INFO_PPI_GET_INFO*/ GetInfo;
  ///
  /// Retrieve the currently set SKU Id.
  ///
  public readonly delegate* unmanaged<EFI_STATUS> /*EFI_GET_PCD_INFO_PPI_GET_SKU*/ GetSku;
}
