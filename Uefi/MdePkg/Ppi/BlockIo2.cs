...
public unsafe partial class EFI
{
  ...
  ///
  public static EFI_GUID EFI_PEI_RECOVERY_BLOCK_IO2_PPI_GUID => new GUID(
  ...
  public const ulong EFI_PEI_RECOVERY_BLOCK_IO2_PPI_REVISION = 0x00010000;
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PEI_BLOCK_IO2_MEDIA
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PEI_RECOVERY_BLOCK_IO2_PPI
{
  ///
  ...
  ///
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PEI_RECOVERY_BLOCK_IO2_PPI* /*This*/,/* OUT */ulong* /*NumberBlockDevices*/, EFI_STATUS> /*EFI_PEI_GET_NUMBER_BLOCK_DEVICES2*/ GetNumberOfBlockDevices;

  ///
  /// Gets the specified media information.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PEI_RECOVERY_BLOCK_IO2_PPI* /*This*/,/* IN */ulong /*DeviceIndex*/,/* OUT */EFI_PEI_BLOCK_IO2_MEDIA* /*MediaInfo*/, EFI_STATUS> /*EFI_PEI_GET_DEVICE_MEDIA_INFORMATION2*/ GetBlockDeviceMediaInfo;

  ///
  /// Reads the requested number of blocks from the specified block device.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PEI_RECOVERY_BLOCK_IO2_PPI* /*This*/,/* IN */ulong /*DeviceIndex*/,/* IN */EFI_PEI_LBA /*StartLBA*/,/* IN */ulong /*BufferSize*/,/* OUT */void* /*Buffer*/, EFI_STATUS> /*EFI_PEI_READ_BLOCKS2*/ ReadBlocks;
}
