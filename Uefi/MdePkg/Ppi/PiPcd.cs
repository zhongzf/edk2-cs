...
{
  public static EFI_GUID EFI_PEI_PCD_PPI_GUID => new GUID(0x1f34d25, 0x4de2, 0x23ad, 0x3f, 0xf3, 0x36, 0x35, 0x3f, 0xf3, 0x23, 0xf1);
...
public unsafe struct EFI_PEI_PCD_PPI
{
  public readonly delegate* unmanaged</* IN */ulong /*SkuId*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_SET_SKU*/ SetSku;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_8*/ Get8;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_16*/ Get16;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_32*/ Get32;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_64*/ Get64;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_POINTER*/ GetPtr;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_BOOLEAN*/ GetBool;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_SIZE*/ GetSize;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */byte /*Value*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_SET_8*/ Set8;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */ushort /*Value*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_SET_16*/ Set16;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */uint /*Value*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_SET_32*/ Set32;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */ulong /*Value*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_SET_64*/ Set64;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN OUT */ulong* /*SizeOfValue*/,/* IN */void* /*Buffer*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_SET_POINTER*/ SetPtr;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */bool /*Value*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_SET_BOOLEAN*/ SetBool;

  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*CallBackToken*/,/* IN */delegate* unmanaged<EFI_GUID*, ulong, void*, ulong, void> /*CallBackFunction*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_CALLBACK_ON_SET*/ CallbackOnSet;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*CallBackToken*/,/* IN */delegate* unmanaged<EFI_GUID*, ulong, void*, ulong, void> /*CallBackFunction*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_CANCEL_CALLBACK*/ CancelCallback;

  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong* /*TokenNumber*/, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_NEXT_TOKEN*/ GetNextToken;
  public readonly delegate* unmanaged</* IN OUT CONST */EFI_GUID*, EFI_STATUS> /*EFI_PEI_PCD_PPI_GET_NEXT_TOKEN_SPACE*/ GetNextTokenSpace;
}
