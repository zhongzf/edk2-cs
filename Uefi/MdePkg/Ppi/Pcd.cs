...
{
  public static EFI_GUID PCD_PPI_GUID => new GUID(0x6e81c58, 0x4ad7, 0x44bc, 0x83, 0x90, 0xf1, 0x2, 0x65, 0xf7, 0x24, 0x80);
...
public unsafe struct PCD_PPI
{
  public readonly delegate* unmanaged</* IN */ulong /*SkuId*/, EFI_STATUS> /*PCD_PPI_SET_SKU*/ SetSku;

  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET8*/ Get8;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET16*/ Get16;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET32*/ Get32;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET64*/ Get64;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_POINTER*/ GetPtr;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_BOOLEAN*/ GetBool;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_SIZE*/ GetSize;

  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_EX_8*/ Get8Ex;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_EX_16*/ Get16Ex;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_EX_32*/ Get32Ex;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_EX_64*/ Get64Ex;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_EX_POINTER*/ GetPtrEx;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_EX_BOOLEAN*/ GetBoolEx;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_EX_SIZE*/ GetSizeEx;

  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/,/* IN */byte /*Value*/, EFI_STATUS> /*PCD_PPI_SET8*/ Set8;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/,/* IN */ushort /*Value*/, EFI_STATUS> /*PCD_PPI_SET16*/ Set16;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/,/* IN */uint /*Value*/, EFI_STATUS> /*PCD_PPI_SET32*/ Set32;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/,/* IN */ulong /*Value*/, EFI_STATUS> /*PCD_PPI_SET64*/ Set64;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/,/* IN OUT */ulong* /*SizeOfValue*/,/* IN */void* /*Buffer*/, EFI_STATUS> /*PCD_PPI_SET_POINTER*/ SetPtr;
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/,/* IN */bool /*Value*/, EFI_STATUS> /*PCD_PPI_SET_BOOLEAN*/ SetBool;

  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */byte /*Value*/, EFI_STATUS> /*PCD_PPI_SET_EX_8*/ Set8Ex;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */ushort /*Value*/, EFI_STATUS> /*PCD_PPI_SET_EX_16*/ Set16Ex;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */uint /*Value*/, EFI_STATUS> /*PCD_PPI_SET_EX_32*/ Set32Ex;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */ulong /*Value*/, EFI_STATUS> /*PCD_PPI_SET_EX_64*/ Set64Ex;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN OUT */ulong* /*SizeOfValue*/,/* IN */void* /*Buffer*/, EFI_STATUS> /*PCD_PPI_SET_EX_POINTER*/ SetPtrEx;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */bool /*Value*/, EFI_STATUS> /*PCD_PPI_SET_EX_BOOLEAN*/ SetBoolEx;

  public readonly delegate* unmanaged</* IN CONST */EFI_GUID*,/* IN */ulong /*TokenNumber*/,/* IN */delegate* unmanaged</* IN CONST */EFI_GUID* /*CallBackGuid*/,/* IN */ulong /*CallBackToken*/,/* IN OUT */void* /*TokenData*/,/* IN */ulong /*TokenDataSize*/, void> /*CallBackFunction*/, EFI_STATUS> /*PCD_PPI_CALLBACK_ONSET*/ CallbackOnSet;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID*,/* IN */ulong /*TokenNumber*/,/* IN */delegate* unmanaged</* IN CONST */EFI_GUID* /*CallBackGuid*/,/* IN */ulong /*CallBackToken*/,/* IN OUT */void* /*TokenData*/,/* IN */ulong /*TokenDataSize*/, void> /*CallBackFunction*/, EFI_STATUS> /*PCD_PPI_CANCEL_CALLBACK*/ CancelCallback;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN OUT */ulong* /*TokenNumber*/, EFI_STATUS> /*PCD_PPI_GET_NEXT_TOKEN*/ GetNextToken;
  public readonly delegate* unmanaged</* IN OUT CONST */EFI_GUID*, EFI_STATUS> /*PCD_PPI_GET_NEXT_TOKENSPACE*/ GetNextTokenSpace;
}
