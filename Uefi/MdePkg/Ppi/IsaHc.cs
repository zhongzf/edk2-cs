...
{
  public static EFI_GUID EFI_ISA_HC_PPI_GUID => new GUID(
...
public unsafe struct EFI_ISA_HC_PPI
{
  ///
  ...
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_ISA_HC_PPI* /*This*/,/* IN */ushort /*IoAddress*/,/* IN */ushort /*IoLength*/,/* OUT */ulong* /*IoApertureHandle*/, EFI_STATUS> /*EFI_PEI_ISA_HC_OPEN_IO*/ OpenIoAperture;
  ///
  /// Closes an aperture on a positive-decode ISA Host Controller.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_ISA_HC_PPI* /*This*/,/* IN */ulong /*IoApertureHandle*/, EFI_STATUS> /*EFI_PEI_ISA_HC_CLOSE_IO*/ CloseIoAperture;
}
