...
{
  public static EFI_GUID GET_PCD_INFO_PPI_GUID => new GUID(0x4d8b155b, 0xc059, 0x4c8f, 0x89, 0x26, 0x6, 0xfd, 0x43, 0x31, 0xdb, 0x8a);
...
public unsafe struct GET_PCD_INFO_PPI
{
  ///
  /// Retrieve additional information associated with a PCD.
  ///
  public readonly delegate* unmanaged</* IN */ulong /*TokenNumber*/,/* OUT */EFI_PCD_INFO* /*PcdInfo*/, EFI_STATUS> /*GET_PCD_INFO_PPI_GET_INFO*/ GetInfo;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* OUT */EFI_PCD_INFO* /*PcdInfo*/, EFI_STATUS> /*GET_PCD_INFO_PPI_GET_INFO_EX*/ GetInfoEx;
  ///
  /// Retrieve the currently set SKU Id.
  ///
  public readonly delegate* unmanaged<EFI_STATUS> /*GET_PCD_INFO_PPI_GET_SKU*/ GetSku;
}
