...
public unsafe partial class EFI
{
  ...
  ///
  public static EFI_GUID EFI_PEI_S3_RESUME2_PPI_GUID => new GUID(
...
public unsafe struct EFI_PEI_S3_RESUME2_PPI
{
  ///
  /// Restores the platform to its preboot configuration for an S3 resume and
  /// jumps to the OS waking vector.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PEI_S3_RESUME2_PPI* /*This*/, EFI_STATUS> /*EFI_PEI_S3_RESUME_PPI_RESTORE_CONFIG2*/ S3RestoreConfig2;
}
