...
{
  public static EFI_GUID EFI_PEI_SMBUS2_PPI_GUID => new GUID(0x9ca93627, 0xb65b, 0x4324, 0xa2, 0x2, 0xc0, 0xb4, 0x61, 0x76, 0x45, 0x43);
...
public unsafe struct EFI_PEI_SMBUS2_PPI
{
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SMBUS2_PPI* /*This*/,/* IN */EFI_SMBUS_DEVICE_ADDRESS /*SlaveAddress*/,/* IN */EFI_SMBUS_DEVICE_COMMAND /*Command*/,/* IN */EFI_SMBUS_OPERATION /*Operation*/,/* IN */bool /*PecCheck*/,/* IN OUT */ulong* /*Length*/,/* IN OUT */void* /*Buffer*/, EFI_STATUS> /*EFI_PEI_SMBUS2_PPI_EXECUTE_OPERATION*/ Execute;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SMBUS2_PPI* /*This*/,/* IN */bool /*ArpAll*/,/* IN */EFI_SMBUS_UDID* /*SmbusUdid*/,/* IN OUT */EFI_SMBUS_DEVICE_ADDRESS* /*SlaveAddress*/, EFI_STATUS> /*EFI_PEI_SMBUS2_PPI_ARP_DEVICE*/ ArpDevice;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SMBUS2_PPI* /*This*/,/* IN OUT */ulong* /*Length*/,/* IN OUT */EFI_SMBUS_DEVICE_MAP** /*SmbusDeviceMap*/, EFI_STATUS> /*EFI_PEI_SMBUS2_PPI_GET_ARP_MAP*/ GetArpMap;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SMBUS2_PPI* /*This*/,/* IN */EFI_SMBUS_DEVICE_ADDRESS /*SlaveAddress*/,/* IN */ulong /*Data*/,/* IN */delegate* unmanaged</* IN CONST */EFI_PEI_SMBUS2_PPI* /*SmbusPpi*/,/* IN */EFI_SMBUS_DEVICE_ADDRESS /*SlaveAddress*/,/* IN */ulong /*Data*/, EFI_STATUS> /*NotifyFunction*/, EFI_STATUS> /*EFI_PEI_SMBUS2_PPI_NOTIFY*/ Notify;
  ///
  /// Identifier which uniquely identifies this SMBus controller in a system.
  ///
  public EFI_GUID Identifier;
}
