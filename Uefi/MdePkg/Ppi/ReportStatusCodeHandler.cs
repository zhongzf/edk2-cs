...
{
  public static EFI_GUID EFI_PEI_RSC_HANDLER_PPI_GUID => new GUID(
...
public unsafe struct EFI_PEI_RSC_HANDLER_PPI
{
  public readonly delegate* unmanaged</* IN */delegate* unmanaged<EFI_PEI_SERVICES**, EFI_STATUS_CODE_TYPE, EFI_STATUS_CODE_VALUE, uint, EFI_GUID*, EFI_STATUS_CODE_DATA*, EFI_STATUS> /*Callback*/, EFI_STATUS> /*EFI_PEI_RSC_HANDLER_REGISTER*/ Register;
  public readonly delegate* unmanaged</* IN */delegate* unmanaged<EFI_PEI_SERVICES**, EFI_STATUS_CODE_TYPE, EFI_STATUS_CODE_VALUE, uint, EFI_GUID*, EFI_STATUS_CODE_DATA*, EFI_STATUS> /*Callback*/, EFI_STATUS> /*EFI_PEI_RSC_HANDLER_UNREGISTER*/ Unregister;
}
