...
{
  //public const ulong EFI_PEI_FIRMWARE_VOLUME_PPI_SIGNATURE = SIGNATURE_32 ('P', 'F', 'V', 'P');
  public const ulong EFI_PEI_FIRMWARE_VOLUME_PPI_REVISION = 0x00010030;
}
...
public unsafe struct EFI_PEI_FIRMWARE_VOLUME_PPI
{
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_FIRMWARE_VOLUME_PPI*,/* IN */void* /*Buffer*/,/* IN */ulong /*BufferSize*/,/* OUT */EFI_PEI_FV_HANDLE* /*FvHandle*/, EFI_STATUS> /*EFI_PEI_FV_PROCESS_FV*/ ProcessVolume;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_FIRMWARE_VOLUME_PPI*,/* IN */EFI_FV_FILETYPE /*SearchType*/,/* IN */EFI_PEI_FV_HANDLE /*FvHandle*/,/* IN OUT */EFI_PEI_FILE_HANDLE* /*FileHandle*/, EFI_STATUS> /*EFI_PEI_FV_FIND_FILE_TYPE*/ FindFileByType;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_FIRMWARE_VOLUME_PPI*,/* IN CONST */EFI_GUID*,/* IN */EFI_PEI_FV_HANDLE* /*FvHandle*/,/* OUT */EFI_PEI_FILE_HANDLE* /*FileHandle*/, EFI_STATUS> /*EFI_PEI_FV_FIND_FILE_NAME*/ FindFileByName;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_FIRMWARE_VOLUME_PPI*,/* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/,/* OUT */EFI_FV_FILE_INFO* /*FileInfo*/, EFI_STATUS> /*EFI_PEI_FV_GET_FILE_INFO*/ GetFileInfo;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_FIRMWARE_VOLUME_PPI*,/* IN */EFI_PEI_FV_HANDLE /*FvHandle*/,/* OUT */EFI_FV_INFO* /*VolumeInfo*/, EFI_STATUS> /*EFI_PEI_FV_GET_INFO*/ GetVolumeInfo;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_FIRMWARE_VOLUME_PPI*,/* IN */EFI_SECTION_TYPE /*SearchType*/,/* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/,/* OUT */void** /*SectionData*/, EFI_STATUS> /*EFI_PEI_FV_FIND_SECTION*/ FindSectionByType;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_FIRMWARE_VOLUME_PPI*,/* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/,/* OUT */EFI_FV_FILE_INFO2* /*FileInfo*/, EFI_STATUS> /*EFI_PEI_FV_GET_FILE_INFO2*/ GetFileInfo2;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_FIRMWARE_VOLUME_PPI*,/* IN */EFI_SECTION_TYPE /*SearchType*/,/* IN */ulong /*SearchInstance*/,/* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/,/* OUT */void** /*SectionData*/,/* OUT */uint* /*AuthenticationStatus*/, EFI_STATUS> /*EFI_PEI_FV_FIND_SECTION2*/ FindSectionByType2;
  ///
  ///
