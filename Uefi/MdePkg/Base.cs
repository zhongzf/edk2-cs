...
public unsafe partial class EFI
{
  ...
  ///
  public const bool TRUE = ((bool)(1 == 1));

  ///
  /// Boolean false value.  UEFI Specification defines this value to be 0,
  /// but this form is more portable.
  ///
  public const bool FALSE = ((bool)(0 == 1));
  ...
  ///
  public const sbyte MAX_INT8 = ((sbyte)0x7F);
  public const byte MAX_UINT8 = ((byte)0xFF);
  public const short MAX_INT16 = ((short)0x7FFF);
  public const ushort MAX_UINT16 = ((ushort)0xFFFF);
  public const int MAX_INT32 = ((int)0x7FFFFFFF);
  public const uint MAX_UINT32 = ((uint)0xFFFFFFFF);
  public const long MAX_INT64 = ((long)0x7FFFFFFFFFFFFFFF);
  public const ulong MAX_UINT64 = ((ulong)0xFFFFFFFFFFFFFFFF);

  ///
  /// Minimum values for the signed UEFI Data Types
  ///
  public const sbyte MIN_INT8 = (((sbyte)-127) - 1);
  public const short MIN_INT16 = (((short)-32767) - 1);
  public const int MIN_INT32 = (((int)-2147483647) - 1);
  public const long MIN_INT64 = (((long)-9223372036854775807) - 1);
...
////      //
////      // The ... list is a series of ulong values, so sum them up.
////      //
...
///**
//  Return the size of argument that has been aligned to sizeof (ulong).
...
//// byte is known to have both a size and an alignment requirement of 1 Byte.
...
//STATIC_ASSERT (sizeof (bool) == 1, "sizeof (bool) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (sbyte)    == 1, "sizeof (sbyte) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (byte)   == 1, "sizeof (byte) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (short)   == 2, "sizeof (short) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (ushort)  == 2, "sizeof (ushort) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (int)   == 4, "sizeof (int) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (uint)  == 4, "sizeof (uint) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (long)   == 8, "sizeof (long) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (ulong)  == 8, "sizeof (ulong) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (byte)   == 1, "sizeof (byte) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (char)  == 2, "sizeof (char) does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (L'A')    == 2, "sizeof (L'A') does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (sizeof (L"A")    == 4, "sizeof (L\"A\") does not meet UEFI Specification Data Type requirements");

//STATIC_ASSERT (ALIGNOF (bool) == sizeof (bool), "Alignment of bool does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (sbyte)    == sizeof (sbyte), "Alignment of sbyte does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (byte)   == sizeof (byte), "Alignment of short does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (short)   == sizeof (short), "Alignment of short does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (ushort)  == sizeof (ushort), "Alignment of ushort does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (int)   == sizeof (int), "Alignment of int does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (uint)  == sizeof (uint), "Alignment of uint does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (long)   == sizeof (long), "Alignment of long does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (ulong)  == sizeof (ulong), "Alignment of ulong does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (byte)   == sizeof (byte), "Alignment of byte does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (char)  == sizeof (char), "Alignment of char does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (long)    == sizeof (long), "Alignment of long does not meet UEFI Specification Data Type requirements");
//STATIC_ASSERT (ALIGNOF (ulong)   == sizeof (ulong), "Alignment of ulong does not meet UEFI Specification Data Type requirements");
...
////
//public enum __VERIFY_UINT8_ENUM_SIZE {
//  __VerifyUint8EnumValue = 0xff
//}

//public enum __VERIFY_UINT16_ENUM_SIZE {
//  __VerifyUint16EnumValue = 0xffff
//}

//public enum __VERIFY_INT32_ENUM_SIZE {
...
//
[StructLayout(LayoutKind.Sequential)]
public unsafe struct RETURN_STATUS { ulong Value; public static implicit operator RETURN_STATUS(ulong value) => new RETURN_STATUS() { Value = value }; public static implicit operator ulong(RETURN_STATUS value) => value.Value; }
