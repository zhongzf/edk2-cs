...
{
  /*CONST*/
  public char* CapturePtr; // Pointer to the start of the captured sub-expression
...
//   IN OUT ulong                           *RegExSyntaxTypeListSize,
...
//   OUT ulong                           *CapturesCount
//   );

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_REGULAR_EXPRESSION_PROTOCOL
{
  public readonly delegate* unmanaged</* IN */EFI_REGULAR_EXPRESSION_PROTOCOL* /*This*/,/* IN */char* /*String*/,/* IN */char* /*Pattern*/,/* IN */EFI_REGEX_SYNTAX_TYPE* /*SyntaxType*/,/* OUT */bool* /*Result*/,/* OUT */EFI_REGEX_CAPTURE** /*Captures*/,/* OUT */ulong* /*CapturesCount*/, EFI_STATUS> /*EFI_REGULAR_EXPRESSION_MATCH*/ MatchString;
  public readonly delegate* unmanaged</* IN */EFI_REGULAR_EXPRESSION_PROTOCOL* /*This*/,/* IN OUT */ulong* /*RegExSyntaxTypeListSize*/,/* OUT */EFI_REGEX_SYNTAX_TYPE* /*RegExSyntaxTypeList*/, EFI_STATUS> /*EFI_REGULAR_EXPRESSION_GET_INFO*/ GetInfo;
}
