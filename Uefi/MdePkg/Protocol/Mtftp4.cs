...
{
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* OUT */EFI_MTFTP4_MODE_DATA* /*ModeData*/, EFI_STATUS> /*EFI_MTFTP4_GET_MODE_DATA*/ GetModeData;
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* IN */EFI_MTFTP4_CONFIG_DATA* /*MtftpConfigData*/, EFI_STATUS> /*EFI_MTFTP4_CONFIGURE*/ Configure;
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* IN */EFI_MTFTP4_OVERRIDE_DATA* /*OverrideData*/,/* IN */byte* /*Filename*/,/* IN */byte* /*ModeStr*/,/* IN */byte /*OptionCount*/,/* IN */EFI_MTFTP4_OPTION* /*OptionList*/,/* OUT */uint* /*PacketLength*/,/* OUT */EFI_MTFTP4_PACKET** /*Packet*/, EFI_STATUS> /*EFI_MTFTP4_GET_INFO*/ GetInfo;
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* IN */uint /*PacketLen*/,/* IN */EFI_MTFTP4_PACKET* /*Packet*/,/* OUT */uint* /*OptionCount*/,/* OUT */EFI_MTFTP4_OPTION** /*OptionList*/, EFI_STATUS> /*EFI_MTFTP4_PARSE_OPTIONS*/ ParseOptions;
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* IN */EFI_MTFTP4_TOKEN* /*Token*/, EFI_STATUS> /*EFI_MTFTP4_READ_FILE*/ ReadFile;
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* IN */EFI_MTFTP4_TOKEN* /*Token*/, EFI_STATUS> /*EFI_MTFTP4_WRITE_FILE*/ WriteFile;
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* IN */EFI_MTFTP4_TOKEN* /*Token*/, EFI_STATUS> /*EFI_MTFTP4_READ_DIRECTORY*/ ReadDirectory;
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_MTFTP4_POLL*/ Poll;
}
...
public unsafe struct EFI_MTFTP4_TOKEN
{
  ...
  ///
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* IN */EFI_MTFTP4_TOKEN* /*Token*/,/* IN */ushort /*PacketLen*/,/* IN */EFI_MTFTP4_PACKET* /*Paket*/, EFI_STATUS> /*EFI_MTFTP4_CHECK_PACKET*/ CheckPacket;
  ///
  /// The pointer to the function to be called when a timeout occurs.
  ///
  public readonly delegate* unmanaged</* IN */EFI_MTFTP4_PROTOCOL* /*This*/,/* IN */EFI_MTFTP4_TOKEN* /*Token*/, EFI_STATUS> /*EFI_MTFTP4_TIMEOUT_CALLBACK*/ TimeoutCallback;
  ///
