...
public unsafe struct EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL*, uint, EFI_NVM_EXPRESS_PASS_THRU_COMMAND_PACKET*, EFI_EVENT, EFI_STATUS> PassThru;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL*, uint*, EFI_STATUS> GetNextNamespace;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL*, uint, EFI_DEVICE_PATH_PROTOCOL**, EFI_STATUS> BuildDevicePath;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL*, EFI_DEVICE_PATH_PROTOCOL*, uint*, EFI_STATUS> GetNamespace;
}
