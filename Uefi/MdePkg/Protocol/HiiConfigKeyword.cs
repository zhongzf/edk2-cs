...
// Progress Errors
// ***********************************************************
public static ulong KEYWORD_HANDLER_NO_ERROR = 0x00000000;
public static ulong KEYWORD_HANDLER_NAMESPACE_ID_NOT_FOUND = 0x00000001;
public static ulong KEYWORD_HANDLER_MALFORMED_STRING = 0x00000002;
public static ulong KEYWORD_HANDLER_KEYWORD_NOT_FOUND = 0x00000004;
public static ulong KEYWORD_HANDLER_INCOMPATIBLE_VALUE_DETECTED = 0x00000008;
public static ulong KEYWORD_HANDLER_ACCESS_NOT_PERMITTED = 0x00000010;
public static ulong KEYWORD_HANDLER_UNDEFINED_PROCESSING_ERROR = 0x80000000;
...
public unsafe struct EFI_CONFIG_KEYWORD_HANDLER_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_CONFIG_KEYWORD_HANDLER_PROTOCOL*, CONST, EFI_STRING*, uint*, EFI_STATUS> SetData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_CONFIG_KEYWORD_HANDLER_PROTOCOL*, CONST, CONST, EFI_STRING*, uint*, EFI_STRING*, EFI_STATUS> GetData;
}
