...
public unsafe struct EFI_UDP6_SERVICE_POINT
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_UDP6_VARIABLE_DATA
{
  ///
...
{
  public uint FragmentLength;      ///< Length of the fragment data buffer.
  public void* FragmentBuffer;     ///< Pointer to the fragment data buffer.
}
