...
{
  public static EFI_GUID EFI_STORAGE_SECURITY_COMMAND_PROTOCOL_GUID = new GUID(
      0xC88B0B6D, 0x0DFC, 0x49A7, new byte[] { 0x9C, 0xB4, 0x49, 0x07, 0x4B, 0x4C, 0x3A, 0x78 });
  ...
  //   IN uint                                   MediaId,
  //   IN ulong                                   Timeout,
  //   IN byte                                    SecurityProtocolId,
  //   IN ushort                                   SecurityProtocolSpecificData,
  //   IN ulong                                    PayloadBufferSize,
  //   OUT void                                    *PayloadBuffer,
  //   OUT ulong                                   *PayloadTransferSize
  //   );
...
public unsafe struct EFI_STORAGE_SECURITY_COMMAND_PROTOCOL
{
  public readonly delegate* unmanaged</* IN */EFI_STORAGE_SECURITY_COMMAND_PROTOCOL* /*This*/,/* IN */uint /*MediaId*/,/* IN */ulong /*Timeout*/,/* IN */byte /*SecurityProtocolId*/,/* IN */ushort /*SecurityProtocolSpecificData*/,/* IN */ulong /*PayloadBufferSize*/,/* OUT */void* /*PayloadBuffer*/,/* OUT */ulong* /*PayloadTransferSize*/, EFI_STATUS> /*EFI_STORAGE_SECURITY_RECEIVE_DATA*/ ReceiveData;
  public readonly delegate* unmanaged</* IN */EFI_STORAGE_SECURITY_COMMAND_PROTOCOL* /*This*/,/* IN */uint /*MediaId*/,/* IN */ulong /*Timeout*/,/* IN */byte /*SecurityProtocolId*/,/* IN */ushort /*SecurityProtocolSpecificData*/,/* IN */ulong /*PayloadBufferSize*/,/* IN */void* /*PayloadBuffer*/, EFI_STATUS> /*EFI_STORAGE_SECURITY_SEND_DATA*/ SendData;
}
