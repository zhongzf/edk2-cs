...
**/
public readonly delegate* unmanaged<EFI_STORAGE_SECURITY_COMMAND_PROTOCOL*,uint,ulong,byte,ushort,ulong,void*,ulong*, EFI_STATUS> ReceiveData;
/**
...
**/
public readonly delegate* unmanaged<EFI_STORAGE_SECURITY_COMMAND_PROTOCOL*,uint,ulong,byte,ushort,ulong,void*, EFI_STATUS> SendData;
}
