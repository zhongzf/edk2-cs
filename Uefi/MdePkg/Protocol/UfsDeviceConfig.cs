...
public unsafe partial class EFI
{
  ...
  //
  public static EFI_GUID EFI_UFS_DEVICE_CONFIG_GUID => new GUID(0xb81bfab0, 0xeb3, 0x4cf9, 0x84, 0x65, 0x7f, 0xa9, 0x86, 0x36, 0x16, 0x64);
  ...
  //   IN byte                             Index,
  //   IN byte                             Selector,
  //   IN OUT byte                         *Descriptor,
  //   IN OUT uint                        *DescSize
  //   );
  ...
  //   IN byte                             Index,
  //   IN byte                             Selector,
  //   IN OUT byte                         *Attribute,
  //   IN OUT uint                        *AttrSize
  //   );
}
...
public unsafe struct EFI_UFS_DEVICE_CONFIG_PROTOCOL
{
  public readonly delegate* unmanaged</* IN */EFI_UFS_DEVICE_CONFIG_PROTOCOL* /*This*/,/* IN */bool /*Read*/,/* IN */byte /*DescId*/,/* IN */byte /*Index*/,/* IN */byte /*Selector*/,/* IN OUT */byte* /*Descriptor*/,/* IN OUT */uint* /*DescSize*/, EFI_STATUS> /*EFI_UFS_DEVICE_CONFIG_RW_DESCRIPTOR*/ RwUfsDescriptor;
  public readonly delegate* unmanaged</* IN */EFI_UFS_DEVICE_CONFIG_PROTOCOL* /*This*/,/* IN */bool /*Read*/,/* IN */byte /*FlagId*/,/* IN OUT */byte* /*Flag*/, EFI_STATUS> /*EFI_UFS_DEVICE_CONFIG_RW_FLAG*/ RwUfsFlag;
  public readonly delegate* unmanaged</* IN */EFI_UFS_DEVICE_CONFIG_PROTOCOL* /*This*/,/* IN */bool /*Read*/,/* IN */byte /*AttrId*/,/* IN */byte /*Index*/,/* IN */byte /*Selector*/,/* IN OUT */byte* /*Attribute*/,/* IN OUT */uint* /*AttrSize*/, EFI_STATUS> /*EFI_UFS_DEVICE_CONFIG_RW_ATTRIBUTE*/ RwUfsAttribute;
}
