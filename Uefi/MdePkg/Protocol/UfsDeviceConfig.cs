...
**/
public readonly delegate* unmanaged<EFI_UFS_DEVICE_CONFIG_PROTOCOL*,bool,byte,byte,byte,byte*,uint*, EFI_STATUS> RwUfsDescriptor;
/**
...
**/
public readonly delegate* unmanaged<EFI_UFS_DEVICE_CONFIG_PROTOCOL*,bool,byte,byte*, EFI_STATUS> RwUfsFlag;
/**
...
**/
public readonly delegate* unmanaged<EFI_UFS_DEVICE_CONFIG_PROTOCOL*,bool,byte,byte,byte,byte*,uint*, EFI_STATUS> RwUfsAttribute;
}
