...
public unsafe partial class EFI
{
  ...
  //   IN OUT    ulong                           *ImageInfoSize,
  //   IN OUT    EFI_FIRMWARE_IMAGE_DESCRIPTOR   *ImageInfo,
  //   OUT       uint                          *DescriptorVersion,
  //   OUT       byte                           *DescriptorCount,
  //   OUT       ulong                           *DescriptorSize,
  //   OUT       uint                          *PackageVersion,
  //   OUT       char                          **PackageVersionName
  //   );
  ...
  //   OUT uint                           *PackageVersion,
  //   OUT char                           **PackageVersionName,
  //   OUT uint                           *PackageVersionNameMaxLen,
  //   OUT ulong                           *AttributesSupported,
  //   OUT ulong                           *AttributesSetting
  //   );
  ...
  //   IN  ulong                              ImageSize,
  //   IN  CONST void                         *VendorCode,
  //   IN  uint                             PackageVersion,
  //   IN  CONST char                       *PackageVersionName
  //   );
}
...
public unsafe struct EFI_FIRMWARE_MANAGEMENT_PROTOCOL
{
  ...
  public readonly delegate* unmanaged</* IN */EFI_FIRMWARE_MANAGEMENT_PROTOCOL* /*This*/,/* IN */byte /*ImageIndex*/,/* IN CONST */void*,/* IN */ulong /*ImageSize*/,/* IN CONST */void*,/* IN */delegate* unmanaged</* IN */ulong /*Completion*/, EFI_STATUS> /*Progress*/,/* OUT */char** /*AbortReason*/, EFI_STATUS> /*EFI_FIRMWARE_MANAGEMENT_PROTOCOL_SET_IMAGE*/ SetImage;
