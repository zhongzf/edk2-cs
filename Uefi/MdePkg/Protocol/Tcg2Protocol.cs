...
public unsafe struct EFI_TCG2_VERSION
{
  public byte Major;
  public byte Minor;
}
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_TCG2_BOOT_SERVICE_CAPABILITY
{
  //
  ...
  //
  public EFI_TCG2_VERSION StructureVersion;
  //
  // Version of the EFI TCG2 protocol.
  // For this version of the protocol, the Major version shall be set to 1
  // and the Minor version shall be set to 1.
  //
  public EFI_TCG2_VERSION ProtocolVersion;
  //
  ...
  //
  public EFI_TCG2_EVENT_ALGORITHM_BITMAP HashAlgorithmBitmap;
  //
  // Bitmap of supported event log formats
  //
  public EFI_TCG2_EVENT_LOG_BITMAP SupportedEventLogs;
  //
  // False = TPM not present
  //
  public bool TPMPresentFlag;
  //
  ...
  //
  public EFI_TCG2_EVENT_ALGORITHM_BITMAP ActivePcrBanks;
}
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_TCG2_EVENT
{
  //
  // Total size of the event including the Size component, the header and the Event data.
  //
  public uint Size;
  public EFI_TCG2_EVENT_HEADER Header;
...
//   IN EFI_TCG2_PROTOCOL *This,
//   IN uint            InputParameterBlockSize,
//   IN byte             *InputParameterBlock,
//   IN uint            OutputParameterBlockSize,
//   IN byte             *OutputParameterBlock
//   );
...
//   IN  EFI_TCG2_PROTOCOL  *This,
//   OUT uint             *OperationPresent,
//   OUT uint             *Response
//   );

[StructLayout(LayoutKind.Sequential)]
public unsafe struct TCG2_PROTOCOL
{
  public readonly delegate* unmanaged</* IN */EFI_TCG2_PROTOCOL* /*This*/,/* IN OUT */EFI_TCG2_BOOT_SERVICE_CAPABILITY* /*ProtocolCapability*/, EFI_STATUS> /*EFI_TCG2_GET_CAPABILITY*/ GetCapability;
  public readonly delegate* unmanaged</* IN */EFI_TCG2_PROTOCOL* /*This*/,/* IN */EFI_TCG2_EVENT_LOG_FORMAT /*EventLogFormat*/,/* OUT */EFI_PHYSICAL_ADDRESS* /*EventLogLocation*/,/* OUT */EFI_PHYSICAL_ADDRESS* /*EventLogLastEntry*/,/* OUT */bool* /*EventLogTruncated*/, EFI_STATUS> /*EFI_TCG2_GET_EVENT_LOG*/ GetEventLog;
  public readonly delegate* unmanaged</* IN */EFI_TCG2_PROTOCOL* /*This*/,/* IN */ulong /*Flags*/,/* IN */EFI_PHYSICAL_ADDRESS /*DataToHash*/,/* IN */ulong /*DataToHashLen*/,/* IN */EFI_TCG2_EVENT* /*EfiTcgEvent*/, EFI_STATUS> /*EFI_TCG2_HASH_LOG_EXTEND_EVENT*/ HashLogExtendEvent;
  public readonly delegate* unmanaged</* IN */EFI_TCG2_PROTOCOL* /*This*/,/* IN */uint /*InputParameterBlockSize*/,/* IN */byte* /*InputParameterBlock*/,/* IN */uint /*OutputParameterBlockSize*/,/* IN */byte* /*OutputParameterBlock*/, EFI_STATUS> /*EFI_TCG2_SUBMIT_COMMAND*/ SubmitCommand;
  public readonly delegate* unmanaged</* IN */EFI_TCG2_PROTOCOL* /*This*/,/* OUT */uint* /*ActivePcrBanks*/, EFI_STATUS> /*EFI_TCG2_GET_ACTIVE_PCR_BANKS*/ GetActivePcrBanks;
  public readonly delegate* unmanaged</* IN */EFI_TCG2_PROTOCOL* /*This*/,/* IN */uint /*ActivePcrBanks*/, EFI_STATUS> /*EFI_TCG2_SET_ACTIVE_PCR_BANKS*/ SetActivePcrBanks;
  public readonly delegate* unmanaged</* IN */EFI_TCG2_PROTOCOL* /*This*/,/* OUT */uint* /*OperationPresent*/,/* OUT */uint* /*Response*/, EFI_STATUS> /*EFI_TCG2_GET_RESULT_OF_SET_ACTIVE_PCR_BANKS*/ GetResultOfSetActivePcrBanks;
}
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_TCG2_FINAL_EVENTS_TABLE
{
  //
