...
public unsafe struct EFI_CPU_PHYSICAL_LOCATION {
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_CPU_PHYSICAL_LOCATION2 {
  ///
...
[StructLayout(LayoutKind.Explicit)] public unsafe struct EXTENDED_PROCESSOR_INFORMATION {
 ...
 [FieldOffset(0)] public EFI_CPU_PHYSICAL_LOCATION2    Location2;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PROCESSOR_INFORMATION {
  ///
...
**/
public readonly delegate* unmanaged<EFI_MP_SERVICES_PROTOCOL*,EFI_AP_PROCEDURE,bool,EFI_EVENT,ulong,void*,ulong**, EFI_STATUS> StartupAllAPs;
/**
...
**/
public readonly delegate* unmanaged<EFI_MP_SERVICES_PROTOCOL*,EFI_AP_PROCEDURE,ulong,EFI_EVENT,ulong,void*,bool*, EFI_STATUS> StartupThisAP;
/**
