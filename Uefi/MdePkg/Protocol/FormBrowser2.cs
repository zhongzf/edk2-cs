...
public static EFI_GUID EFI_FORM_BROWSER2_PROTOCOL_GUID = new GUID(0xb9d4c360, 0xbcfb, 0x4f9b, new byte[] { 0x92, 0x98, 0x53, 0xc1, 0x36, 0x98, 0x22, 0x58 });
...
public unsafe struct EFI_SCREEN_DESCRIPTOR
{
  public ulong LeftColumn;
  public ulong RightColumn;
  public ulong TopRow;
  public ulong BottomRow;
}
...
public unsafe struct EFI_FORM_BROWSER2_PROTOCOL
{
  /**
    ...
    @retval EFI_INVALID_PARAMETER One of the parameters has an
                                  invalid value.
  **/
  public readonly delegate* unmanaged<CONST, EFI_HII_HANDLE*, ulong, EFI_GUID*, EFI_FORM_ID, CONST, EFI_BROWSER_ACTION_REQUEST*, EFI_STATUS> SendForm;
  /**
    ...
    @param RetrieveData   A bool field which allows an agent to
  ...
  **/
  public readonly delegate* unmanaged<CONST, ulong*, EFI_STRING, CONST, CONST, CONST, EFI_STATUS> BrowserCallback;
}
