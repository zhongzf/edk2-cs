...
public unsafe struct EFI_BLOCK_IO_CRYPTO_TOKEN
{
  //
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_BLOCK_IO_CRYPTO_CAPABILITY
{
  //
  // GUID of the algorithm.
  //
  public EFI_GUID Algorithm;
  //
  ...
  //
  public ulong CryptoBlockSizeBitMask;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_BLOCK_IO_CRYPTO_IV_INPUT
{
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_BLOCK_IO_CRYPTO_IV_INPUT_AES_XTS
{
  public EFI_BLOCK_IO_CRYPTO_IV_INPUT Header;
  public ulong CryptoBlockNumber;
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_BLOCK_IO_CRYPTO_IV_INPUT_AES_CBC_MICROSOFT_BITLOCKER
{
  public EFI_BLOCK_IO_CRYPTO_IV_INPUT Header;
  public ulong CryptoBlockByteOffset;
  public ulong CryptoBlockByteSize;
}
...
public unsafe struct EFI_BLOCK_IO_CRYPTO_CAPABILITIES
{
  ...
  //
  public ulong CapabilityCount;
  //
  // Array of supported capabilities.
  //
  public fixed EFI_BLOCK_IO_CRYPTO_CAPABILITY Capabilities[1];
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_BLOCK_IO_CRYPTO_CONFIGURATION_TABLE_ENTRY
{
  //
  ...
  //
  public EFI_BLOCK_IO_CRYPTO_CAPABILITY Capability;
  //
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_BLOCK_IO_CRYPTO_RESPONSE_CONFIGURATION_ENTRY
{
  //
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_BLOCK_IO_CRYPTO_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_BLOCK_IO_CRYPTO_PROTOCOL*, bool, EFI_STATUS> Reset;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_BLOCK_IO_CRYPTO_PROTOCOL*, EFI_BLOCK_IO_CRYPTO_CAPABILITIES*, EFI_STATUS> GetCapabilities;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_BLOCK_IO_CRYPTO_PROTOCOL*, ulong, EFI_BLOCK_IO_CRYPTO_CONFIGURATION_TABLE_ENTRY*, EFI_BLOCK_IO_CRYPTO_RESPONSE_CONFIGURATION_ENTRY*, EFI_STATUS> SetConfiguration;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_BLOCK_IO_CRYPTO_PROTOCOL*, ulong, ulong, EFI_GUID*, EFI_BLOCK_IO_CRYPTO_RESPONSE_CONFIGURATION_ENTRY*, EFI_STATUS> GetConfiguration;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_BLOCK_IO_CRYPTO_PROTOCOL*, uint, EFI_LBA, EFI_BLOCK_IO_CRYPTO_TOKEN*, ulong, void*, ulong*, void*, EFI_STATUS> ReadExtended;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_BLOCK_IO_CRYPTO_PROTOCOL*, uint, EFI_LBA, EFI_BLOCK_IO_CRYPTO_TOKEN*, ulong, void*, ulong*, void*, EFI_STATUS> WriteExtended;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_BLOCK_IO_CRYPTO_PROTOCOL*, EFI_BLOCK_IO_CRYPTO_TOKEN*, EFI_STATUS> FlushBlocks;
}
