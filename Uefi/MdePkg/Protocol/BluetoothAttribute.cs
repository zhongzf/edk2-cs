...
//
[StructLayout(LayoutKind.Explicit)] public unsafe struct Permission {
  struct {
...
**/
public readonly delegate* unmanaged<EFI_BLUETOOTH_ATTRIBUTE_PROTOCOL*,void*,ulong,EFI_BLUETOOTH_ATTRIBUTE_CALLBACK_FUNCTION,void*, EFI_STATUS> SendRequest;
/**
...
**/
public readonly delegate* unmanaged<EFI_BLUETOOTH_ATTRIBUTE_PROTOCOL*,EFI_BLUETOOTH_ATTRIBUTE_CALLBACK_PARAMETER*,EFI_BLUETOOTH_ATTRIBUTE_CALLBACK_FUNCTION,void*, EFI_STATUS> RegisterForServerNotification;
/**
...
**/
public readonly delegate* unmanaged<EFI_BLUETOOTH_ATTRIBUTE_PROTOCOL*,ulong*,void**, EFI_STATUS> GetServiceInfo;
/**
...
**/
public readonly delegate* unmanaged<EFI_BLUETOOTH_ATTRIBUTE_PROTOCOL*,ulong*,void**, EFI_STATUS> GetDeviceInfo;
}
