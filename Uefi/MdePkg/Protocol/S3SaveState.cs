...
{
  public static EFI_GUID EFI_S3_SAVE_STATE_PROTOCOL_GUID = new GUID(0xe857caf6, 0xc046, 0x45dc, new byte[] { 0xbe, 0x3f, 0xee, 0x7, 0x65, 0xfb, 0xa8, 0x87 });
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_S3_BOOT_SCRIPT_POSITION { void* Value; public static implicit operator EFI_S3_BOOT_SCRIPT_POSITION(void* value) => new EFI_S3_BOOT_SCRIPT_POSITION() { Value = value }; public static implicit operator void*(EFI_S3_BOOT_SCRIPT_POSITION value) => value.Value; }
...
//   OUT      ulong                               *RelativePosition
//   );

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_S3_SAVE_STATE_PROTOCOL
{
  public readonly delegate* unmanaged</* IN CONST */EFI_S3_SAVE_STATE_PROTOCOL* /*This*/,/* IN */ulong /*OpCode*/, EFI_STATUS> /*EFI_S3_SAVE_STATE_WRITE*/ Write;
  public readonly delegate* unmanaged</* IN CONST */EFI_S3_SAVE_STATE_PROTOCOL* /*This*/,/* IN */bool /*BeforeOrAfter*/,/* IN OUT */EFI_S3_BOOT_SCRIPT_POSITION* /*Position*/,/* IN */ulong /*OpCode*/, EFI_STATUS> /*EFI_S3_SAVE_STATE_INSERT*/ Insert;
  public readonly delegate* unmanaged</* IN CONST */EFI_S3_SAVE_STATE_PROTOCOL* /*This*/,/* IN */bool /*BeforeOrAfter*/,/* IN */bool /*CreateIfNotFound*/,/* IN OUT */EFI_S3_BOOT_SCRIPT_POSITION* /*Position*/,/* IN CONST */byte* /*Label*/, EFI_STATUS> /*EFI_S3_SAVE_STATE_LABEL*/ Label;
  public readonly delegate* unmanaged</* IN CONST */EFI_S3_SAVE_STATE_PROTOCOL* /*This*/,/* IN */EFI_S3_BOOT_SCRIPT_POSITION /*Position1*/,/* IN */EFI_S3_BOOT_SCRIPT_POSITION /*Position2*/,/* OUT */ulong* /*RelativePosition*/, EFI_STATUS> /*EFI_S3_SAVE_STATE_COMPARE*/ Compare;
}
