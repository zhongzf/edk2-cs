...
public unsafe struct EFI_S3_SAVE_STATE_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<CONST, ulong, EFI_STATUS> Write;
  /**
    Record operations that need to be replayed during an S3 resume.
  ...
  **/
  public readonly delegate* unmanaged<CONST, bool, EFI_S3_BOOT_SCRIPT_POSITION*, ulong, EFI_STATUS> Insert;
  /**
    ...
    @retval    EFI_OUT_OF_RESOURCES     There is insufficient memory to store the boot script.
  **/
  public readonly delegate* unmanaged<CONST, bool, bool, EFI_S3_BOOT_SCRIPT_POSITION*, CONST, EFI_STATUS> Label;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_S3_BOOT_SCRIPT_POSITION, EFI_S3_BOOT_SCRIPT_POSITION, ulong*, EFI_STATUS> Compare;
}
