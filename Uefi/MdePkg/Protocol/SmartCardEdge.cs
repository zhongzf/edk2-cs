...
public unsafe partial class EFI
{
  ...
  //   OUT ulong                             *NumberAidSupported,
  //   IN OUT ulong                             *AidTableSize OPTIONAL,
  //   OUT SMART_CARD_AID                    *AidTable OPTIONAL,
  //   OUT ulong                             *NumberSCPresent,
  //   IN OUT ulong                             *CsnTableSize OPTIONAL,
  //   OUT SMART_CARD_CSN                    *CsnTable OPTIONAL,
  //   OUT uint                            *VersionScEdgeProtocol OPTIONAL
  //   );
  ...
  //   IN     byte                             *ScardCsn OPTIONAL,
  //   OUT byte                             *ScardAid OPTIONAL
  //   );
  ...
  //   IN     byte                             *PinCode,
  //   OUT bool                           *PinResult,
  //   OUT uint                            *RemainingAttempts OPTIONAL
  //   );
  ...
  //   IN     EFI_SMART_CARD_EDGE_PROTOCOL      *This,
  //   IN     EFI_HANDLE                        SCardHandle,
  //   IN OUT ulong                             *CredentialSize,
  //   OUT byte                             *CredentialList OPTIONAL
  //   );
  ...
  //   IN     EFI_GUID                          *HashAlgorithm,
  //   IN     EFI_GUID                          *PaddingMethod,
  //   IN     ulong                             EncryptedSize,
  //   IN     byte                             *EncryptedData,
  //   IN OUT ulong                             *PlaintextSize,
  //   OUT byte                             *PlaintextData
  //   );
...
public unsafe struct EFI_SMART_CARD_EDGE_PROTOCOL
{
  ...
  public readonly delegate* unmanaged</* IN */EFI_SMART_CARD_EDGE_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*SCardHandle*/,/* IN OUT */ulong* /*ReaderNameLength*/,/* OUT */char* /*ReaderName*/, EFI_STATUS> /*EFI_SMART_CARD_EDGE_GET_READER_NAME*/ GetReaderName;
  public readonly delegate* unmanaged</* IN */EFI_SMART_CARD_EDGE_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*SCardHandle*/,/* IN */int /*PinSize*/,/* IN */byte* /*PinCode*/,/* OUT */bool* /*PinResult*/,/* OUT */uint* /*RemainingAttempts*/, EFI_STATUS> /*EFI_SMART_CARD_EDGE_VERIFY_PIN*/ VerifyPin;
  public readonly delegate* unmanaged</* IN */EFI_SMART_CARD_EDGE_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*SCardHandle*/,/* OUT */uint* /*RemainingAttempts*/, EFI_STATUS> /*EFI_SMART_CARD_EDGE_GET_PIN_REMAINING*/ GetPinRemaining;
  public readonly delegate* unmanaged</* IN */EFI_SMART_CARD_EDGE_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*SCardHandle*/,/* IN */EFI_GUID* /*DataId*/,/* IN OUT */ulong* /*DataSize*/,/* OUT */void* /*Data*/, EFI_STATUS> /*EFI_SMART_CARD_EDGE_GET_DATA*/ GetData;
  public readonly delegate* unmanaged</* IN */EFI_SMART_CARD_EDGE_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*SCardHandle*/,/* IN OUT */ulong* /*CredentialSize*/,/* OUT */byte* /*CredentialList*/, EFI_STATUS> /*EFI_SMART_CARD_EDGE_GET_CREDENTIAL*/ GetCredential;
  public readonly delegate* unmanaged</* IN */EFI_SMART_CARD_EDGE_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*SCardHandle*/,/* IN */ulong /*KeyId*/,/* IN */ulong /*KeyType*/,/* IN */EFI_GUID* /*HashAlgorithm*/,/* IN */EFI_GUID* /*PaddingMethod*/,/* IN */byte* /*HashedData*/,/* OUT */byte* /*SignatureData*/, EFI_STATUS> /*EFI_SMART_CARD_EDGE_SIGN_DATA*/ SignData;
  public readonly delegate* unmanaged</* IN */EFI_SMART_CARD_EDGE_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*SCardHandle*/,/* IN */ulong /*KeyId*/,/* IN */EFI_GUID* /*HashAlgorithm*/,/* IN */EFI_GUID* /*PaddingMethod*/,/* IN */ulong /*EncryptedSize*/,/* IN */byte* /*EncryptedData*/,/* IN OUT */ulong* /*PlaintextSize*/,/* OUT */byte* /*PlaintextData*/, EFI_STATUS> /*EFI_SMART_CARD_EDGE_DECRYPT_DATA*/ DecryptData;
  public readonly delegate* unmanaged</* IN */EFI_SMART_CARD_EDGE_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*SCardHandle*/,/* IN */ulong /*KeyId*/,/* IN */byte* /*dataQx*/,/* IN */byte* /*dataQy*/,/* OUT */byte* /*DHAgreement*/, EFI_STATUS> /*EFI_SMART_CARD_EDGE_BUILD_DH_AGREEMENT*/ BuildDHAgreement;
}
