...
public unsafe struct EFI_SMART_CARD_EDGE_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, ulong*, ulong*, SMART_CARD_AID*, ulong*, ulong*, SMART_CARD_CSN*, uint*, EFI_STATUS> GetContext;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE*, byte*, byte*, EFI_STATUS> Connect;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, EFI_STATUS> Disconnect;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, byte, EFI_STATUS> GetCsn;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, ulong*, char*, EFI_STATUS> GetReaderName;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, int, byte*, bool*, uint*, EFI_STATUS> VerifyPin;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, uint*, EFI_STATUS> GetPinRemaining;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, EFI_GUID*, ulong*, void*, EFI_STATUS> GetData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, ulong*, byte*, EFI_STATUS> GetCredential;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, ulong, ulong, EFI_GUID*, EFI_GUID*, byte*, byte*, EFI_STATUS> SignData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, ulong, EFI_GUID*, EFI_GUID*, ulong, byte*, ulong*, byte*, EFI_STATUS> DecryptData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_SMART_CARD_EDGE_PROTOCOL*, EFI_HANDLE, ulong, byte*, byte*, byte*, EFI_STATUS> BuildDHAgreement;
}
