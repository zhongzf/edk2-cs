...
{
  public static EFI_GUID EFI_DECOMPRESS_PROTOCOL_GUID = new GUID(
      0xd8117cfe, 0x94a6, 0x11d4, new byte[] { 0x9a, 0x3a, 0x0, 0x90, 0x27, 0x3f, 0xc1, 0x4d });
  ...
  //   IN   void                             *Source,
  //   IN   uint                           SourceSize,
  //   OUT  uint                           *DestinationSize,
  //   OUT  uint                           *ScratchSize
  //   );
...
public unsafe struct EFI_DECOMPRESS_PROTOCOL
{
  public readonly delegate* unmanaged</* IN */EFI_DECOMPRESS_PROTOCOL* /*This*/,/* IN */void* /*Source*/,/* IN */uint /*SourceSize*/,/* OUT */uint* /*DestinationSize*/,/* OUT */uint* /*ScratchSize*/, EFI_STATUS> /*EFI_DECOMPRESS_GET_INFO*/ GetInfo;
  public readonly delegate* unmanaged</* IN */EFI_DECOMPRESS_PROTOCOL* /*This*/,/* IN */void* /*Source*/,/* IN */uint /*SourceSize*/,/* IN OUT */void* /*Destination*/,/* IN */uint /*DestinationSize*/,/* IN OUT */void* /*Scratch*/,/* IN */uint /*ScratchSize*/, EFI_STATUS> /*EFI_DECOMPRESS_DECOMPRESS*/ Decompress;
}
