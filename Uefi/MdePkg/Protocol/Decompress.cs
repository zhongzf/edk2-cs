...
public unsafe struct EFI_DECOMPRESS_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_DECOMPRESS_PROTOCOL*, void*, uint, uint*, uint*, EFI_STATUS> GetInfo;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DECOMPRESS_PROTOCOL*, void*, uint, void*, uint, void*, uint, EFI_STATUS> Decompress;
}
