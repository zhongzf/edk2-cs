...
{
  public readonly delegate* unmanaged</* IN */EFI_BIS_PROTOCOL* /*This*/,/* OUT */BIS_APPLICATION_HANDLE* /*AppHandle*/,/* IN OUT */EFI_BIS_VERSION* /*InterfaceVersion*/,/* IN */EFI_BIS_DATA* /*TargetAddress*/, EFI_STATUS> /*EFI_BIS_INITIALIZE*/ Initialize;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/, EFI_STATUS> /*EFI_BIS_SHUTDOWN*/ Shutdown;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/,/* IN */EFI_BIS_DATA* /*ToFree*/, EFI_STATUS> /*EFI_BIS_FREE*/ Free;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/,/* OUT */EFI_BIS_DATA** /*Certificate*/, EFI_STATUS> /*EFI_BIS_GET_BOOT_OBJECT_AUTHORIZATION_CERTIFICATE*/ GetBootObjectAuthorizationCertificate;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/,/* OUT */bool* /*CheckIsRequired*/, EFI_STATUS> /*EFI_BIS_GET_BOOT_OBJECT_AUTHORIZATION_CHECKFLAG*/ GetBootObjectAuthorizationCheckFlag;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/,/* OUT */EFI_BIS_DATA** /*UpdateToken*/, EFI_STATUS> /*EFI_BIS_GET_BOOT_OBJECT_AUTHORIZATION_UPDATE_TOKEN*/ GetBootObjectAuthorizationUpdateToken;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/,/* OUT */EFI_BIS_DATA** /*SignatureInfo*/, EFI_STATUS> /*EFI_BIS_GET_SIGNATURE_INFO*/ GetSignatureInfo;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/,/* IN */EFI_BIS_DATA* /*RequestCredential*/,/* OUT */EFI_BIS_DATA** /*NewUpdateToken*/, EFI_STATUS> /*EFI_BIS_UPDATE_BOOT_OBJECT_AUTHORIZATION*/ UpdateBootObjectAuthorization;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/,/* IN */EFI_BIS_DATA* /*Credentials*/,/* IN */EFI_BIS_DATA* /*DataObject*/,/* OUT */bool* /*IsVerified*/, EFI_STATUS> /*EFI_BIS_VERIFY_BOOT_OBJECT*/ VerifyBootObject;
  public readonly delegate* unmanaged</* IN */BIS_APPLICATION_HANDLE /*AppHandle*/,/* IN */EFI_BIS_DATA* /*Credentials*/,/* IN */EFI_BIS_DATA* /*DataObject*/,/* IN */EFI_BIS_DATA* /*SectionName*/,/* IN */EFI_BIS_DATA* /*AuthorityCertificate*/,/* OUT */bool* /*IsVerified*/, EFI_STATUS> /*EFI_BIS_VERIFY_OBJECT_WITH_CREDENTIAL*/ VerifyObjectWithCredential;
}
