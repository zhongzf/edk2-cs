...
public unsafe struct EFI_LEGACY_SPI_FLASH_PROTOCOL
{
  ...
  /// Set the BIOS base address.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_LEGACY_SPI_FLASH_PROTOCOL* /*This*/,/* IN */uint /*BiosBaseAddress*/, EFI_STATUS> /*EFI_LEGACY_SPI_FLASH_PROTOCOL_BIOS_BASE_ADDRESS*/ BiosBaseAddress;
  ...
  /// Determine if the SPI range is protected.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_LEGACY_SPI_FLASH_PROTOCOL* /*This*/,/* IN */uint /*BiosAddress*/,/* IN */uint /*BlocksToProtect*/, EFI_STATUS> /*EFI_LEGACY_SPI_FLASH_PROTOCOL_IS_RANGE_PROTECTED*/ IsRangeProtected;

  ///
  /// Set the next protect range register.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_LEGACY_SPI_FLASH_PROTOCOL* /*This*/,/* IN */uint /*BiosAddress*/,/* IN */uint /*BlocksToProtect*/, EFI_STATUS> /*EFI_LEGACY_SPI_FLASH_PROTOCOL_PROTECT_NEXT_RANGE*/ ProtectNextRange;

  ///
  /// Lock the SPI controller configuration.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_LEGACY_SPI_FLASH_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_LEGACY_SPI_FLASH_PROTOCOL_LOCK_CONTROLLER*/ LockController;
}
