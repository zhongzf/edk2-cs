...
public unsafe struct EFI_IP6_ADDRESS_PAIR
{
  ///
  ...
  ///
  public EFI_IPv6_ADDRESS Ip6Address;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_IP6_VARIABLE_DATA
{
  ///
...
{
  public EFI_IPv6_ADDRESS Address;           ///< The IPv6 address.
...
{
  public EFI_IPv6_ADDRESS Neighbor;    ///< The on-link unicast/anycast IP address of the neighbor.
  public EFI_MAC_ADDRESS LinkAddress; ///< Link-layer address of the neighbor.
  public EFI_IP6_NEIGHBOR_STATE State;       ///< State of this neighbor cache entry.
}
...
{
  public byte Type;                  ///< The type of ICMP message.
  public byte Code;                  ///< The code of the ICMP message.
}
...
{
  public uint FragmentLength;                ///< Length of fragment data. This field may not be set to zero.
  public void* FragmentBuffer;               ///< Pointer to fragment data. This field may not be set to NULL.
}
...
{
  public byte Protocol;                 ///< Protocol type override.
  public byte HopLimit;                 ///< Hop-Limit override.
  public uint FlowLabel;                ///< Flow-Label override.
}
...
public unsafe struct EFI_IP6_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, EFI_IP6_MODE_DATA*, EFI_MANAGED_NETWORK_CONFIG_DATA*, EFI_SIMPLE_NETWORK_MODE*, EFI_STATUS> GetModeData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, EFI_IP6_CONFIG_DATA*, EFI_STATUS> Configure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, bool, EFI_IPv6_ADDRESS*, EFI_STATUS> Groups;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, bool, EFI_IPv6_ADDRESS*, byte, EFI_IPv6_ADDRESS*, EFI_STATUS> Routes;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, bool, EFI_IPv6_ADDRESS*, EFI_MAC_ADDRESS*, uint, bool, EFI_STATUS> Neighbors;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, EFI_IP6_COMPLETION_TOKEN*, EFI_STATUS> Transmit;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, EFI_IP6_COMPLETION_TOKEN*, EFI_STATUS> Receive;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, EFI_IP6_COMPLETION_TOKEN*, EFI_STATUS> Cancel;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_IP6_PROTOCOL*, EFI_STATUS> Poll;
}
