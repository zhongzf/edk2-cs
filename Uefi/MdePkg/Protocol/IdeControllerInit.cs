...
public unsafe struct EFI_IDE_CONTROLLER_INIT_PROTOCOL
{
  ...
  ///
  public readonly delegate* unmanaged</* IN */EFI_IDE_CONTROLLER_INIT_PROTOCOL* /*This*/,/* IN */byte /*Channel*/,/* OUT */bool* /*Enabled*/,/* OUT */byte* /*MaxDevices*/, EFI_STATUS> /*EFI_IDE_CONTROLLER_GET_CHANNEL_INFO*/ GetChannelInfo;

  ///
  /// The notification that the driver entity is about to enter the
  /// specified phase during the enumeration process.
  ///
  public readonly delegate* unmanaged</* IN */EFI_IDE_CONTROLLER_INIT_PROTOCOL* /*This*/,/* IN */EFI_IDE_CONTROLLER_ENUM_PHASE /*Phase*/,/* IN */byte /*Channel*/, EFI_STATUS> /*EFI_IDE_CONTROLLER_NOTIFY_PHASE*/ NotifyPhase;

  ///
  /// Submits the Drive Identify data that was returned by the device.
  ///
  public readonly delegate* unmanaged</* IN */EFI_IDE_CONTROLLER_INIT_PROTOCOL* /*This*/,/* IN */byte /*Channel*/,/* IN */byte /*Device*/,/* IN */EFI_IDENTIFY_DATA* /*IdentifyData*/, EFI_STATUS> /*EFI_IDE_CONTROLLER_SUBMIT_DATA*/ SubmitData;
