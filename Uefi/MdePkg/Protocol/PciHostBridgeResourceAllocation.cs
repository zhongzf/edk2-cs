...
///
public enum EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PHASE
{
  ///
...
///
public enum EFI_PCI_CONTROLLER_RESOURCE_ALLOCATION_PHASE
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL
{
  ///
  /// The notification from the PCI bus enumerator that it is about to enter
  /// a certain phase during the enumeration process.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL* /*This*/,/* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PHASE /*Phase*/, EFI_STATUS> /*EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL_NOTIFY_PHASE*/ NotifyPhase;
  ...
  ///
  public readonly delegate* unmanaged</* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL* /*This*/,/* IN OUT */EFI_HANDLE* /*RootBridgeHandle*/, EFI_STATUS> /*EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL_GET_NEXT_ROOT_BRIDGE*/ GetNextRootBridge;

  ///
  /// Retrieves the allocation-related attributes of a PCI root bridge.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*RootBridgeHandle*/,/* OUT */ulong* /*Attributes*/, EFI_STATUS> /*EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL_GET_ATTRIBUTES*/ GetAllocAttributes;

  ///
  /// Sets up a PCI root bridge for bus enumeration.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*RootBridgeHandle*/,/* OUT */void** /*Configuration*/, EFI_STATUS> /*EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL_START_BUS_ENUMERATION*/ StartBusEnumeration;

  ///
  /// Sets up the PCI root bridge so that it decodes a specific range of bus numbers.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*RootBridgeHandle*/,/* IN */void* /*Configuration*/, EFI_STATUS> /*EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL_SET_BUS_NUMBERS*/ SetBusNumbers;

  ///
  /// Submits the resource requirements for the specified PCI root bridge.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*RootBridgeHandle*/,/* IN */void* /*Configuration*/, EFI_STATUS> /*EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL_SUBMIT_RESOURCES*/ SubmitResources;

  ///
  /// Returns the proposed resource assignment for the specified PCI root bridges.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*RootBridgeHandle*/,/* OUT */void** /*Configuration*/, EFI_STATUS> /*EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL_GET_PROPOSED_RESOURCES*/ GetProposedResources;
  ...
  /// before enumeration.
  ///
  public readonly delegate* unmanaged</* IN */EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL* /*This*/,/* IN */EFI_HANDLE /*RootBridgeHandle*/,/* IN */EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL_PCI_ADDRESS /*PciAddress*/,/* IN */EFI_PCI_CONTROLLER_RESOURCE_ALLOCATION_PHASE /*Phase*/, EFI_STATUS> /*EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL_PREPROCESS_CONTROLLER*/ PreprocessController;
}
