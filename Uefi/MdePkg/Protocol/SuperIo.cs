...
[StructLayout(LayoutKind.Explicit)] public unsafe struct ACPI_RESOURCE_HEADER_PTR {
 [FieldOffset(0)] public ACPI_SMALL_RESOURCE_HEADER    *SmallHeader;
 [FieldOffset(0)] public ACPI_LARGE_RESOURCE_HEADER    *LargeHeader;
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_SIO_REGISTER_MODIFY {
 public byte    Register;    ///< Register number.
 public byte    AndMask;     ///< Bitwise AND mask.
 public byte    OrMask;      ///< Bitwise OR mask.
}
...
**/
public readonly delegate* unmanaged<CONST,bool,bool,byte,byte*, EFI_STATUS> RegisterAccess;
/**
...
**/
public readonly delegate* unmanaged<CONST,ACPI_RESOURCE_HEADER_PTR*, EFI_STATUS> GetResources;
/**
...
**/
public readonly delegate* unmanaged<CONST,ACPI_RESOURCE_HEADER_PTR, EFI_STATUS> SetResources;
/**
...
**/
public readonly delegate* unmanaged<CONST,ACPI_RESOURCE_HEADER_PTR*, EFI_STATUS> PossibleResources;
/**
...
**/
public readonly delegate* unmanaged<CONST,CONST,ulong, EFI_STATUS> Modify;
}
