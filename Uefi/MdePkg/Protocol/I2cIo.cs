...
public static ulong EFI_I2C_IO_PROTOCOL_GUID = { 0xb60a3e6b, 0x18c4, 0x46e5, { 0xa2, 0x9a, 0xc9, 0xa1, 0x06, 0x65, 0xa2, 0x8e }};
...
public unsafe struct EFI_I2C_IO_PROTOCOL {
  ///
...
**/
public readonly delegate* unmanaged<CONST,ulong,EFI_EVENT,EFI_I2C_REQUEST_PACKET*,EFI_STATUS*, EFI_STATUS> QueueRequest;
  ...
  ///
  CONSTpublic EFI_GUID                           *DeviceGuid;
 ...
 public uint                                   HardwareRevision;
  ...
  ///
  CONSTpublic EFI_I2C_CONTROLLER_CAPABILITIES    *I2cControllerCapabilities;
}
