...
public unsafe struct EFI_SIO_CONTROL_PROTOCOL
{
  ...
  /// Enable a device.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_SIO_CONTROL_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_SIO_CONTROL_ENABLE*/ EnableDevice;
  ///
  /// Disable a device.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_SIO_CONTROL_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_SIO_CONTROL_DISABLE*/ DisableDevice;
}
