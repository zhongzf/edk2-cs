...
public unsafe struct EFI_MM_SW_REGISTER_CONTEXT {
 public ulong    SwMmiInputValue;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_MM_SW_CONTEXT {
  ///
  /// The 0-based index of the CPU which generated the software MMI.
  ///
 public ulong    SwMmiCpuIndex;
  ///
...
/**
  ...
  @retval EFI_OUT_OF_RESOURCES   A unique software MMI value could not be assigned
                                 for this dispatch.
**/
public readonly delegate* unmanaged<CONST,EFI_MM_HANDLER_ENTRY_POINT,OUT,EFI_HANDLE*, EFI_STATUS> Register;
/**
