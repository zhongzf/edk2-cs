...
public static EFI_GUID EFI_HII_STRING_PROTOCOL_GUID = new GUID(0xfd96974, 0x23aa, 0x4cdc, new byte[] { 0xb9, 0xcb, 0x98, 0xd1, 0x77, 0x50, 0x32, 0x2a });
...
public unsafe struct EFI_HII_STRING_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_HII_HANDLE, EFI_STRING_ID*, CONST, CONST, CONST, CONST, EFI_STATUS> NewString;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, CONST, EFI_HII_HANDLE, EFI_STRING_ID, EFI_STRING, ulong*, EFI_FONT_INFO**, EFI_STATUS> GetString;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_HII_HANDLE, EFI_STRING_ID, CONST, EFI_STRING, CONST, EFI_STATUS> SetString;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_HII_HANDLE, byte*, ulong*, EFI_STATUS> GetLanguages;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_HII_HANDLE, CONST, byte*, ulong*, EFI_STATUS> GetSecondaryLanguages;
}
