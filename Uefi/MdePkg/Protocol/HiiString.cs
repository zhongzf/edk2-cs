...
public unsafe partial class EFI
{
  ...
  //   IN  CONST char                    *LanguageName  OPTIONAL,
  ...
  //   IN CONST  EFI_HII_STRING_PROTOCOL   *This,
  //   IN        EFI_HII_HANDLE            PackageList,
  //   IN OUT    byte                     *Languages,
  //   IN OUT    ulong                     *LanguagesSize
  //   );
  ...
  //   IN CONST  EFI_HII_STRING_PROTOCOL   *This,
  //   IN        EFI_HII_HANDLE            PackageList,
  //   IN CONST  byte                     *PrimaryLanguage,
  //   IN OUT    byte                     *SecondaryLanguages,
  //   IN OUT    ulong                     *SecondaryLanguagesSize
  //   );
}
...
public unsafe struct EFI_HII_STRING_PROTOCOL
{
  ...
  public readonly delegate* unmanaged</* IN CONST */EFI_HII_STRING_PROTOCOL* /*This*/,/* IN */EFI_HII_HANDLE /*PackageList*/,/* IN CONST */byte* /*PrimaryLanguage*/,/* IN OUT */byte* /*SecondaryLanguages*/,/* IN OUT */ulong* /*SecondaryLanguagesSize*/, EFI_STATUS> /*EFI_HII_GET_2ND_LANGUAGES*/ GetSecondaryLanguages;
}
