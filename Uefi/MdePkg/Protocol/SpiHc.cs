...
public unsafe struct EFI_SPI_HC_PROTOCOL
{
  ///
  ...
  /// Assert or deassert the SPI chip select.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_SPI_PERIPHERAL* /*SpiPeripheral*/,/* IN */bool /*PinValue*/, EFI_STATUS> /*EFI_SPI_HC_PROTOCOL_CHIP_SELECT*/ ChipSelect;

  ///
  /// Set up the clock generator to produce the correct clock frequency, phase
  /// and polarity for a SPI chip.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_SPI_PERIPHERAL* /*SpiPeripheral*/,/* IN */uint* /*ClockHz*/, EFI_STATUS> /*EFI_SPI_HC_PROTOCOL_CLOCK*/ Clock;
