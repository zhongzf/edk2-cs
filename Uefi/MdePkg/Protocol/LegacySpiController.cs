...
public unsafe struct EFI_LEGACY_SPI_CONTROLLER_PROTOCOL
{
  ...
  /// Set the erase block opcode.
  ///
  public readonly delegate* unmanaged</* IN */byte /*EraseBlockOpcode*/, EFI_STATUS> /*EFI_LEGACY_SPI_CONTROLLER_PROTOCOL_ERASE_BLOCK_OPCODE*/ EraseBlockOpcode;

  ///
  /// Set the write status prefix opcode.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_LEGACY_SPI_CONTROLLER_PROTOCOL* /*This*/,/* IN */byte /*WriteStatusPrefix*/, EFI_STATUS> /*EFI_LEGACY_SPI_CONTROLLER_PROTOCOL_WRITE_STATUS_PREFIX*/ WriteStatusPrefix;

  ///
  /// Set the BIOS base address.
  ///
  public readonly delegate* unmanaged</* IN */uint /*BiosBaseAddress*/, EFI_STATUS> /*EFI_LEGACY_SPI_CONTROLLER_PROTOCOL_BIOS_BASE_ADDRESS*/ BiosBaseAddress;

  ///
  /// Clear the SPI protect range registers.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_LEGACY_SPI_CONTROLLER_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_LEGACY_SPI_CONTROLLER_PROTOCOL_CLEAR_SPI_PROTECT*/ ClearSpiProtect;

  ///
  /// Determine if the SPI range is protected.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_LEGACY_SPI_CONTROLLER_PROTOCOL* /*This*/,/* IN */uint /*BiosAddress*/,/* IN */uint /*BlocksToProtect*/, EFI_STATUS> /*EFI_LEGACY_SPI_CONTROLLER_PROTOCOL_IS_RANGE_PROTECTED*/ IsRangeProtected;

  ///
  /// Set the next protect range register.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_LEGACY_SPI_CONTROLLER_PROTOCOL* /*This*/,/* IN */uint /*BiosAddress*/,/* IN */uint /*BlocksToProtect*/, EFI_STATUS> /*EFI_LEGACY_SPI_CONTROLLER_PROTOCOL_PROTECT_NEXT_RANGE*/ ProtectNextRange;

  ///
  /// Lock the SPI controller configuration.
  ///
  public readonly delegate* unmanaged<EFI_STATUS> /*EFI_LEGACY_SPI_CONTROLLER_PROTOCOL_LOCK_CONTROLLER*/ LockController;
}
