...
public unsafe struct EFI_DRIVER_CONFIGURATION_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_DRIVER_CONFIGURATION_PROTOCOL*, EFI_HANDLE, EFI_HANDLE, byte*, EFI_DRIVER_CONFIGURATION_ACTION_REQUIRED*, EFI_STATUS> SetOptions;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DRIVER_CONFIGURATION_PROTOCOL*, EFI_HANDLE, EFI_HANDLE, EFI_STATUS> OptionsValid;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DRIVER_CONFIGURATION_PROTOCOL*, EFI_HANDLE, EFI_HANDLE, uint, EFI_DRIVER_CONFIGURATION_ACTION_REQUIRED*, EFI_STATUS> ForceDefaults;
  ///
