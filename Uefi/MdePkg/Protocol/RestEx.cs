...
// *******************************************************
[StructLayout(LayoutKind.Explicit)] public unsafe struct EFI_REST_EX_SERVICE_INFO {
...
**/
public readonly delegate* unmanaged<EFI_REST_EX_PROTOCOL*,EFI_HTTP_MESSAGE*,EFI_HTTP_MESSAGE*, EFI_STATUS> SendReceive;
/**
...
**/
public readonly delegate* unmanaged<EFI_REST_EX_PROTOCOL*,EFI_TIME*, EFI_STATUS> GetServiceTime;
/**
...
**/
public readonly delegate* unmanaged<EFI_REST_EX_PROTOCOL*,EFI_REST_EX_SERVICE_INFO**, EFI_STATUS> GetService;
/**
...
**/
public readonly delegate* unmanaged<EFI_REST_EX_PROTOCOL*,EFI_REST_EX_CONFIG_DATA*, EFI_STATUS> GetModeData;
/**
...
**/
public readonly delegate* unmanaged<EFI_REST_EX_PROTOCOL*,EFI_REST_EX_CONFIG_DATA, EFI_STATUS> Configure;
/**
...
**/
public readonly delegate* unmanaged<EFI_REST_EX_PROTOCOL*,EFI_HTTP_MESSAGE*,EFI_REST_EX_TOKEN*,ulong*, EFI_STATUS> AyncSendReceive;
/**
...
**/
public readonly delegate* unmanaged<EFI_REST_EX_PROTOCOL*,EFI_HTTP_MESSAGE*,EFI_REST_EX_TOKEN*, EFI_STATUS> EventService;
}
