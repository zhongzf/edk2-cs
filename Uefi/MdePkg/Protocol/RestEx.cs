...
public unsafe partial class EFI
{
  ...
  public static EFI_GUID EFI_REST_EX_PROTOCOL_GUID = new GUID(
      0x55648b91, 0xe7d, 0x40a3, new byte[] { 0xa9, 0xb3, 0xa8, 0x15, 0xd7, 0xea, 0xdf, 0x97 });
...
public unsafe struct EFI_REST_EX_SERVICE_INFO_VER
{
  public byte Major;
  public byte Minor;
}
...
// *******************************************************
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_REST_EX_SERVICE_INFO_HEADER
{
  public uint Length;
  public EFI_REST_EX_SERVICE_INFO_VER RestServiceInfoVer;
}

// *******************************************************
// EFI_REST_EX_SERVICE_TYPE
// *******************************************************
public enum EFI_REST_EX_SERVICE_TYPE
{
...
// *******************************************************
public enum EFI_REST_EX_SERVICE_ACCESS_MODE
{
...
// *******************************************************
public enum EFI_REST_EX_CONFIG_TYPE
{
  EfiRestExConfigHttp,
...
// *******************************************************
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_REST_EX_SERVICE_INFO_V_1_0
{
  public EFI_REST_EX_SERVICE_INFO_HEADER EfiRestExServiceInfoHeader;
  public EFI_REST_EX_SERVICE_TYPE RestServiceType;
  public EFI_REST_EX_SERVICE_ACCESS_MODE RestServiceAccessMode;
  public EFI_GUID VendorRestServiceName;
  public uint VendorSpecificDataLength;
  public byte* VendorSpecifcData;
  public EFI_REST_EX_CONFIG_TYPE RestExConfigType;
  public byte RestExConfigDataLength;
}
...
public unsafe struct EFI_REST_EX_SERVICE_INFO
{
  [FieldOffset(0)] public EFI_REST_EX_SERVICE_INFO_HEADER EfiRestExServiceInfoHeader;
  [FieldOffset(0)] public EFI_REST_EX_SERVICE_INFO_V_1_0 EfiRestExServiceInfoV10;
}
...
// *******************************************************
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_REST_EX_HTTP_CONFIG_DATA
{
  public EFI_HTTP_CONFIG_DATA HttpConfigData;
...
// *******************************************************
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_REST_EX_CONFIG_DATA { byte* Value; public static implicit operator EFI_REST_EX_CONFIG_DATA(byte* value) => new EFI_REST_EX_CONFIG_DATA() { Value = value }; public static implicit operator byte*(EFI_REST_EX_CONFIG_DATA value) => value.Value; }

// *******************************************************
// EFI_REST_EX_TOKEN
// *******************************************************
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_REST_EX_TOKEN
{
  public EFI_EVENT Event;
  public EFI_STATUS Status;
  public EFI_HTTP_MESSAGE* ResponseMessage;
}
...
//   IN      ulong                  *TimeOutInMilliSeconds OPTIONAL
//   );
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_REST_EX_PROTOCOL
{
  public readonly delegate* unmanaged</* IN */EFI_REST_EX_PROTOCOL* /*This*/,/* IN */EFI_HTTP_MESSAGE* /*RequestMessage*/,/* OUT */EFI_HTTP_MESSAGE* /*ResponseMessage*/, EFI_STATUS> /*EFI_REST_SEND_RECEIVE*/ SendReceive;
  public readonly delegate* unmanaged</* IN */EFI_REST_EX_PROTOCOL* /*This*/,/* OUT */EFI_TIME* /*Time*/, EFI_STATUS> /*EFI_REST_GET_TIME*/ GetServiceTime;
  public readonly delegate* unmanaged</* IN */EFI_REST_EX_PROTOCOL* /*This*/,/* OUT */EFI_REST_EX_SERVICE_INFO** /*RestExServiceInfo*/, EFI_STATUS> /*EFI_REST_EX_GET_SERVICE*/ GetService;
  public readonly delegate* unmanaged</* IN */EFI_REST_EX_PROTOCOL* /*This*/,/* OUT */EFI_REST_EX_CONFIG_DATA* /*RestExConfigData*/, EFI_STATUS> /*EFI_REST_EX_GET_MODE_DATA*/ GetModeData;
  public readonly delegate* unmanaged</* IN */EFI_REST_EX_PROTOCOL* /*This*/,/* IN */EFI_REST_EX_CONFIG_DATA /*RestExConfigData*/, EFI_STATUS> /*EFI_REST_EX_CONFIGURE*/ Configure;
  public readonly delegate* unmanaged</* IN */EFI_REST_EX_PROTOCOL* /*This*/,/* IN */EFI_HTTP_MESSAGE* /*RequestMessage*/,/* IN */EFI_REST_EX_TOKEN* /*RestExToken*/,/* IN */ulong* /*TimeOutInMilliSeconds*/, EFI_STATUS> /*EFI_REST_EX_ASYNC_SEND_RECEIVE*/ AyncSendReceive;
  public readonly delegate* unmanaged</* IN */EFI_REST_EX_PROTOCOL* /*This*/,/* IN */EFI_HTTP_MESSAGE* /*RequestMessage*/,/* IN */EFI_REST_EX_TOKEN* /*RestExToken*/, EFI_STATUS> /*EFI_REST_EX_EVENT_SERVICE*/ EventService;
}
