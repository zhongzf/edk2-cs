...
{
  public static EFI_GUID EFI_TREE_PROTOCOL_GUID = new GUID(0x607f766c, 0x7455, 0x42be, new byte[] { 0x93, 0x0b, 0xe4, 0xd7, 0x6d, 0xb2, 0x72, 0x0f });
}
...
public unsafe struct TREE_BOOT_SERVICE_CAPABILITY_1_0
{
  ...
  //
  public TREE_VERSION StructureVersion;
  //
  // Version of the TrEE protocol.
  // For this version of the protocol, the Major version shall be set to 1
  // and the Minor version shall be set to 0.
  //
  public TREE_VERSION ProtocolVersion;
  //
  ...
  //
  public TREE_EVENT_LOG_BITMAP SupportedEventLogs;
  //
...
public unsafe struct TrEE_EVENT_HEADER
{
  ...
  //
  public TrEE_PCRINDEX PCRIndex;
  //
  // Type of the event that shall be extended (and optionally logged).
  //
  public TrEE_EVENTTYPE EventType;
}
...
public unsafe struct TrEE_EVENT
{
  ...
  //
  public uint Size;
  public TrEE_EVENT_HEADER Header;
...
{
  public readonly delegate* unmanaged</* IN */EFI_TREE_PROTOCOL* /*This*/,/* IN OUT */TREE_BOOT_SERVICE_CAPABILITY* /*ProtocolCapability*/, EFI_STATUS> /*EFI_TREE_GET_CAPABILITY*/ GetCapability;
  public readonly delegate* unmanaged</* IN */EFI_TREE_PROTOCOL* /*This*/,/* IN */TREE_EVENT_LOG_FORMAT /*EventLogFormat*/,/* OUT */EFI_PHYSICAL_ADDRESS* /*EventLogLocation*/,/* OUT */EFI_PHYSICAL_ADDRESS* /*EventLogLastEntry*/,/* OUT */bool* /*EventLogTruncated*/, EFI_STATUS> /*EFI_TREE_GET_EVENT_LOG*/ GetEventLog;
  public readonly delegate* unmanaged</* IN */EFI_TREE_PROTOCOL* /*This*/,/* IN */ulong /*Flags*/,/* IN */EFI_PHYSICAL_ADDRESS /*DataToHash*/,/* IN */ulong /*DataToHashLen*/,/* IN */TrEE_EVENT* /*Event*/, EFI_STATUS> /*EFI_TREE_HASH_LOG_EXTEND_EVENT*/ HashLogExtendEvent;
  public readonly delegate* unmanaged</* IN */EFI_TREE_PROTOCOL* /*This*/,/* IN */uint /*InputParameterBlockSize*/,/* IN */byte* /*InputParameterBlock*/,/* IN */uint /*OutputParameterBlockSize*/,/* IN */byte* /*OutputParameterBlock*/, EFI_STATUS> /*EFI_TREE_SUBMIT_COMMAND*/ SubmitCommand;
}
