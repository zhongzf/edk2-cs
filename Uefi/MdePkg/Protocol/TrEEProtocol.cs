...
public static ulong TREE_EVENT_LOG_FORMAT_TCG_1_2 = 0x00000001;
...
public static ulong TREE_BOOT_HASH_ALG_SHA1 = 0x00000001;
public static ulong TREE_BOOT_HASH_ALG_SHA256 = 0x00000002;
public static ulong TREE_BOOT_HASH_ALG_SHA384 = 0x00000004;
public static ulong TREE_BOOT_HASH_ALG_SHA512 = 0x00000008;

//
// This bit is shall be set when an event shall be extended but not logged.
//
public static ulong TREE_EXTEND_ONLY = 0x0000000000000001;
//
...
public static ulong TREE_EVENT_HEADER_VERSION = 1;
