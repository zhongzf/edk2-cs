...
public unsafe struct MM_COMPLETION { void* Value; public static implicit operator MM_COMPLETION(void* value) => new MM_COMPLETION() { Value = value }; public static implicit operator void*(MM_COMPLETION value) => value.Value; }

[StructLayout(LayoutKind.Sequential)]
public unsafe struct MM_DISPATCH_COMPLETION_TOKEN
{
  public MM_COMPLETION Completion;
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_MM_MP_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<CONST, ulong*, EFI_STATUS> GetNumberOfProcessors;
  /**
    ...
    @retval EFI_TIMEOUT                   In blocking mode, the timeout expired before the specified AP
                                          has finished
  **/
  public readonly delegate* unmanaged<CONST, EFI_AP_PROCEDURE2, ulong, ulong, void*, MM_COMPLETION*, EFI_STATUS*, EFI_STATUS> DispatchProcedure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_AP_PROCEDURE2, ulong, void*, MM_COMPLETION*, EFI_STATUS*, EFI_STATUS> BroadcastProcedure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_AP_PROCEDURE, void*, EFI_STATUS> SetStartupProcedure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, MM_COMPLETION, EFI_STATUS> CheckForProcedure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, MM_COMPLETION, EFI_STATUS> WaitForProcedure;
}
