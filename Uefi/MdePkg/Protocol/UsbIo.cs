...
public unsafe partial class EFI
{
  ...
  //   IN EFI_USB_IO_PROTOCOL            *This,
  //   OUT ushort                        **LangIDTable,
  //   OUT ushort                        *TableSize
  //   );
}
...
public unsafe struct EFI_USB_IO_PROTOCOL
{
  ...
  //
  public readonly delegate* unmanaged</* IN */EFI_USB_IO_PROTOCOL* /*This*/,/* OUT */EFI_USB_DEVICE_DESCRIPTOR* /*DeviceDescriptor*/, EFI_STATUS> /*EFI_USB_IO_GET_DEVICE_DESCRIPTOR*/ UsbGetDeviceDescriptor;
  public readonly delegate* unmanaged</* IN */EFI_USB_IO_PROTOCOL* /*This*/,/* OUT */EFI_USB_CONFIG_DESCRIPTOR* /*ConfigurationDescriptor*/, EFI_STATUS> /*EFI_USB_IO_GET_CONFIG_DESCRIPTOR*/ UsbGetConfigDescriptor;
  public readonly delegate* unmanaged</* IN */EFI_USB_IO_PROTOCOL* /*This*/,/* OUT */EFI_USB_INTERFACE_DESCRIPTOR* /*InterfaceDescriptor*/, EFI_STATUS> /*EFI_USB_IO_GET_INTERFACE_DESCRIPTOR*/ UsbGetInterfaceDescriptor;
  public readonly delegate* unmanaged</* IN */EFI_USB_IO_PROTOCOL* /*This*/,/* IN */byte /*EndpointIndex*/,/* OUT */EFI_USB_ENDPOINT_DESCRIPTOR* /*EndpointDescriptor*/, EFI_STATUS> /*EFI_USB_IO_GET_ENDPOINT_DESCRIPTOR*/ UsbGetEndpointDescriptor;
  public readonly delegate* unmanaged</* IN */EFI_USB_IO_PROTOCOL* /*This*/,/* IN */ushort /*LangID*/,/* IN */byte /*StringID*/,/* OUT */char** /*String*/, EFI_STATUS> /*EFI_USB_IO_GET_STRING_DESCRIPTOR*/ UsbGetStringDescriptor;
  public readonly delegate* unmanaged</* IN */EFI_USB_IO_PROTOCOL* /*This*/,/* OUT */ushort** /*LangIDTable*/,/* OUT */ushort* /*TableSize*/, EFI_STATUS> /*EFI_USB_IO_GET_SUPPORTED_LANGUAGE*/ UsbGetSupportedLanguages;

  //
  // Reset controller's parent port
  //
  public readonly delegate* unmanaged</* IN */EFI_USB_IO_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_USB_IO_PORT_RESET*/ UsbPortReset;
}
