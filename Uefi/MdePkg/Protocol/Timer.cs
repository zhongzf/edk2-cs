...
public unsafe struct EFI_TIMER_ARCH_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_TIMER_ARCH_PROTOCOL*, EFI_TIMER_NOTIFY, EFI_STATUS> RegisterHandler;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TIMER_ARCH_PROTOCOL*, ulong, EFI_STATUS> SetTimerPeriod;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TIMER_ARCH_PROTOCOL*, ulong*, EFI_STATUS> GetTimerPeriod;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TIMER_ARCH_PROTOCOL*, EFI_STATUS> GenerateSoftInterrupt;
}
