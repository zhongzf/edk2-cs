...
public unsafe partial class EFI
{
  public static EFI_GUID EFI_USB_HC_PROTOCOL_GUID = new GUID(
      0xf5089266, 0x1aa0, 0x4953, new byte[] { 0x97, 0xd8, 0x56, 0x2f, 0x8a, 0x73, 0xb5, 0x19 });
  ...
  //   IN     EFI_USB_HC_PROTOCOL       *This,
  //   IN     byte                     DeviceAddress,
  //   IN     bool                   IsSlowDevice,
  //   IN     byte                     MaximumPacketLength,
  //   IN     EFI_USB_DEVICE_REQUEST    *Request,
  //   IN     EFI_USB_DATA_DIRECTION    TransferDirection,
  //   IN OUT void                      *Data       OPTIONAL,
  //   IN OUT ulong                     *DataLength OPTIONAL,
  //   IN     ulong                     TimeOut,
  //   OUT    uint                    *TransferResult
  //   );
  ...
  //   IN     EFI_USB_HC_PROTOCOL    *This,
  //   IN     byte                  DeviceAddress,
  //   IN     byte                  EndPointAddress,
  //   IN     byte                  MaximumPacketLength,
  //   IN OUT void                   *Data,
  //   IN OUT ulong                  *DataLength,
  //   IN OUT byte                  *DataToggle,
  //   IN     ulong                  TimeOut,
  //   OUT    uint                 *TransferResult
  //   );
  ...
  //   IN     byte                                               EndPointAddress,
  //   IN     bool                                             IsSlowDevice,
  //   IN     byte                                               MaxiumPacketLength,
  //   IN     bool                                             IsNewTransfer,
  //   IN OUT byte                                               *DataToggle,
  //   IN     ulong                                               PollingInterval  OPTIONAL,
...
public unsafe struct EFI_USB_HC_PROTOCOL
{
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */ushort /*Attributes*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_RESET*/ Reset;
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* OUT */EFI_USB_HC_STATE* /*State*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_GET_STATE*/ GetState;
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */EFI_USB_HC_STATE /*State*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_SET_STATE*/ SetState;
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*DeviceAddress*/,/* IN */bool /*IsSlowDevice*/,/* IN */byte /*MaximumPacketLength*/,/* IN */EFI_USB_DEVICE_REQUEST* /*Request*/,/* IN */EFI_USB_DATA_DIRECTION /*TransferDirection*/,/* IN OUT */void* /*Data*/,/* IN OUT */ulong* /*DataLength*/,/* IN */ulong /*TimeOut*/,/* OUT */uint* /*TransferResult*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_CONTROL_TRANSFER*/ ControlTransfer;
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*DeviceAddress*/,/* IN */byte /*EndPointAddress*/,/* IN */byte /*MaximumPacketLength*/,/* IN OUT */void* /*Data*/,/* IN OUT */ulong* /*DataLength*/,/* IN OUT */byte* /*DataToggle*/,/* IN */ulong /*TimeOut*/,/* OUT */uint* /*TransferResult*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_BULK_TRANSFER*/ BulkTransfer;
  
  //public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*DeviceAddress*/,/* IN */byte /*EndPointAddress*/,/* IN */bool /*IsSlowDevice*/,/* IN */byte /*MaxiumPacketLength*/,/* IN */bool /*IsNewTransfer*/,/* IN OUT */byte* /*DataToggle*/,/* IN */ulong /*PollingInterval*/,/* IN */ulong /*DataLength*/,/* IN */EFI_ASYNC_USB_TRANSFER_CALLBACK /*CallBackFunction*/,/* IN */void* /*Context*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_ASYNC_INTERRUPT_TRANSFER*/ AsyncInterruptTransfer;
  public readonly void* AsyncInterruptTransfer;

  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*DeviceAddress*/,/* IN */byte /*EndPointAddress*/,/* IN */bool /*IsSlowDevice*/,/* IN */byte /*MaximumPacketLength*/,/* IN OUT */void* /*Data*/,/* IN OUT */ulong* /*DataLength*/,/* IN OUT */byte* /*DataToggle*/,/* IN */ulong /*TimeOut*/,/* OUT */uint* /*TransferResult*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_SYNC_INTERRUPT_TRANSFER*/ SyncInterruptTransfer;
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*DeviceAddress*/,/* IN */byte /*EndPointAddress*/,/* IN */byte /*MaximumPacketLength*/,/* IN OUT */void* /*Data*/,/* IN */ulong /*DataLength*/,/* OUT */uint* /*TransferResult*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_ISOCHRONOUS_TRANSFER*/ IsochronousTransfer;

  //public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*DeviceAddress*/,/* IN */byte /*EndPointAddress*/,/* IN */byte /*MaximumPacketLength*/,/* IN OUT */void* /*Data*/,/* IN */ulong /*DataLength*/,/* IN */EFI_ASYNC_USB_TRANSFER_CALLBACK /*IsochronousCallBack*/,/* IN */void* /*Context*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_ASYNC_ISOCHRONOUS_TRANSFER*/ AsyncIsochronousTransfer;
  public readonly void* AsyncIsochronousTransfer;

  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* OUT */byte* /*PortNumber*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_GET_ROOTHUB_PORT_NUMBER*/ GetRootHubPortNumber;
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*PortNumber*/,/* OUT */EFI_USB_PORT_STATUS* /*PortStatus*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_GET_ROOTHUB_PORT_STATUS*/ GetRootHubPortStatus;
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*PortNumber*/,/* IN */EFI_USB_PORT_FEATURE /*PortFeature*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_SET_ROOTHUB_PORT_FEATURE*/ SetRootHubPortFeature;
  public readonly delegate* unmanaged</* IN */EFI_USB_HC_PROTOCOL* /*This*/,/* IN */byte /*PortNumber*/,/* IN */EFI_USB_PORT_FEATURE /*PortFeature*/, EFI_STATUS> /*EFI_USB_HC_PROTOCOL_CLEAR_ROOTHUB_PORT_FEATURE*/ ClearRootHubPortFeature;
  ///
