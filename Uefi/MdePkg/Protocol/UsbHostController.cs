...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,ushort, EFI_STATUS> Reset;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,EFI_USB_HC_STATE*, EFI_STATUS> GetState;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,EFI_USB_HC_STATE, EFI_STATUS> SetState;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,bool,byte,EFI_USB_DEVICE_REQUEST*,EFI_USB_DATA_DIRECTION,void*,ulong*,ulong,uint*, EFI_STATUS> ControlTransfer;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,byte,byte,void*,ulong*,byte*,ulong,uint*, EFI_STATUS> BulkTransfer;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,byte,bool,byte,bool,byte*,ulong,ulong,EFI_ASYNC_USB_TRANSFER_CALLBACK,void*, EFI_STATUS> AsyncInterruptTransfer;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,byte,bool,byte,void*,ulong*,byte*,ulong,uint*, EFI_STATUS> SyncInterruptTransfer;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,byte,byte,void*,ulong,uint*, EFI_STATUS> IsochronousTransfer;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,byte,byte,void*,ulong,EFI_ASYNC_USB_TRANSFER_CALLBACK,void*, EFI_STATUS> AsyncIsochronousTransfer;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte*, EFI_STATUS> GetRootHubPortNumber;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,EFI_USB_PORT_STATUS*, EFI_STATUS> GetRootHubPortStatus;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,EFI_USB_PORT_FEATURE, EFI_STATUS> SetRootHubPortFeature;
/**
...
**/
public readonly delegate* unmanaged<EFI_USB_HC_PROTOCOL*,byte,EFI_USB_PORT_FEATURE, EFI_STATUS> ClearRootHubPortFeature;
  ///
