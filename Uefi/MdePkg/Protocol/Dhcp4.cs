...
public unsafe struct EFI_DHCP4_CONFIG_DATA
{
  ...
  ///
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/,/* IN */void* /*Context*/,/* IN */EFI_DHCP4_STATE /*CurrentState*/,/* IN */EFI_DHCP4_EVENT /*Dhcp4Event*/,/* IN */EFI_DHCP4_PACKET* /*Packet*/,/* OUT */EFI_DHCP4_PACKET** /*NewPacket*/, EFI_STATUS> /*EFI_DHCP4_CALLBACK*/ Dhcp4Callback;
  ///
...
{
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/,/* OUT */EFI_DHCP4_MODE_DATA* /*Dhcp4ModeData*/, EFI_STATUS> /*EFI_DHCP4_GET_MODE_DATA*/ GetModeData;
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/,/* IN */EFI_DHCP4_CONFIG_DATA* /*Dhcp4CfgData*/, EFI_STATUS> /*EFI_DHCP4_CONFIGURE*/ Configure;
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/,/* IN */EFI_EVENT /*CompletionEvent*/, EFI_STATUS> /*EFI_DHCP4_START*/ Start;
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/,/* IN */bool /*RebindRequest*/,/* IN */EFI_EVENT /*CompletionEvent*/, EFI_STATUS> /*EFI_DHCP4_RENEW_REBIND*/ RenewRebind;
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_DHCP4_RELEASE*/ Release;
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_DHCP4_STOP*/ Stop;
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/,/* IN */EFI_DHCP4_PACKET* /*SeedPacket*/,/* IN */uint /*DeleteCount*/,/* IN */byte* /*DeleteList*/,/* IN */uint /*AppendCount*/,/* IN */EFI_DHCP4_PACKET_OPTION* /*AppendList*/,/* OUT */EFI_DHCP4_PACKET** /*NewPacket*/, EFI_STATUS> /*EFI_DHCP4_BUILD*/ Build;
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/,/* IN */EFI_DHCP4_TRANSMIT_RECEIVE_TOKEN* /*Token*/, EFI_STATUS> /*EFI_DHCP4_TRANSMIT_RECEIVE*/ TransmitReceive;
  public readonly delegate* unmanaged</* IN */EFI_DHCP4_PROTOCOL* /*This*/,/* IN */EFI_DHCP4_PACKET* /*Packet*/,/* IN OUT */uint* /*OptionCount*/,/* OUT */EFI_DHCP4_PACKET_OPTION* /*PacketOptionList*/, EFI_STATUS> /*EFI_DHCP4_PARSE*/ Parse;
}
