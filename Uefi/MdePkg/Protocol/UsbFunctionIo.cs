...
public static EFI_GUID EFI_USBFN_IO_PROTOCOL_GUID = new GUID( 
      0x32d2963a, 0xfe5d, 0x4f30, new byte[] {0xb6, 0x33, 0x6e, 0x5d, 0xc5, 0x58, 0x3, 0xcc});

// typedef struct _EFI_USBFN_IO_PROTOCOL EFI_USBFN_IO_PROTOCOL;

public static ulong EFI_USBFN_IO_PROTOCOL_REVISION = 0x00010001;
...
public unsafe struct EFI_USB_INTERFACE_INFO {
 public EFI_USB_INTERFACE_DESCRIPTOR    *InterfaceDescriptor;
 public EFI_USB_ENDPOINT_DESCRIPTOR     **EndpointDescriptorTable;
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_USB_CONFIG_INFO {
 public EFI_USB_CONFIG_DESCRIPTOR    *ConfigDescriptor;
 public EFI_USB_INTERFACE_INFO       **InterfaceInfoTable;
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_USB_DEVICE_INFO {
 public EFI_USB_DEVICE_DESCRIPTOR    *DeviceDescriptor;
...
public unsafe struct EFI_USBFN_TRANSFER_RESULT {
 ...
 public EFI_USBFN_TRANSFER_STATUS       TransferStatus;
 public byte                           EndpointIndex;
 public EFI_USBFN_ENDPOINT_DIRECTION    Direction;
 public void                            *Buffer;
}
...
[StructLayout(LayoutKind.Explicit)] public unsafe struct EFI_USBFN_MESSAGE_PAYLOAD {
 [FieldOffset(0)] public EFI_USB_DEVICE_REQUEST       udr;
 [FieldOffset(0)] public EFI_USBFN_TRANSFER_RESULT    utr;
