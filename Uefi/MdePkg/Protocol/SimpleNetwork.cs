...
public static ulong EFI_SIMPLE_NETWORK_RECEIVE_UNICAST = 0x01;
public static ulong EFI_SIMPLE_NETWORK_RECEIVE_MULTICAST = 0x02;
public static ulong EFI_SIMPLE_NETWORK_RECEIVE_BROADCAST = 0x04;
public static ulong EFI_SIMPLE_NETWORK_RECEIVE_PROMISCUOUS = 0x08;
public static ulong EFI_SIMPLE_NETWORK_RECEIVE_PROMISCUOUS_MULTICAST = 0x10;

public static ulong EFI_SIMPLE_NETWORK_RECEIVE_INTERRUPT = 0x01;
public static ulong EFI_SIMPLE_NETWORK_TRANSMIT_INTERRUPT = 0x02;
public static ulong EFI_SIMPLE_NETWORK_COMMAND_INTERRUPT = 0x04;
public static ulong EFI_SIMPLE_NETWORK_SOFTWARE_INTERRUPT = 0x08;

public static ulong MAX_MCAST_FILTER_CNT = 16;
[StructLayout(LayoutKind.Sequential)]
...
public static ulong EFI_SIMPLE_NETWORK_PROTOCOL_REVISION = 0x00010000;

//
// Revision defined in EFI1.1
//
public static ulong EFI_SIMPLE_NETWORK_INTERFACE_REVISION = EFI_SIMPLE_NETWORK_PROTOCOL_REVISION;
