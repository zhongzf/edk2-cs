...
{
  public static EFI_GUID EFI_KMS_PROTOCOL_GUID = new GUID(
      0xEC3A978D, 0x7C4E, 0x48FA, new byte[] { 0x9A, 0xBE, 0x6A, 0xD9, 0x1C, 0xC8, 0xF8, 0x11 });
  ...
  ///@{
  public static EFI_GUID EFI_KMS_FORMAT_GENERIC_128_GUID = new GUID(
      0xec8a3d69, 0x6ddf, 0x4108, new byte[] { 0x94, 0x76, 0x73, 0x37, 0xfc, 0x52, 0x21, 0x36 });
  public static EFI_GUID EFI_KMS_FORMAT_GENERIC_160_GUID = new GUID(
      0xa3b3e6f8, 0xefca, 0x4bc1, new byte[] { 0x88, 0xfb, 0xcb, 0x87, 0x33, 0x9b, 0x25, 0x79 });
  public static EFI_GUID EFI_KMS_FORMAT_GENERIC_256_GUID = new GUID(
      0x70f64793, 0xc323, 0x4261, new byte[] { 0xac, 0x2c, 0xd8, 0x76, 0xf2, 0x7c, 0x53, 0x45 });
  public static EFI_GUID EFI_KMS_FORMAT_GENERIC_512_GUID = new GUID(
      0x978fe043, 0xd7af, 0x422e, new byte[] { 0x8a, 0x92, 0x2b, 0x48, 0xe4, 0x63, 0xbd, 0xe6 });
  public static EFI_GUID EFI_KMS_FORMAT_GENERIC_1024_GUID = new GUID(
      0x43be0b44, 0x874b, 0x4ead, new byte[] { 0xb0, 0x9c, 0x24, 0x1a, 0x4f, 0xbd, 0x7e, 0xb3 });
  public static EFI_GUID EFI_KMS_FORMAT_GENERIC_2048_GUID = new GUID(
      0x40093f23, 0x630c, 0x4626, new byte[] { 0x9c, 0x48, 0x40, 0x37, 0x3b, 0x19, 0xcb, 0xbe });
  public static EFI_GUID EFI_KMS_FORMAT_GENERIC_3072_GUID = new GUID(
      0xb9237513, 0x6c44, 0x4411, new byte[] { 0xa9, 0x90, 0x21, 0xe5, 0x56, 0xe0, 0x5a, 0xde });
  public static EFI_GUID EFI_KMS_FORMAT_GENERIC_DYNAMIC_GUID = new GUID(
      0x2156e996, 0x66de, 0x4b27, new byte[] { 0x9c, 0xc9, 0xb0, 0x9f, 0xac, 0x4d, 0x2, 0xbe });
  ///@}
  ...
  ///@{
  public static EFI_GUID EFI_KMS_FORMAT_MD2_128_GUID = new GUID(
      0x78be11c4, 0xee44, 0x4a22, new byte[] { 0x9f, 0x05, 0x03, 0x85, 0x2e, 0xc5, 0xc9, 0x78 });
  public static EFI_GUID EFI_KMS_FORMAT_MDC2_128_GUID = new GUID(
      0xf7ad60f8, 0xefa8, 0x44a3, new byte[] { 0x91, 0x13, 0x23, 0x1f, 0x39, 0x9e, 0xb4, 0xc7 });
  public static EFI_GUID EFI_KMS_FORMAT_MD4_128_GUID = new GUID(
      0xd1c17aa1, 0xcac5, 0x400f, new byte[] { 0xbe, 0x17, 0xe2, 0xa2, 0xae, 0x06, 0x67, 0x7c });
  public static EFI_GUID EFI_KMS_FORMAT_MDC4_128_GUID = new GUID(
      0x3fa4f847, 0xd8eb, 0x4df4, new byte[] { 0xbd, 0x49, 0x10, 0x3a, 0x0a, 0x84, 0x7b, 0xbc });
  public static EFI_GUID EFI_KMS_FORMAT_MD5_128_GUID = new GUID(
      0xdcbc3662, 0x9cda, 0x4b52, new byte[] { 0xa0, 0x4c, 0x82, 0xeb, 0x1d, 0x23, 0x48, 0xc7 });
  public static EFI_GUID EFI_KMS_FORMAT_MD5SHA_128_GUID = new GUID(
      0x1c178237, 0x6897, 0x459e, new byte[] { 0x9d, 0x36, 0x67, 0xce, 0x8e, 0xf9, 0x4f, 0x76 });
  public static EFI_GUID EFI_KMS_FORMAT_SHA1_160_GUID = new GUID(
      0x453c5e5a, 0x482d, 0x43f0, new byte[] { 0x87, 0xc9, 0x59, 0x41, 0xf3, 0xa3, 0x8a, 0xc2 });
  public static EFI_GUID EFI_KMS_FORMAT_SHA256_256_GUID = new GUID(
      0x6bb4f5cd, 0x8022, 0x448d, new byte[] { 0xbc, 0x6d, 0x77, 0x1b, 0xae, 0x93, 0x5f, 0xc6 });
  public static EFI_GUID EFI_KMS_FORMAT_SHA512_512_GUID = new GUID(
      0x2f240e12, 0xe14d, 0x475c, new byte[] { 0x83, 0xb0, 0xef, 0xff, 0x22, 0xd7, 0x7b, 0xe7 });
  ///@}
  ...
  ///@{
  public static EFI_GUID EFI_KMS_FORMAT_AESXTS_128_GUID = new GUID(
      0x4776e33f, 0xdb47, 0x479a, new byte[] { 0xa2, 0x5f, 0xa1, 0xcd, 0x0a, 0xfa, 0xb3, 0x8b });
  public static EFI_GUID EFI_KMS_FORMAT_AESXTS_256_GUID = new GUID(
      0xdc7e8613, 0xc4bb, 0x4db0, new byte[] { 0x84, 0x62, 0x13, 0x51, 0x13, 0x57, 0xab, 0xe2 });
  public static EFI_GUID EFI_KMS_FORMAT_AESCBC_128_GUID = new GUID(
      0xa0e8ee6a, 0x0e92, 0x44d4, new byte[] { 0x86, 0x1b, 0x0e, 0xaa, 0x4a, 0xca, 0x44, 0xa2 });
  public static EFI_GUID EFI_KMS_FORMAT_AESCBC_256_GUID = new GUID(
      0xd7e69789, 0x1f68, 0x45e8, new byte[] { 0x96, 0xef, 0x3b, 0x64, 0x07, 0xa5, 0xb2, 0xdc });
  public static EFI_GUID EFI_KMS_FORMAT_RSASHA1_1024_GUID = new GUID(
      0x56417bed, 0x6bbe, 0x4882, new byte[] { 0x86, 0xa0, 0x3a, 0xe8, 0xbb, 0x17, 0xf8, 0xf9 });
  public static EFI_GUID EFI_KMS_FORMAT_RSASHA1_2048_GUID = new GUID(
      0xf66447d4, 0x75a6, 0x463e, new byte[] { 0xa8, 0x19, 0x07, 0x7f, 0x2d, 0xda, 0x05, 0xe9 });
  public static EFI_GUID EFI_KMS_FORMAT_RSASHA256_2048_GUID = new GUID(
      0xa477af13, 0x877d, 0x4060, new byte[] { 0xba, 0xa1, 0x25, 0xd1, 0xbe, 0xa0, 0x8a, 0xd3 });
  public static EFI_GUID EFI_KMS_FORMAT_RSASHA256_3072_GUID = new GUID(
...
public unsafe struct EFI_KMS_FORMAT_GENERIC_DYNAMIC
{
  ...
  /// The data of the key.
  ///
  public fixed byte KeyData[1];
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_KMS_CLIENT_INFO
{
  ///
  /// The size in bytes for the client identifier.
  ///
  public ushort ClientIdSize;
  ///
...
public unsafe struct EFI_KMS_KEY_DESCRIPTOR
{
  ...
  ///
  public EFI_STATUS KeyStatus;
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_KMS_DYNAMIC_FIELD
{
  ///
  ...
  ///
  public fixed byte KeyAttributeData[1];
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_KMS_DYNAMIC_ATTRIBUTE
{
  ///
  ...
  ///
  public EFI_KMS_DYNAMIC_FIELD[/*1*/] Field;
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_KMS_KEY_ATTRIBUTE
{
  ///
  ...
  ///
  public byte KeyAttributeIdentifierType;
  ///
  ...
  ///
  public byte KeyAttributeIdentifierCount;
  ///
  ...
  ///
  public void* KeyAttributeIdentifier;
  ///
  ...
  ///
  public ushort KeyAttributeValueSize;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_KMS_PROTOCOL
{
  ///
  ...
  /// FALSE otherwise.
  ///
  public bool ClientDataSupported;
  ///
  ...
  ///
  public byte KeyAttributeIdStringTypes;
  public ushort KeyAttributeIdMaxCount;
  ///
  ...
  ///
  public ulong KeyAttributesCount;
  ///
  ...
  ///
  public EFI_KMS_KEY_ATTRIBUTE* KeyAttributes;
}
