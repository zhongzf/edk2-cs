...
public unsafe struct EFI_USER_CREDENTIAL2_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_USER_PROFILE_HANDLE, EFI_STATUS> Enroll;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_HII_HANDLE*, EFI_GUID*, EFI_FORM_ID*, EFI_STATUS> Form;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, ulong*, ulong*, EFI_HII_HANDLE*, EFI_IMAGE_ID*, EFI_STATUS> Tile;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_HII_HANDLE*, EFI_STRING_ID*, EFI_STATUS> Title;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_USER_PROFILE_HANDLE, EFI_USER_INFO_IDENTIFIER*, EFI_STATUS> User;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_CREDENTIAL_LOGON_FLAGS*, EFI_STATUS> Select;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_STATUS> Deselect;
  /**
    ...
    @retval EFI_INVALID_PARAMETER  AutoLogon is NULL.
  **/
  public readonly delegate* unmanaged<CONST, EFI_CREDENTIAL_LOGON_FLAGS*, EFI_STATUS> Default;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_USER_INFO_HANDLE, EFI_USER_INFO*, ulong*, EFI_STATUS> GetInfo;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_USER_INFO_HANDLE*, EFI_STATUS> GetNextInfo;
