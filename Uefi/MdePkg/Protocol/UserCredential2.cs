...
{
  public static EFI_GUID EFI_USER_CREDENTIAL2_PROTOCOL_GUID = new GUID(
      0xe98adb03, 0xb8b9, 0x4af8, new byte[] { 0xba, 0x20, 0x26, 0xe9, 0x11, 0x4c, 0xbc, 0xe5 });
...
public unsafe struct EFI_USER_CREDENTIAL2_PROTOCOL
{
  public EFI_GUID Identifier; ///< Uniquely identifies this credential provider.
  public EFI_GUID Type;       ///< Identifies this class of User Credential Provider.
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* IN */EFI_USER_PROFILE_HANDLE /*User*/, EFI_STATUS> /*EFI_CREDENTIAL2_ENROLL*/ Enroll;
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* OUT */EFI_HII_HANDLE* /*Hii*/,/* OUT */EFI_GUID* /*FormSetId*/,/* OUT */EFI_FORM_ID* /*FormId*/, EFI_STATUS> /*EFI_CREDENTIAL2_FORM*/ Form;
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* IN OUT */ulong* /*Width*/,/* IN OUT */ulong* /*Height*/,/* OUT */EFI_HII_HANDLE* /*Hii*/,/* OUT */EFI_IMAGE_ID* /*Image*/, EFI_STATUS> /*EFI_CREDENTIAL2_TILE*/ Tile;
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* OUT */EFI_HII_HANDLE* /*Hii*/,/* OUT */EFI_STRING_ID* /*String*/, EFI_STATUS> /*EFI_CREDENTIAL2_TITLE*/ Title;
  //public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* IN */EFI_USER_PROFILE_HANDLE /*User*/,/* OUT */EFI_USER_INFO_IDENTIFIER* /*Identifier*/, EFI_STATUS> /*EFI_CREDENTIAL2_USER*/ User;
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* OUT */EFI_CREDENTIAL_LOGON_FLAGS* /*AutoLogon*/, EFI_STATUS> /*EFI_CREDENTIAL2_SELECT*/ Select;
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_CREDENTIAL2_DESELECT*/ Deselect;
  public readonly delegate* unmanaged</* IN  CONST */ EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/ ,/* OUT */EFI_CREDENTIAL_LOGON_FLAGS* /*AutoLogon*/, EFI_STATUS> /*EFI_CREDENTIAL2_DEFAULT*/ Default;
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* IN */EFI_USER_INFO_HANDLE /*UserInfo*/,/* OUT */EFI_USER_INFO* /*Info*/,/* IN OUT */ulong* /*InfoSize*/, EFI_STATUS> /*EFI_CREDENTIAL2_GET_INFO*/ GetInfo;
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* IN OUT */EFI_USER_INFO_HANDLE* /*UserInfo*/, EFI_STATUS> /*EFI_CREDENTIAL2_GET_NEXT_INFO*/ GetNextInfo;
  public EFI_CREDENTIAL_CAPABILITIES Capabilities;
  public readonly delegate* unmanaged</* IN CONST */EFI_USER_CREDENTIAL2_PROTOCOL* /*This*/,/* IN */EFI_USER_PROFILE_HANDLE /*User*/, EFI_STATUS> /*EFI_CREDENTIAL2_DELETE*/ Delete;
}
