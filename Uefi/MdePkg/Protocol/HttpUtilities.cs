...
public unsafe struct EFI_HTTP_UTILITIES_PROTOCOL
{
  /**
    ...
    @retval EFI_INVALID_PARAMETER   One or more of the following conditions is TRUE:
                                    This is NULL.
  **/
  public readonly delegate* unmanaged<EFI_HTTP_UTILITIES_PROTOCOL*, ulong, void*, ulong, byte*, ulong, EFI_HTTP_HEADER*, ulong*, void**, EFI_STATUS> Build;
  /**
    ...
    @retval EFI_INVALID_PARAMETER   One or more of the following conditions is TRUE:
                                    ...
                                    FieldCount is NULL.
  **/
  public readonly delegate* unmanaged<EFI_HTTP_UTILITIES_PROTOCOL*, byte*, ulong, EFI_HTTP_HEADER**, ulong*, EFI_STATUS> Parse;
}
