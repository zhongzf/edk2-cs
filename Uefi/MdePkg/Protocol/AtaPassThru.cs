...
public static EFI_GUID EFI_ATA_PASS_THRU_PROTOCOL_GUID = new GUID(
    0x1d3de7f0, 0x807, 0x424f, new byte[] { 0xaa, 0x69, 0x11, 0xa5, 0x4e, 0x19, 0xa4, 0x6f });
...
public unsafe struct EFI_ATA_PASS_THRU_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_ATA_PASS_THRU_PROTOCOL*, ushort, ushort, EFI_ATA_PASS_THRU_COMMAND_PACKET*, EFI_EVENT, EFI_STATUS> PassThru;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_ATA_PASS_THRU_PROTOCOL*, ushort*, EFI_STATUS> GetNextPort;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_ATA_PASS_THRU_PROTOCOL*, ushort, ushort*, EFI_STATUS> GetNextDevice;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_ATA_PASS_THRU_PROTOCOL*, ushort, ushort, EFI_DEVICE_PATH_PROTOCOL**, EFI_STATUS> BuildDevicePath;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_ATA_PASS_THRU_PROTOCOL*, EFI_DEVICE_PATH_PROTOCOL*, ushort*, ushort*, EFI_STATUS> GetDevice;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_ATA_PASS_THRU_PROTOCOL*, ushort, EFI_STATUS> ResetPort;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_ATA_PASS_THRU_PROTOCOL*, ushort, ushort, EFI_STATUS> ResetDevice;
}
