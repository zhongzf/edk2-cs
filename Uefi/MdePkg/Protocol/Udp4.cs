...
public unsafe struct EFI_UDP4_SERVICE_POINT
{
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_UDP4_VARIABLE_DATA
{
...
{
  public EFI_UDP4_SESSION_DATA* UdpSessionData;       // OPTIONAL
...
public unsafe struct EFI_UDP4_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_UDP4_PROTOCOL*, EFI_UDP4_CONFIG_DATA*, EFI_IP4_MODE_DATA*, EFI_MANAGED_NETWORK_CONFIG_DATA*, EFI_SIMPLE_NETWORK_MODE*, EFI_STATUS> GetModeData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_UDP4_PROTOCOL*, EFI_UDP4_CONFIG_DATA*, EFI_STATUS> Configure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_UDP4_PROTOCOL*, bool, EFI_IPv4_ADDRESS*, EFI_STATUS> Groups;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_UDP4_PROTOCOL*, bool, EFI_IPv4_ADDRESS*, EFI_IPv4_ADDRESS*, EFI_IPv4_ADDRESS*, EFI_STATUS> Routes;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_UDP4_PROTOCOL*, EFI_UDP4_COMPLETION_TOKEN*, EFI_STATUS> Transmit;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_UDP4_PROTOCOL*, EFI_UDP4_COMPLETION_TOKEN*, EFI_STATUS> Receive;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_UDP4_PROTOCOL*, EFI_UDP4_COMPLETION_TOKEN*, EFI_STATUS> Cancel;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_UDP4_PROTOCOL*, EFI_STATUS> Poll;
}
