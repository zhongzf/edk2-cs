...
{
  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/,/* IN */bool /*ExtendedVerification*/, EFI_STATUS> /*EFI_TEXT_RESET*/ Reset;

  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/,/* IN */char* /*String*/, EFI_STATUS> /*EFI_TEXT_STRING*/ OutputString;
  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/,/* IN */char* /*String*/, EFI_STATUS> /*EFI_TEXT_TEST_STRING*/ TestString;

  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/,/* IN */ulong /*ModeNumber*/,/* OUT */ulong* /*Columns*/,/* OUT */ulong* /*Rows*/, EFI_STATUS> /*EFI_TEXT_QUERY_MODE*/ QueryMode;
  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/,/* IN */ulong /*ModeNumber*/, EFI_STATUS> /*EFI_TEXT_SET_MODE*/ SetMode;
  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/,/* IN */ulong /*Attribute*/, EFI_STATUS> /*EFI_TEXT_SET_ATTRIBUTE*/ SetAttribute;

  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_TEXT_CLEAR_SCREEN*/ ClearScreen;
  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/,/* IN */ulong /*Column*/,/* IN */ulong /*Row*/, EFI_STATUS> /*EFI_TEXT_SET_CURSOR_POSITION*/ SetCursorPosition;
  public readonly delegate* unmanaged</* IN */EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* /*This*/,/* IN */bool /*Visible*/, EFI_STATUS> /*EFI_TEXT_ENABLE_CURSOR*/ EnableCursor;
