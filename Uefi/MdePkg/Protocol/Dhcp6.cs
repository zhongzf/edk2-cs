...
public static EFI_GUID EFI_DHCP6_PROTOCOL_GUID = new GUID(
    0x87c8bad7, 0x595, 0x4053, new byte[] { 0x82, 0x97, 0xde, 0xde, 0x39, 0x5f, 0x5d, 0x5b });

public static EFI_GUID EFI_DHCP6_SERVICE_BINDING_PROTOCOL_GUID = new GUID(
    0x9fb9a8a1, 0x2f4a, 0x43a6, new byte[] { 0x88, 0x9c, 0xd0, 0xf7, 0xb6, 0xc4, 0x7a, 0xd5 });

// typedef struct _EFI_DHCP6_PROTOCOL EFI_DHCP6_PROTOCOL;

public enum EFI_DHCP6_STATE
{
  ///
...
public unsafe struct EFI_DHCP6_PACKET_OPTION
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DHCP6_HEADER
{
  ///
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DHCP6_DUID
{
  ///
  ...
  ///
  public fixed byte Duid[1];
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DHCP6_RETRANSMISSION
{
  ///
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DHCP6_IA_ADDRESS
{
  ///
  /// The IPv6 address.
  ///
  public EFI_IPv6_ADDRESS IpAddress;
  ///
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DHCP6_IA_DESCRIPTOR
{
  public ushort Type;                    ///< Type for an IA.
  public uint IaId;                    ///< The identifier for an IA.
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DHCP6_IA
{
  ///
  /// The descriptor for IA.
  ///
  public EFI_DHCP6_IA_DESCRIPTOR Descriptor;
  ///
  /// The state of the configured IA.
  ///
  public EFI_DHCP6_STATE State;
  ///
  /// Pointer to the cached latest Reply packet. May be NULL if no packet is cached.
  ///
  public EFI_DHCP6_PACKET* ReplyPacket;
  ///
  /// Number of IPv6 addresses of the configured IA.
  ///
  public uint IaAddressCount;
  ///
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DHCP6_CONFIG_DATA
{
  ///
  ...
  ///
  public EFI_DHCP6_CALLBACK Dhcp6Callback;
  ///
  ...
  /// automatically.
  ///
  public EFI_DHCP6_PACKET_OPTION** OptionList;
  ///
  /// The descriptor for the IA of the EFI DHCPv6 Protocol instance.
  ///
  public EFI_DHCP6_IA_DESCRIPTOR IaDescriptor;
  ///
  ...
  ///
  public EFI_DHCP6_RETRANSMISSION* SolicitRetransmission;
}
...
public unsafe struct EFI_DHCP6_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, EFI_DHCP6_MODE_DATA*, EFI_DHCP6_CONFIG_DATA*, EFI_STATUS> GetModeData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, EFI_DHCP6_CONFIG_DATA*, EFI_STATUS> Configure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, EFI_STATUS> Start;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, bool, EFI_DHCP6_PACKET_OPTION*, uint, EFI_DHCP6_PACKET_OPTION*, EFI_DHCP6_RETRANSMISSION*, EFI_EVENT, EFI_DHCP6_INFO_CALLBACK, void*, EFI_STATUS> InfoRequest;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, bool, EFI_STATUS> RenewRebind;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, uint, EFI_IPv6_ADDRESS*, EFI_STATUS> Decline;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, uint, EFI_IPv6_ADDRESS*, EFI_STATUS> Release;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, EFI_STATUS> Stop;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DHCP6_PROTOCOL*, EFI_DHCP6_PACKET*, uint*, EFI_DHCP6_PACKET_OPTION*, EFI_STATUS> Parse;
}
