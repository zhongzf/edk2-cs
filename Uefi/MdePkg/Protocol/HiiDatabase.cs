...
public unsafe partial class EFI
{
  ...
  //   IN        byte                     PackageType,
  //   IN CONST  EFI_GUID                  *PackageGuid,
  //   IN OUT    ulong                     *HandleBufferLength,
  //   OUT       EFI_HII_HANDLE            *Handle
  //   );
  ...
  //   IN CONST  EFI_HII_DATABASE_PROTOCOL *This,
  //   IN OUT    ushort                    *KeyGuidBufferLength,
  ...
  //   IN OUT ushort                       *KeyboardLayoutLength,
...
{
  public readonly delegate* unmanaged</* IN CONST */EFI_HII_DATABASE_PROTOCOL* /*This*/,/* IN CONST */EFI_HII_PACKAGE_LIST_HEADER* /*PackageList*/,/* IN */EFI_HANDLE /*DriverHandle*/,/* OUT */EFI_HII_HANDLE* /*Handle*/, EFI_STATUS> /*EFI_HII_DATABASE_NEW_PACK*/ NewPackageList;
  public readonly delegate* unmanaged</* IN CONST */EFI_HII_DATABASE_PROTOCOL* /*This*/,/* IN */EFI_HII_HANDLE /*Handle*/, EFI_STATUS> /*EFI_HII_DATABASE_REMOVE_PACK*/ RemovePackageList;
  ...
  public readonly delegate* unmanaged</* IN CONST */EFI_HII_DATABASE_PROTOCOL* /*This*/,/* IN CONST */EFI_GUID* /*KeyGuid*/, EFI_STATUS> /*EFI_HII_SET_KEYBOARD_LAYOUT*/ SetKeyboardLayout;
  public readonly delegate* unmanaged</* IN CONST */EFI_HII_DATABASE_PROTOCOL* /*This*/,/* IN */EFI_HII_HANDLE /*PackageListHandle*/,/* OUT */EFI_HANDLE* /*DriverHandle*/, EFI_STATUS> /*EFI_HII_DATABASE_GET_PACK_HANDLE*/ GetPackageListHandle;
}
