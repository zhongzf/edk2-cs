...
public unsafe struct EFI_DNS6_CONFIG_DATA
{
  ///
  ...
  ///
  public EFI_IPv6_ADDRESS* DnsServerList;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DNS6_CACHE_ENTRY
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DNS6_MODE_DATA
{
  ///
  /// The configuration data of this instance.
  ///
  public EFI_DNS6_CONFIG_DATA DnsConfigData;
  ///
  ...
  ///
  public EFI_DNS6_CACHE_ENTRY* DnsCacheList;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct DNS6_HOST_TO_ADDR_DATA
{
  ///
  ...
  ///
  public EFI_IPv6_ADDRESS* IpList;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct DNS6_ADDR_TO_HOST_DATA
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct DNS6_RESOURCE_RECORD
{
  ///
  /// The Owner name.
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct DNS6_GENERAL_LOOKUP_DATA
{
  ///
  ...
  ///
  public DNS6_RESOURCE_RECORD* RRList;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DNS6_COMPLETION_TOKEN
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DNS6_PROTOCOL
{
  public readonly delegate* unmanaged</* IN */EFI_DNS6_PROTOCOL* /*This*/,/* OUT */EFI_DNS6_MODE_DATA* /*DnsModeData*/, EFI_STATUS> /*EFI_DNS6_GET_MODE_DATA*/ GetModeData;
  public readonly delegate* unmanaged</* IN */EFI_DNS6_PROTOCOL* /*This*/,/* IN */EFI_DNS6_CONFIG_DATA* /*DnsConfigData*/, EFI_STATUS> /*EFI_DNS6_CONFIGURE*/ Configure;
  public readonly delegate* unmanaged</* IN */EFI_DNS6_PROTOCOL* /*This*/,/* IN */char* /*HostName*/,/* IN */EFI_DNS6_COMPLETION_TOKEN* /*Token*/, EFI_STATUS> /*EFI_DNS6_HOST_NAME_TO_IP*/ HostNameToIp;
  public readonly delegate* unmanaged</* IN */EFI_DNS6_PROTOCOL* /*This*/,/* IN */EFI_IPv6_ADDRESS /*IpAddress*/,/* IN */EFI_DNS6_COMPLETION_TOKEN* /*Token*/, EFI_STATUS> /*EFI_DNS6_IP_TO_HOST_NAME*/ IpToHostName;
  public readonly delegate* unmanaged</* IN */EFI_DNS6_PROTOCOL* /*This*/,/* IN */byte* /*QName*/,/* IN */ushort /*QType*/,/* IN */ushort /*QClass*/,/* IN */EFI_DNS6_COMPLETION_TOKEN* /*Token*/, EFI_STATUS> /*EFI_DNS6_GENERAL_LOOKUP*/ GeneralLookUp;
  public readonly delegate* unmanaged</* IN */EFI_DNS6_PROTOCOL* /*This*/,/* IN */bool /*DeleteFlag*/,/* IN */bool /*Override*/,/* IN */EFI_DNS6_CACHE_ENTRY /*DnsCacheEntry*/, EFI_STATUS> /*EFI_DNS6_UPDATE_DNS_CACHE*/ UpdateDnsCache;
  public readonly delegate* unmanaged</* IN */EFI_DNS6_PROTOCOL* /*This*/, EFI_STATUS> /*EFI_DNS6_POLL*/ Poll;
  public readonly delegate* unmanaged</* IN */EFI_DNS6_PROTOCOL* /*This*/,/* IN */EFI_DNS6_COMPLETION_TOKEN* /*Token*/, EFI_STATUS> /*EFI_DNS6_CANCEL*/ Cancel;
}
