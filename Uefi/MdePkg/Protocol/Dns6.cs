...
public unsafe struct EFI_DNS6_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_DNS6_PROTOCOL*, EFI_DNS6_MODE_DATA*, EFI_STATUS> GetModeData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DNS6_PROTOCOL*, EFI_DNS6_CONFIG_DATA*, EFI_STATUS> Configure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DNS6_PROTOCOL*, char*, EFI_DNS6_COMPLETION_TOKEN*, EFI_STATUS> HostNameToIp;
  /**
    ...
    @retval EFI_OUT_OF_RESOURCES    Failed to allocate needed resources.
  **/
  public readonly delegate* unmanaged<EFI_DNS6_PROTOCOL*, EFI_IPv6_ADDRESS, EFI_DNS6_COMPLETION_TOKEN*, EFI_STATUS> IpToHostName;
  /**
    ...
    @retval EFI_OUT_OF_RESOURCES    Failed to allocate needed resources.
  **/
  public readonly delegate* unmanaged<EFI_DNS6_PROTOCOL*, byte*, ushort, ushort, EFI_DNS6_COMPLETION_TOKEN*, EFI_STATUS> GeneralLookUp;
  /**
    ...
    @retval EFI_OUT_OF_RESOURCE     Failed to allocate needed resources.
  **/
  public readonly delegate* unmanaged<EFI_DNS6_PROTOCOL*, bool, bool, EFI_DNS6_CACHE_ENTRY, EFI_STATUS> UpdateDnsCache;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DNS6_PROTOCOL*, EFI_STATUS> Poll;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_DNS6_PROTOCOL*, EFI_DNS6_COMPLETION_TOKEN*, EFI_STATUS> Cancel;
}
