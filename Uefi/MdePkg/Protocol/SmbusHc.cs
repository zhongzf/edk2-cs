...
public unsafe struct EFI_SMBUS_HC_PROTOCOL
{
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_SMBUS_DEVICE_ADDRESS, EFI_SMBUS_DEVICE_COMMAND, EFI_SMBUS_OPERATION, bool, ulong*, void*, EFI_STATUS> Execute;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, bool, EFI_SMBUS_UDID*, EFI_SMBUS_DEVICE_ADDRESS*, EFI_STATUS> ArpDevice;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, ulong*, EFI_SMBUS_DEVICE_MAP**, EFI_STATUS> GetArpMap;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_SMBUS_DEVICE_ADDRESS, ulong, EFI_SMBUS_NOTIFY_FUNCTION, EFI_STATUS> Notify;
}
