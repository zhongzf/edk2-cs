...
public unsafe struct EFI_TCP6_SERVICE_POINT
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_TCP6_VARIABLE_DATA
{
...
{
  public uint FragmentLength;  ///< Length of data buffer in the fragment.
  public void* FragmentBuffer; ///< Pointer to the data buffer in the fragment.
}
...
public unsafe struct EFI_TCP6_PROTOCOL
{
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_TCP6_CONNECTION_STATE*, EFI_TCP6_CONFIG_DATA*, EFI_IP6_MODE_DATA*, EFI_MANAGED_NETWORK_CONFIG_DATA*, EFI_SIMPLE_NETWORK_MODE*, EFI_STATUS> GetModeData;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_TCP6_CONFIG_DATA*, EFI_STATUS> Configure;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_TCP6_CONNECTION_TOKEN*, EFI_STATUS> Connect;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_TCP6_LISTEN_TOKEN*, EFI_STATUS> Accept;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_TCP6_IO_TOKEN*, EFI_STATUS> Transmit;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_TCP6_IO_TOKEN*, EFI_STATUS> Receive;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_TCP6_CLOSE_TOKEN*, EFI_STATUS> Close;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_TCP6_COMPLETION_TOKEN*, EFI_STATUS> Cancel;
  /**
  ...
  **/
  public readonly delegate* unmanaged<EFI_TCP6_PROTOCOL*, EFI_STATUS> Poll;
}
