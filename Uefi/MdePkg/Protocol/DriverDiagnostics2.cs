...
**/
public readonly delegate* unmanaged<EFI_DRIVER_DIAGNOSTICS2_PROTOCOL*,EFI_HANDLE,EFI_HANDLE,EFI_DRIVER_DIAGNOSTIC_TYPE,byte*,EFI_GUID**,ulong*,char**, EFI_STATUS> RunDiagnostics;
  ///
