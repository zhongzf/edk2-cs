...
{
  public readonly delegate* unmanaged</* IN */ulong /*SkuId*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_SET_SKU*/ SetSku;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_GET_8*/ Get8;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_GET_16*/ Get16;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_GET_32*/ Get32;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_GET_64*/ Get64;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_GET_POINTER*/ GetPtr;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_GET_BOOLEAN*/ GetBool;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_GET_SIZE*/ GetSize;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */byte /*Value*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_SET_8*/ Set8;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */ushort /*Value*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_SET_16*/ Set16;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*TokenNumber*/,/* IN */uint /*Value*/, EFI_STATUS> /*EFI_PCD_PROTOCOL_SET_32*/ Set32;
