...
//   IN  CONST EFI_SPI_NOR_FLASH_PROTOCOL  *This,
//   IN  uint                            FlashAddress,
//   IN  uint                            LengthInBytes,
//   OUT byte                             *Buffer
//   );
...
public unsafe struct EFI_SPI_NOR_FLASH_PROTOCOL
{
  ...
  /// Write the flash status register.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_SPI_NOR_FLASH_PROTOCOL* /*This*/,/* IN */uint /*LengthInBytes*/,/* IN */byte* /*FlashStatus*/, EFI_STATUS> /*EFI_SPI_NOR_FLASH_PROTOCOL_WRITE_STATUS*/ WriteStatus;

  ///
  /// Write data to the SPI flash.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_SPI_NOR_FLASH_PROTOCOL* /*This*/,/* IN */uint /*FlashAddress*/,/* IN */uint /*LengthInBytes*/,/* IN */byte* /*Buffer*/, EFI_STATUS> /*EFI_SPI_NOR_FLASH_PROTOCOL_WRITE_DATA*/ WriteData;

  ///
  /// Efficiently erases one or more 4KiB regions in the SPI flash.
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_SPI_NOR_FLASH_PROTOCOL* /*This*/,/* IN */uint /*FlashAddress*/,/* IN */uint /*BlockCount*/, EFI_STATUS> /*EFI_SPI_NOR_FLASH_PROTOCOL_ERASE*/ Erase;
}
