...
public static ulong EFI_FV2_READ_DISABLE_CAP = 0x0000000000000001;
public static ulong EFI_FV2_READ_ENABLE_CAP = 0x0000000000000002;
public static ulong EFI_FV2_READ_STATUS = 0x0000000000000004;
public static ulong EFI_FV2_WRITE_DISABLE_CAP = 0x0000000000000008;
public static ulong EFI_FV2_WRITE_ENABLE_CAP = 0x0000000000000010;
public static ulong EFI_FV2_WRITE_STATUS = 0x0000000000000020;
public static ulong EFI_FV2_LOCK_CAP = 0x0000000000000040;
public static ulong EFI_FV2_LOCK_STATUS = 0x0000000000000080;
public static ulong EFI_FV2_WRITE_POLICY_RELIABLE = 0x0000000000000100;
public static ulong EFI_FV2_READ_LOCK_CAP = 0x0000000000001000;
public static ulong EFI_FV2_READ_LOCK_STATUS = 0x0000000000002000;
public static ulong EFI_FV2_WRITE_LOCK_CAP = 0x0000000000004000;
public static ulong EFI_FV2_WRITE_LOCK_STATUS = 0x0000000000008000;
public static ulong EFI_FV2_ALIGNMENT = 0x00000000001F0000;
public static ulong EFI_FV2_ALIGNMENT_1 = 0x0000000000000000;
public static ulong EFI_FV2_ALIGNMENT_2 = 0x0000000000010000;
public static ulong EFI_FV2_ALIGNMENT_4 = 0x0000000000020000;
public static ulong EFI_FV2_ALIGNMENT_8 = 0x0000000000030000;
public static ulong EFI_FV2_ALIGNMENT_16 = 0x0000000000040000;
public static ulong EFI_FV2_ALIGNMENT_32 = 0x0000000000050000;
public static ulong EFI_FV2_ALIGNMENT_64 = 0x0000000000060000;
public static ulong EFI_FV2_ALIGNMENT_128 = 0x0000000000070000;
public static ulong EFI_FV2_ALIGNMENT_256 = 0x0000000000080000;
public static ulong EFI_FV2_ALIGNMENT_512 = 0x0000000000090000;
public static ulong EFI_FV2_ALIGNMENT_1K = 0x00000000000A0000;
public static ulong EFI_FV2_ALIGNMENT_2K = 0x00000000000B0000;
public static ulong EFI_FV2_ALIGNMENT_4K = 0x00000000000C0000;
public static ulong EFI_FV2_ALIGNMENT_8K = 0x00000000000D0000;
public static ulong EFI_FV2_ALIGNMENT_16K = 0x00000000000E0000;
public static ulong EFI_FV2_ALIGNMENT_32K = 0x00000000000F0000;
public static ulong EFI_FV2_ALIGNMENT_64K = 0x0000000000100000;
public static ulong EFI_FV2_ALIGNMENT_128K = 0x0000000000110000;
public static ulong EFI_FV2_ALIGNMENT_256K = 0x0000000000120000;
public static ulong EFI_FV2_ALIGNMENT_512K = 0x0000000000130000;
public static ulong EFI_FV2_ALIGNMENT_1M = 0x0000000000140000;
public static ulong EFI_FV2_ALIGNMENT_2M = 0x0000000000150000;
public static ulong EFI_FV2_ALIGNMENT_4M = 0x0000000000160000;
public static ulong EFI_FV2_ALIGNMENT_8M = 0x0000000000170000;
public static ulong EFI_FV2_ALIGNMENT_16M = 0x0000000000180000;
public static ulong EFI_FV2_ALIGNMENT_32M = 0x0000000000190000;
public static ulong EFI_FV2_ALIGNMENT_64M = 0x00000000001A0000;
public static ulong EFI_FV2_ALIGNMENT_128M = 0x00000000001B0000;
public static ulong EFI_FV2_ALIGNMENT_256M = 0x00000000001C0000;
public static ulong EFI_FV2_ALIGNMENT_512M = 0x00000000001D0000;
public static ulong EFI_FV2_ALIGNMENT_1G = 0x00000000001E0000;
public static ulong EFI_FV2_ALIGNMENT_2G = 0x00000000001F0000;
...
public static ulong EFI_FV_UNRELIABLE_WRITE = 0x00000000;
public static ulong EFI_FV_RELIABLE_WRITE = 0x00000001;

//
// EFI_FV_WRITE_FILE_DATA
//
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_FV_WRITE_FILE_DATA
{
  ///
  /// Pointer to a GUID, which is the file name to be written.
  ///
  public EFI_GUID* NameGuid;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_FIRMWARE_VOLUME2_PROTOCOL
{
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_FV_ATTRIBUTES*, EFI_STATUS> GetVolumeAttributes;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, EFI_FV_ATTRIBUTES*, EFI_STATUS> SetVolumeAttributes;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, CONST, void**, ulong*, EFI_FV_FILETYPE*, EFI_FV_FILE_ATTRIBUTES*, uint*, EFI_STATUS> ReadFile;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, CONST, EFI_SECTION_TYPE, ulong, void**, ulong*, uint*, EFI_STATUS> ReadSection;
  /**
    Locates the requested section within a file and returns it in a buffer.
  ...
  **/
  public readonly delegate* unmanaged<CONST, uint, EFI_FV_WRITE_POLICY, EFI_FV_WRITE_FILE_DATA*, EFI_STATUS> WriteFile;
  /**
  ...
  **/
  public readonly delegate* unmanaged<CONST, CONST, ulong, CONST, EFI_STATUS> SetInfo;
}
