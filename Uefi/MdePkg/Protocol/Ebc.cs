...
// Define OPCODES
//
public static ulong OPCODE_BREAK = 0x00;
public static ulong OPCODE_JMP = 0x01;
public static ulong OPCODE_JMP8 = 0x02;
public static ulong OPCODE_CALL = 0x03;
public static ulong OPCODE_RET = 0x04;
public static ulong OPCODE_CMPEQ = 0x05;
public static ulong OPCODE_CMPLTE = 0x06;
public static ulong OPCODE_CMPGTE = 0x07;
public static ulong OPCODE_CMPULTE = 0x08;
public static ulong OPCODE_CMPUGTE = 0x09;
public static ulong OPCODE_NOT = 0x0A;
public static ulong OPCODE_NEG = 0x0B;
public static ulong OPCODE_ADD = 0x0C;
public static ulong OPCODE_SUB = 0x0D;
public static ulong OPCODE_MUL = 0x0E;
public static ulong OPCODE_MULU = 0x0F;
public static ulong OPCODE_DIV = 0x10;
public static ulong OPCODE_DIVU = 0x11;
public static ulong OPCODE_MOD = 0x12;
public static ulong OPCODE_MODU = 0x13;
public static ulong OPCODE_AND = 0x14;
public static ulong OPCODE_OR = 0x15;
public static ulong OPCODE_XOR = 0x16;
public static ulong OPCODE_SHL = 0x17;
public static ulong OPCODE_SHR = 0x18;
public static ulong OPCODE_ASHR = 0x19;
public static ulong OPCODE_EXTNDB = 0x1A;
public static ulong OPCODE_EXTNDW = 0x1B;
public static ulong OPCODE_EXTNDD = 0x1C;
public static ulong OPCODE_MOVBW = 0x1D;
public static ulong OPCODE_MOVWW = 0x1E;
public static ulong OPCODE_MOVDW = 0x1F;
public static ulong OPCODE_MOVQW = 0x20;
public static ulong OPCODE_MOVBD = 0x21;
public static ulong OPCODE_MOVWD = 0x22;
public static ulong OPCODE_MOVDD = 0x23;
public static ulong OPCODE_MOVQD = 0x24;
public static ulong OPCODE_MOVSNW = 0x25  // Move signed natural with word index;
public static ulong OPCODE_MOVSND = 0x26  // Move signed natural with dword index;
//
public static ulong OPCODE_27 = 0x27;
//
public static ulong OPCODE_MOVQQ = 0x28 // Does this go away?;
public static ulong OPCODE_LOADSP = 0x29;
public static ulong OPCODE_STORESP = 0x2A;
public static ulong OPCODE_PUSH = 0x2B;
public static ulong OPCODE_POP = 0x2C;
public static ulong OPCODE_CMPIEQ = 0x2D;
public static ulong OPCODE_CMPILTE = 0x2E;
public static ulong OPCODE_CMPIGTE = 0x2F;
public static ulong OPCODE_CMPIULTE = 0x30;
public static ulong OPCODE_CMPIUGTE = 0x31;
public static ulong OPCODE_MOVNW = 0x32;
public static ulong OPCODE_MOVND = 0x33;
//
public static ulong OPCODE_34 = 0x34;
//
public static ulong OPCODE_PUSHN = 0x35;
public static ulong OPCODE_POPN = 0x36;
public static ulong OPCODE_MOVI = 0x37;
public static ulong OPCODE_MOVIN = 0x38;
public static ulong OPCODE_MOVREL = 0x39;

//
// Bit masks for opcode encodings
//
public static ulong OPCODE_M_OPCODE = 0x3F  // bits of interest for first level decode;
public static ulong OPCODE_M_IMMDATA = 0x80;
public static ulong OPCODE_M_IMMDATA64 = 0x40;
public static ulong OPCODE_M_64BIT = 0x40  // for CMP;
public static ulong OPCODE_M_RELADDR = 0x10  // for CALL instruction;
public static ulong OPCODE_M_CMPI32_DATA = 0x80  // for CMPI;
public static ulong OPCODE_M_CMPI64 = 0x40  // for CMPI 32 or 64 bit comparison;
public static ulong OPERAND_M_MOVIN_N = 0x80;
public static ulong OPERAND_M_CMPI_INDEX = 0x10;

//
// Masks for instructions that encode presence of indexes for operand1 and/or
// operand2.
//
public static ulong OPCODE_M_IMMED_OP1 = 0x80;
public static ulong OPCODE_M_IMMED_OP2 = 0x40;

//
// Bit masks for operand encodings
//
public static ulong OPERAND_M_INDIRECT1 = 0x08;
public static ulong OPERAND_M_INDIRECT2 = 0x80;
public static ulong OPERAND_M_OP1 = 0x07;
public static ulong OPERAND_M_OP2 = 0x70;

//
// Masks for data manipulation instructions
//
public static ulong DATAMANIP_M_64 = 0x40 // 64-bit width operation;
public static ulong DATAMANIP_M_IMMDATA = 0x80;
...
// of the move.
//
public static ulong MOVI_M_IMMDATA = 0x40;
public static ulong MOVI_M_DATAWIDTH = 0xC0;
public static ulong MOVI_DATAWIDTH16 = 0x40;
public static ulong MOVI_DATAWIDTH32 = 0x80;
public static ulong MOVI_DATAWIDTH64 = 0xC0;
public static ulong MOVI_M_MOVEWIDTH = 0x30;
public static ulong MOVI_MOVEWIDTH8 = 0x00;
public static ulong MOVI_MOVEWIDTH16 = 0x10;
public static ulong MOVI_MOVEWIDTH32 = 0x20;
public static ulong MOVI_MOVEWIDTH64 = 0x30;

//
// Masks for CALL instruction encodings
//
public static ulong OPERAND_M_RELATIVE_ADDR = 0x10;
public static ulong OPERAND_M_NATIVE_CALL = 0x20;

//
// Masks for decoding push/pop instructions
//
public static ulong PUSHPOP_M_IMMDATA = 0x80 // opcode bit indicating immediate data;
public static ulong PUSHPOP_M_64 = 0x40 // opcode bit indicating 64-bit operation;
//
// Mask for operand of JMP instruction
//
public static ulong JMP_M_RELATIVE = 0x10;
public static ulong JMP_M_CONDITIONAL = 0x80;
public static ulong JMP_M_CS = 0x40;
...
//
public static ulong CONDITION_M_CONDITIONAL = 0x80;
public static ulong CONDITION_M_CS = 0x40;

///
/// Protocol Guid Name defined in spec.
///
public static ulong EFI_EBC_PROTOCOL_GUID = EFI_EBC_INTERPRETER_PROTOCOL_GUID;
