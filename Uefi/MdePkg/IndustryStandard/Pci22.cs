...
public unsafe struct PCI_DEVICE_INDEPENDENT_REGION
{
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct PCI_DEVICE_HEADER_TYPE_REGION
{
  public fixed uint Bar[6];
  public uint CISPtr;
  public ushort SubsystemVendorID;
  public ushort SubsystemID;
  public uint ExpansionRomBar;
  public byte CapabilityPtr;
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct PCI_TYPE00
{
  public PCI_DEVICE_INDEPENDENT_REGION Hdr;
  public PCI_DEVICE_HEADER_TYPE_REGION Device;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct PCI_BRIDGE_CONTROL_REGISTER
{
  public fixed uint Bar[2];
  public byte PrimaryBus;
  public byte SecondaryBus;
  public byte SubordinateBus;
  public byte SecondaryLatencyTimer;
  public byte IoBase;
  public byte IoLimit;
  public ushort SecondaryStatus;
  public ushort MemoryBase;
  public ushort MemoryLimit;
  public ushort PrefetchableMemoryBase;
  public ushort PrefetchableMemoryLimit;
  public uint PrefetchableBaseUpper32;
  public uint PrefetchableLimitUpper32;
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct PCI_TYPE01
{
  public PCI_DEVICE_INDEPENDENT_REGION Hdr;
  public PCI_BRIDGE_CONTROL_REGISTER Bridge;
}

[StructLayout(LayoutKind.Explicit)]
public unsafe struct PCI_TYPE_GENERIC
{
  [FieldOffset(0)] public PCI_TYPE00 Device;
  [FieldOffset(0)] public PCI_TYPE01 Bridge;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct PCI_CARDBUS_CONTROL_REGISTER
{
  public uint CardBusSocketReg;   ///< Cardbus Socket/ExCA Base
  public byte Cap_Ptr;
  public byte Reserved;
  public ushort SecondaryStatus;      ///< Secondary Status
  public byte PciBusNumber;         ///< PCI Bus Number
  public byte CardBusBusNumber;     ///< CardBus Bus Number
  public byte SubordinateBusNumber; ///< Subordinate Bus Number
  public byte CardBusLatencyTimer;  ///< CardBus Latency Timer
  public uint MemoryBase0;          ///< Memory Base Register 0
  public uint MemoryLimit0;         ///< Memory Limit Register 0
  public uint MemoryBase1;
  public uint MemoryLimit1;
  public uint IoBase0;
  public uint IoLimit0;           ///< I/O Base Register 0
  public uint IoBase1;            ///< I/O Limit Register 0
  public uint IoLimit1;
  public byte InterruptLine;      ///< Interrupt Line
  public byte InterruptPin;       ///< Interrupt Pin
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_CAPABILITY_HDR
{
  public byte CapabilityID;
  public byte NextItemPtr;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_CAPABILITY_PMI
{
  public EFI_PCI_CAPABILITY_HDR Hdr;
  public EFI_PCI_PMC PMC;
  public EFI_PCI_PMCSR PMCSR;
  public EFI_PCI_PMCSR_BSE BridgeExtention;
  public byte Data;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_CAPABILITY_AGP
{
  public EFI_PCI_CAPABILITY_HDR Hdr;
  public byte Rev;
  public byte Reserved;
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_CAPABILITY_VPD
{
  public EFI_PCI_CAPABILITY_HDR Hdr;
  public ushort AddrReg;
  public uint DataReg;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_CAPABILITY_SLOTID
{
  public EFI_PCI_CAPABILITY_HDR Hdr;
  public byte ExpnsSlotReg;
  public byte ChassisNo;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_CAPABILITY_MSI32
{
  public EFI_PCI_CAPABILITY_HDR Hdr;
  public ushort MsgCtrlReg;
  public uint MsgAddrReg;
  public ushort MsgDataReg;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_CAPABILITY_MSI64
{
  public EFI_PCI_CAPABILITY_HDR Hdr;
  public ushort MsgCtrlReg;
  public uint MsgAddrRegLsdw;
  public uint MsgAddrRegMsdw;
  public ushort MsgDataReg;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_CAPABILITY_HOTPLUG
{
  public EFI_PCI_CAPABILITY_HDR Hdr;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct PCI_EXPANSION_ROM_HEADER
{
  public ushort Signature;  ///< 0xaa55
  public fixed byte Reserved[0x16];
  public ushort PcirOffset;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_LEGACY_EXPANSION_ROM_HEADER
{
  public ushort Signature;  ///< 0xaa55
  public byte Size512;
  public fixed byte InitEntryPoint[3];
  public fixed byte Reserved[0x12];
  public ushort PcirOffset;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct PCI_DATA_STRUCTURE
{
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PCI_EXPANSION_ROM_HEADER
{
  public ushort Signature;  ///< 0xaa55
  public ushort InitializationSize;
  public uint EfiSignature; ///< 0x0EF1
  public ushort EfiSubsystem;
  public ushort EfiMachineType;
  public ushort CompressionType;
  public fixed byte Reserved[8];
  public ushort EfiImageHeaderOffset;
  public ushort PcirOffset;
}

[StructLayout(LayoutKind.Explicit)]
public unsafe struct EFI_PCI_ROM_HEADER
{
  [FieldOffset(0)] public byte* Raw;
  [FieldOffset(0)] public PCI_EXPANSION_ROM_HEADER* Generic;
  [FieldOffset(0)] public EFI_PCI_EXPANSION_ROM_HEADER* Efi;
  [FieldOffset(0)] public EFI_LEGACY_EXPANSION_ROM_HEADER* PcAt;
}
