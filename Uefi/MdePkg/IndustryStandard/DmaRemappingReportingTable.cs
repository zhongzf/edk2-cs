...
public unsafe struct EFI_ACPI_DMAR_STRUCTURE_HEADER
{
  public ushort Type;
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_PCI_PATH
{
  public byte Device;
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_DEVICE_SCOPE_STRUCTURE_HEADER
{
  public byte Type;
  public byte Length;
  public byte Flags;
...
**/
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_DRHD_HEADER
{
  public EFI_ACPI_DMAR_STRUCTURE_HEADER Header;
  ...
  **/
  ...
  ///
  public ulong RegisterBaseAddress;
}
...
**/
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_RMRR_HEADER
{
  public EFI_ACPI_DMAR_STRUCTURE_HEADER Header;
  ...
  ///
  public ulong ReservedMemoryRegionBaseAddress;
  ...
  /**
    ...
    multiple of 4KB.
  **/
  public ulong ReservedMemoryRegionLimitAddress;
}
...
**/
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_ATSR_HEADER
{
  public EFI_ACPI_DMAR_STRUCTURE_HEADER Header;
...
**/
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_RHSA_HEADER
{
  public EFI_ACPI_DMAR_STRUCTURE_HEADER Header;
...
**/
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_ANDD_HEADER
{
  public EFI_ACPI_DMAR_STRUCTURE_HEADER Header;
...
**/
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_SATC_HEADER
{
  public EFI_ACPI_DMAR_STRUCTURE_HEADER Header;
...
**/
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_SIDP_HEADER
{
  public EFI_ACPI_DMAR_STRUCTURE_HEADER Header;
...
**/
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_ACPI_DMAR_HEADER
{
