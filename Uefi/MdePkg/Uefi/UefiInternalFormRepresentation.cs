...
//
public static ulong EFI_HII_PACKAGE_TYPE_ALL = 0x00;
public static ulong EFI_HII_PACKAGE_TYPE_GUID = 0x01;
public static ulong EFI_HII_PACKAGE_FORMS = 0x02;
public static ulong EFI_HII_PACKAGE_STRINGS = 0x04;
public static ulong EFI_HII_PACKAGE_FONTS = 0x05;
public static ulong EFI_HII_PACKAGE_IMAGES = 0x06;
public static ulong EFI_HII_PACKAGE_SIMPLE_FONTS = 0x07;
public static ulong EFI_HII_PACKAGE_DEVICE_PATH = 0x08;
public static ulong EFI_HII_PACKAGE_KEYBOARD_LAYOUT = 0x09;
public static ulong EFI_HII_PACKAGE_ANIMATIONS = 0x0A;
public static ulong EFI_HII_PACKAGE_END = 0xDF;
public static ulong EFI_HII_PACKAGE_TYPE_SYSTEM_BEGIN = 0xE0;
public static ulong EFI_HII_PACKAGE_TYPE_SYSTEM_END = 0xFF;
...
///@{
public static ulong EFI_GLYPH_NON_SPACING = 0x01;
public static ulong EFI_GLYPH_WIDE = 0x02;
public static ulong EFI_GLYPH_HEIGHT = 19;
public static ulong EFI_GLYPH_WIDTH = 8;
///@}
...
//
public static ulong EFI_HII_FONT_STYLE_NORMAL = 0x00000000;
public static ulong EFI_HII_FONT_STYLE_BOLD = 0x00000001;
public static ulong EFI_HII_FONT_STYLE_ITALIC = 0x00000002;
public static ulong EFI_HII_FONT_STYLE_EMBOSS = 0x00010000;
public static ulong EFI_HII_FONT_STYLE_OUTLINE = 0x00020000;
public static ulong EFI_HII_FONT_STYLE_SHADOW = 0x00040000;
public static ulong EFI_HII_FONT_STYLE_UNDERLINE = 0x00080000;
public static ulong EFI_HII_FONT_STYLE_DBL_UNDER = 0x00100000;
...
//
public static ulong EFI_HII_GIBT_END = 0x00;
public static ulong EFI_HII_GIBT_GLYPH = 0x10;
public static ulong EFI_HII_GIBT_GLYPHS = 0x11;
public static ulong EFI_HII_GIBT_GLYPH_DEFAULT = 0x12;
public static ulong EFI_HII_GIBT_GLYPHS_DEFAULT = 0x13;
public static ulong EFI_HII_GIBT_GLYPH_VARIABILITY = 0x14;
public static ulong EFI_HII_GIBT_DUPLICATE = 0x20;
public static ulong EFI_HII_GIBT_SKIP2 = 0x21;
public static ulong EFI_HII_GIBT_SKIP1 = 0x22;
public static ulong EFI_HII_GIBT_DEFAULTS = 0x23;
public static ulong EFI_HII_GIBT_EXT1 = 0x30;
public static ulong EFI_HII_GIBT_EXT2 = 0x31;
public static ulong EFI_HII_GIBT_EXT4 = 0x32;
...
public static ulong UEFI_CONFIG_LANG = "x-UEFI";
public static ulong UEFI_CONFIG_LANG_2 = "x-i-UEFI";
...
//
public static ulong EFI_HII_SIBT_END = 0x00;
public static ulong EFI_HII_SIBT_STRING_SCSU = 0x10;
public static ulong EFI_HII_SIBT_STRING_SCSU_FONT = 0x11;
public static ulong EFI_HII_SIBT_STRINGS_SCSU = 0x12;
public static ulong EFI_HII_SIBT_STRINGS_SCSU_FONT = 0x13;
public static ulong EFI_HII_SIBT_STRING_UCS2 = 0x14;
public static ulong EFI_HII_SIBT_STRING_UCS2_FONT = 0x15;
public static ulong EFI_HII_SIBT_STRINGS_UCS2 = 0x16;
public static ulong EFI_HII_SIBT_STRINGS_UCS2_FONT = 0x17;
public static ulong EFI_HII_SIBT_DUPLICATE = 0x20;
public static ulong EFI_HII_SIBT_SKIP2 = 0x21;
public static ulong EFI_HII_SIBT_SKIP1 = 0x22;
public static ulong EFI_HII_SIBT_EXT1 = 0x30;
public static ulong EFI_HII_SIBT_EXT2 = 0x31;
public static ulong EFI_HII_SIBT_EXT4 = 0x32;
public static ulong EFI_HII_SIBT_FONT = 0x40;
...
//
public static ulong EFI_HII_IIBT_END = 0x00;
public static ulong EFI_HII_IIBT_IMAGE_1BIT = 0x10;
public static ulong EFI_HII_IIBT_IMAGE_1BIT_TRANS = 0x11;
public static ulong EFI_HII_IIBT_IMAGE_4BIT = 0x12;
public static ulong EFI_HII_IIBT_IMAGE_4BIT_TRANS = 0x13;
public static ulong EFI_HII_IIBT_IMAGE_8BIT = 0x14;
public static ulong EFI_HII_IIBT_IMAGE_8BIT_TRANS = 0x15;
public static ulong EFI_HII_IIBT_IMAGE_24BIT = 0x16;
public static ulong EFI_HII_IIBT_IMAGE_24BIT_TRANS = 0x17;
public static ulong EFI_HII_IIBT_IMAGE_JPEG = 0x18;
public static ulong EFI_HII_IIBT_IMAGE_PNG = 0x19;
public static ulong EFI_HII_IIBT_DUPLICATE = 0x20;
public static ulong EFI_HII_IIBT_SKIP2 = 0x21;
public static ulong EFI_HII_IIBT_SKIP1 = 0x22;
public static ulong EFI_HII_IIBT_EXT1 = 0x30;
public static ulong EFI_HII_IIBT_EXT2 = 0x31;
public static ulong EFI_HII_IIBT_EXT4 = 0x32;
...
[StructLayout(LayoutKind.Explicit)] public unsafe struct EFI_IFR_TYPE_VALUE {
...
// IFR Opcodes
//
public static ulong EFI_IFR_FORM_OP = 0x01;
public static ulong EFI_IFR_SUBTITLE_OP = 0x02;
public static ulong EFI_IFR_TEXT_OP = 0x03;
public static ulong EFI_IFR_IMAGE_OP = 0x04;
public static ulong EFI_IFR_ONE_OF_OP = 0x05;
public static ulong EFI_IFR_CHECKBOX_OP = 0x06;
public static ulong EFI_IFR_NUMERIC_OP = 0x07;
public static ulong EFI_IFR_PASSWORD_OP = 0x08;
public static ulong EFI_IFR_ONE_OF_OPTION_OP = 0x09;
public static ulong EFI_IFR_SUPPRESS_IF_OP = 0x0A;
public static ulong EFI_IFR_LOCKED_OP = 0x0B;
public static ulong EFI_IFR_ACTION_OP = 0x0C;
public static ulong EFI_IFR_RESET_BUTTON_OP = 0x0D;
public static ulong EFI_IFR_FORM_SET_OP = 0x0E;
public static ulong EFI_IFR_REF_OP = 0x0F;
public static ulong EFI_IFR_NO_SUBMIT_IF_OP = 0x10;
public static ulong EFI_IFR_INCONSISTENT_IF_OP = 0x11;
public static ulong EFI_IFR_EQ_ID_VAL_OP = 0x12;
public static ulong EFI_IFR_EQ_ID_ID_OP = 0x13;
public static ulong EFI_IFR_EQ_ID_VAL_LIST_OP = 0x14;
public static ulong EFI_IFR_AND_OP = 0x15;
public static ulong EFI_IFR_OR_OP = 0x16;
public static ulong EFI_IFR_NOT_OP = 0x17;
public static ulong EFI_IFR_RULE_OP = 0x18;
public static ulong EFI_IFR_GRAY_OUT_IF_OP = 0x19;
public static ulong EFI_IFR_DATE_OP = 0x1A;
public static ulong EFI_IFR_TIME_OP = 0x1B;
public static ulong EFI_IFR_STRING_OP = 0x1C;
public static ulong EFI_IFR_REFRESH_OP = 0x1D;
public static ulong EFI_IFR_DISABLE_IF_OP = 0x1E;
public static ulong EFI_IFR_ANIMATION_OP = 0x1F;
public static ulong EFI_IFR_TO_LOWER_OP = 0x20;
public static ulong EFI_IFR_TO_UPPER_OP = 0x21;
public static ulong EFI_IFR_MAP_OP = 0x22;
public static ulong EFI_IFR_ORDERED_LIST_OP = 0x23;
public static ulong EFI_IFR_VARSTORE_OP = 0x24;
public static ulong EFI_IFR_VARSTORE_NAME_VALUE_OP = 0x25;
public static ulong EFI_IFR_VARSTORE_EFI_OP = 0x26;
public static ulong EFI_IFR_VARSTORE_DEVICE_OP = 0x27;
public static ulong EFI_IFR_VERSION_OP = 0x28;
public static ulong EFI_IFR_END_OP = 0x29;
public static ulong EFI_IFR_MATCH_OP = 0x2A;
public static ulong EFI_IFR_GET_OP = 0x2B;
public static ulong EFI_IFR_SET_OP = 0x2C;
public static ulong EFI_IFR_READ_OP = 0x2D;
public static ulong EFI_IFR_WRITE_OP = 0x2E;
public static ulong EFI_IFR_EQUAL_OP = 0x2F;
public static ulong EFI_IFR_NOT_EQUAL_OP = 0x30;
public static ulong EFI_IFR_GREATER_THAN_OP = 0x31;
public static ulong EFI_IFR_GREATER_EQUAL_OP = 0x32;
public static ulong EFI_IFR_LESS_THAN_OP = 0x33;
public static ulong EFI_IFR_LESS_EQUAL_OP = 0x34;
public static ulong EFI_IFR_BITWISE_AND_OP = 0x35;
public static ulong EFI_IFR_BITWISE_OR_OP = 0x36;
public static ulong EFI_IFR_BITWISE_NOT_OP = 0x37;
public static ulong EFI_IFR_SHIFT_LEFT_OP = 0x38;
public static ulong EFI_IFR_SHIFT_RIGHT_OP = 0x39;
public static ulong EFI_IFR_ADD_OP = 0x3A;
public static ulong EFI_IFR_SUBTRACT_OP = 0x3B;
public static ulong EFI_IFR_MULTIPLY_OP = 0x3C;
public static ulong EFI_IFR_DIVIDE_OP = 0x3D;
public static ulong EFI_IFR_MODULO_OP = 0x3E;
public static ulong EFI_IFR_RULE_REF_OP = 0x3F;
public static ulong EFI_IFR_QUESTION_REF1_OP = 0x40;
public static ulong EFI_IFR_QUESTION_REF2_OP = 0x41;
public static ulong EFI_IFR_UINT8_OP = 0x42;
public static ulong EFI_IFR_UINT16_OP = 0x43;
public static ulong EFI_IFR_UINT32_OP = 0x44;
public static ulong EFI_IFR_UINT64_OP = 0x45;
public static ulong EFI_IFR_TRUE_OP = 0x46;
public static ulong EFI_IFR_FALSE_OP = 0x47;
public static ulong EFI_IFR_TO_UINT_OP = 0x48;
public static ulong EFI_IFR_TO_STRING_OP = 0x49;
public static ulong EFI_IFR_TO_BOOLEAN_OP = 0x4A;
public static ulong EFI_IFR_MID_OP = 0x4B;
public static ulong EFI_IFR_FIND_OP = 0x4C;
public static ulong EFI_IFR_TOKEN_OP = 0x4D;
public static ulong EFI_IFR_STRING_REF1_OP = 0x4E;
public static ulong EFI_IFR_STRING_REF2_OP = 0x4F;
public static ulong EFI_IFR_CONDITIONAL_OP = 0x50;
public static ulong EFI_IFR_QUESTION_REF3_OP = 0x51;
public static ulong EFI_IFR_ZERO_OP = 0x52;
public static ulong EFI_IFR_ONE_OP = 0x53;
public static ulong EFI_IFR_ONES_OP = 0x54;
public static ulong EFI_IFR_UNDEFINED_OP = 0x55;
public static ulong EFI_IFR_LENGTH_OP = 0x56;
public static ulong EFI_IFR_DUP_OP = 0x57;
public static ulong EFI_IFR_THIS_OP = 0x58;
public static ulong EFI_IFR_SPAN_OP = 0x59;
public static ulong EFI_IFR_VALUE_OP = 0x5A;
public static ulong EFI_IFR_DEFAULT_OP = 0x5B;
public static ulong EFI_IFR_DEFAULTSTORE_OP = 0x5C;
public static ulong EFI_IFR_FORM_MAP_OP = 0x5D;
public static ulong EFI_IFR_CATENATE_OP = 0x5E;
public static ulong EFI_IFR_GUID_OP = 0x5F;
public static ulong EFI_IFR_SECURITY_OP = 0x60;
public static ulong EFI_IFR_MODAL_TAG_OP = 0x61;
public static ulong EFI_IFR_REFRESH_ID_OP = 0x62;
public static ulong EFI_IFR_WARNING_IF_OP = 0x63;
public static ulong EFI_IFR_MATCH2_OP = 0x64;
...
//
public static ulong EFI_IFR_FLAG_READ_ONLY = 0x01;
public static ulong EFI_IFR_FLAG_CALLBACK = 0x04;
public static ulong EFI_IFR_FLAG_RESET_REQUIRED = 0x10;
public static ulong EFI_IFR_FLAG_REST_STYLE = 0x20;
public static ulong EFI_IFR_FLAG_RECONNECT_REQUIRED = 0x40;
public static ulong EFI_IFR_FLAG_OPTIONS_ONLY = 0x80;
...
//
public static ulong EFI_HII_DEFAULT_CLASS_STANDARD = 0x0000;
public static ulong EFI_HII_DEFAULT_CLASS_MANUFACTURING = 0x0001;
public static ulong EFI_HII_DEFAULT_CLASS_SAFE = 0x0002;
public static ulong EFI_HII_DEFAULT_CLASS_PLATFORM_BEGIN = 0x4000;
public static ulong EFI_HII_DEFAULT_CLASS_PLATFORM_END = 0x7fff;
public static ulong EFI_HII_DEFAULT_CLASS_HARDWARE_BEGIN = 0x8000;
public static ulong EFI_HII_DEFAULT_CLASS_HARDWARE_END = 0xbfff;
public static ulong EFI_HII_DEFAULT_CLASS_FIRMWARE_BEGIN = 0xc000;
public static ulong EFI_HII_DEFAULT_CLASS_FIRMWARE_END = 0xffff;
...
public static ulong EFI_IFR_FLAGS_HORIZONTAL = 0x01;
...
public static ulong EFI_IFR_CHECKBOX_DEFAULT = 0x01;
public static ulong EFI_IFR_CHECKBOX_DEFAULT_MFG = 0x02;
...
//
public static ulong EFI_QF_DATE_YEAR_SUPPRESS = 0x01;
public static ulong EFI_QF_DATE_MONTH_SUPPRESS = 0x02;
public static ulong EFI_QF_DATE_DAY_SUPPRESS = 0x04;

public static ulong EFI_QF_DATE_STORAGE = 0x30;
public static ulong QF_DATE_STORAGE_NORMAL = 0x00;
public static ulong QF_DATE_STORAGE_TIME = 0x10;
public static ulong QF_DATE_STORAGE_WAKEUP = 0x20;

[StructLayout(LayoutKind.Explicit)] public unsafe struct u8 {
  struct {
...
//
public static ulong EFI_IFR_NUMERIC_SIZE = 0x03;
public static ulong EFI_IFR_NUMERIC_SIZE_1 = 0x00;
public static ulong EFI_IFR_NUMERIC_SIZE_2 = 0x01;
public static ulong EFI_IFR_NUMERIC_SIZE_4 = 0x02;
public static ulong EFI_IFR_NUMERIC_SIZE_8 = 0x03;

public static ulong EFI_IFR_DISPLAY = 0x30;
public static ulong EFI_IFR_DISPLAY_INT_DEC = 0x00;
public static ulong EFI_IFR_DISPLAY_UINT_DEC = 0x10;
public static ulong EFI_IFR_DISPLAY_UINT_HEX = 0x20;
...
public static ulong EFI_IFR_STRING_MULTI_LINE = 0x01;
...
public static ulong EFI_IFR_UNIQUE_SET = 0x01;
public static ulong EFI_IFR_NO_EMPTY_SET = 0x02;
...
//
public static ulong QF_TIME_HOUR_SUPPRESS = 0x01;
public static ulong QF_TIME_MINUTE_SUPPRESS = 0x02;
public static ulong QF_TIME_SECOND_SUPPRESS = 0x04;

public static ulong QF_TIME_STORAGE = 0x30;
public static ulong QF_TIME_STORAGE_NORMAL = 0x00;
public static ulong QF_TIME_STORAGE_TIME = 0x10;
public static ulong QF_TIME_STORAGE_WAKEUP = 0x20;
...
//
public static ulong EFI_IFR_TYPE_NUM_SIZE_8 = 0x00;
public static ulong EFI_IFR_TYPE_NUM_SIZE_16 = 0x01;
public static ulong EFI_IFR_TYPE_NUM_SIZE_32 = 0x02;
public static ulong EFI_IFR_TYPE_NUM_SIZE_64 = 0x03;
public static ulong EFI_IFR_TYPE_BOOLEAN = 0x04;
public static ulong EFI_IFR_TYPE_TIME = 0x05;
public static ulong EFI_IFR_TYPE_DATE = 0x06;
public static ulong EFI_IFR_TYPE_STRING = 0x07;
public static ulong EFI_IFR_TYPE_OTHER = 0x08;
public static ulong EFI_IFR_TYPE_UNDEFINED = 0x09;
public static ulong EFI_IFR_TYPE_ACTION = 0x0A;
public static ulong EFI_IFR_TYPE_BUFFER = 0x0B;
public static ulong EFI_IFR_TYPE_REF = 0x0C;

public static ulong EFI_IFR_OPTION_DEFAULT = 0x10;
public static ulong EFI_IFR_OPTION_DEFAULT_MFG = 0x20;
...
///@{
public static ulong EFI_IFR_STRING_UNSIGNED_DEC = 0;
public static ulong EFI_IFR_STRING_SIGNED_DEC = 1;
public static ulong EFI_IFR_STRING_LOWERCASE_HEX = 2;
public static ulong EFI_IFR_STRING_UPPERCASE_HEX = 3;
///@}
...
/// 8 = Unicode.
///@{
public static ulong EFI_IFR_STRING_ASCII = 0;
public static ulong EFI_IFR_STRING_UNICODE = 8;
///@}
...
//
public static ulong EFI_IFR_FF_CASE_SENSITIVE = 0x00;
public static ulong EFI_IFR_FF_CASE_INSENSITIVE = 0x01;
...
//
public static ulong EFI_IFR_FLAGS_FIRST_MATCHING = 0x00;
public static ulong EFI_IFR_FLAGS_FIRST_NON_MATCHING = 0x01;
...
///
public static ulong EFI_AFFECTED_BY_STANDARD_SHIFT = 0x0001;
...
// Modifier values
//
public static ulong EFI_NULL_MODIFIER = 0x0000;
public static ulong EFI_LEFT_CONTROL_MODIFIER = 0x0001;
public static ulong EFI_RIGHT_CONTROL_MODIFIER = 0x0002;
public static ulong EFI_LEFT_ALT_MODIFIER = 0x0003;
public static ulong EFI_RIGHT_ALT_MODIFIER = 0x0004;
public static ulong EFI_ALT_GR_MODIFIER = 0x0005;
public static ulong EFI_INSERT_MODIFIER = 0x0006;
public static ulong EFI_DELETE_MODIFIER = 0x0007;
public static ulong EFI_PAGE_DOWN_MODIFIER = 0x0008;
public static ulong EFI_PAGE_UP_MODIFIER = 0x0009;
public static ulong EFI_HOME_MODIFIER = 0x000A;
public static ulong EFI_END_MODIFIER = 0x000B;
public static ulong EFI_LEFT_SHIFT_MODIFIER = 0x000C;
public static ulong EFI_RIGHT_SHIFT_MODIFIER = 0x000D;
public static ulong EFI_CAPS_LOCK_MODIFIER = 0x000E;
public static ulong EFI_NUM_LOCK_MODIFIER = 0x000F;
public static ulong EFI_LEFT_ARROW_MODIFIER = 0x0010;
public static ulong EFI_RIGHT_ARROW_MODIFIER = 0x0011;
public static ulong EFI_DOWN_ARROW_MODIFIER = 0x0012;
public static ulong EFI_UP_ARROW_MODIFIER = 0x0013;
public static ulong EFI_NS_KEY_MODIFIER = 0x0014;
public static ulong EFI_NS_KEY_DEPENDENCY_MODIFIER = 0x0015;
public static ulong EFI_FUNCTION_KEY_ONE_MODIFIER = 0x0016;
public static ulong EFI_FUNCTION_KEY_TWO_MODIFIER = 0x0017;
public static ulong EFI_FUNCTION_KEY_THREE_MODIFIER = 0x0018;
public static ulong EFI_FUNCTION_KEY_FOUR_MODIFIER = 0x0019;
public static ulong EFI_FUNCTION_KEY_FIVE_MODIFIER = 0x001A;
public static ulong EFI_FUNCTION_KEY_SIX_MODIFIER = 0x001B;
public static ulong EFI_FUNCTION_KEY_SEVEN_MODIFIER = 0x001C;
public static ulong EFI_FUNCTION_KEY_EIGHT_MODIFIER = 0x001D;
public static ulong EFI_FUNCTION_KEY_NINE_MODIFIER = 0x001E;
public static ulong EFI_FUNCTION_KEY_TEN_MODIFIER = 0x001F;
public static ulong EFI_FUNCTION_KEY_ELEVEN_MODIFIER = 0x0020;
public static ulong EFI_FUNCTION_KEY_TWELVE_MODIFIER = 0x0021;
...
//
public static ulong EFI_PRINT_MODIFIER = 0x0022;
public static ulong EFI_SYS_REQUEST_MODIFIER = 0x0023;
public static ulong EFI_SCROLL_LOCK_MODIFIER = 0x0024;
public static ulong EFI_PAUSE_MODIFIER = 0x0025;
public static ulong EFI_BREAK_MODIFIER = 0x0026;

public static ulong EFI_LEFT_LOGO_MODIFIER = 0x0027;
public static ulong EFI_RIGHT_LOGO_MODIFIER = 0x0028;
public static ulong EFI_MENU_MODIFIER = 0x0029;
...
///
public static ulong EFI_HII_AIBT_END = 0x00;
public static ulong EFI_HII_AIBT_OVERLAY_IMAGES = 0x10;
public static ulong EFI_HII_AIBT_CLEAR_IMAGES = 0x11;
public static ulong EFI_HII_AIBT_RESTORE_SCRN = 0x12;
public static ulong EFI_HII_AIBT_OVERLAY_IMAGES_LOOP = 0x18;
public static ulong EFI_HII_AIBT_CLEAR_IMAGES_LOOP = 0x19;
public static ulong EFI_HII_AIBT_RESTORE_SCRN_LOOP = 0x1A;
public static ulong EFI_HII_AIBT_DUPLICATE = 0x20;
public static ulong EFI_HII_AIBT_SKIP2 = 0x21;
public static ulong EFI_HII_AIBT_SKIP1 = 0x22;
public static ulong EFI_HII_AIBT_EXT1 = 0x30;
public static ulong EFI_HII_AIBT_EXT2 = 0x31;
public static ulong EFI_HII_AIBT_EXT4 = 0x32;
...
///
public static ulong STRING_TOKEN = (t)  t;

///
/// IMAGE_TOKEN is not defined in UEFI specification. But it is placed
/// here for the easy access by C files and VFR source files.
///
public static ulong IMAGE_TOKEN = (t)  t;
