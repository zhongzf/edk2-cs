...
//   IN  ulong                        MemoryMapSize,
//   IN  ulong                        DescriptorSize,
//   IN  uint                       DescriptorVersion,
...
public unsafe partial class EFI
{
  ...
  //   IN     char                      *VariableName,
  //   IN     EFI_GUID                    *VendorGuid,
  //   OUT    uint                      *Attributes     OPTIONAL,
  ...
  //   IN OUT ulong                    *VariableNameSize,
  //   IN OUT char                   *VariableName,
...
//   OUT ulong                       *ExitDataSize,
//   OUT char                      **ExitData    OPTIONAL
//   );
...
//   IN  ulong                        ExitDataSize,
//   IN  char                       *ExitData     OPTIONAL
//   );
...
//   IN ulong                    Timeout,
//   IN ulong                   WatchdogCode,
//   IN ulong                    DataSize,
//   IN char                   *WatchdogData OPTIONAL
//   );
...
public unsafe partial class EFI
{
  ...
  //   IN  uint            Attributes,
  //   OUT ulong            *MaximumVariableStorageSize,
  //   OUT ulong            *RemainingVariableStorageSize,
  //   OUT ulong            *MaximumVariableSize
  //   );
...
public unsafe struct EFI_RUNTIME_SERVICES
{
  ...
  // Time Services
  //
  public readonly delegate* unmanaged</* OUT */EFI_TIME* /*Time*/,/* OUT */EFI_TIME_CAPABILITIES* /*Capabilities*/, EFI_STATUS> /*EFI_GET_TIME*/ GetTime;
  public readonly delegate* unmanaged</* IN */EFI_TIME* /*Time*/, EFI_STATUS> /*EFI_SET_TIME*/ SetTime;
  public readonly delegate* unmanaged</* OUT */bool* /*Enabled*/,/* OUT */bool* /*Pending*/,/* OUT */EFI_TIME* /*Time*/, EFI_STATUS> /*EFI_GET_WAKEUP_TIME*/ GetWakeupTime;
  public readonly delegate* unmanaged</* IN */bool /*Enable*/,/* IN */EFI_TIME* /*Time*/, EFI_STATUS> /*EFI_SET_WAKEUP_TIME*/ SetWakeupTime;

  //
  // Virtual Memory Services
  //
  public readonly delegate* unmanaged</* IN */ulong /*MemoryMapSize*/,/* IN */ulong /*DescriptorSize*/,/* IN */uint /*DescriptorVersion*/,/* IN */EFI_MEMORY_DESCRIPTOR* /*VirtualMap*/, EFI_STATUS> /*EFI_SET_VIRTUAL_ADDRESS_MAP*/ SetVirtualAddressMap;
  public readonly delegate* unmanaged</* IN */ulong /*DebugDisposition*/,/* IN OUT */void** /*Address*/, EFI_STATUS> /*EFI_CONVERT_POINTER*/ ConvertPointer;

  //
  // Variable Services
  //
  public readonly delegate* unmanaged</* IN */char* /*VariableName*/,/* IN */EFI_GUID* /*VendorGuid*/,/* OUT */uint* /*Attributes*/,/* IN OUT */ulong* /*DataSize*/,/* OUT */void* /*Data*/, EFI_STATUS> /*EFI_GET_VARIABLE*/ GetVariable;
  public readonly delegate* unmanaged</* IN OUT */ulong* /*VariableNameSize*/,/* IN OUT */char* /*VariableName*/,/* IN OUT */EFI_GUID* /*VendorGuid*/, EFI_STATUS> /*EFI_GET_NEXT_VARIABLE_NAME*/ GetNextVariableName;
  public readonly delegate* unmanaged</* IN */char* /*VariableName*/,/* IN */EFI_GUID* /*VendorGuid*/,/* IN */uint /*Attributes*/,/* IN */ulong /*DataSize*/,/* IN */void* /*Data*/, EFI_STATUS> /*EFI_SET_VARIABLE*/ SetVariable;

  //
  // Miscellaneous Services
  //
  public readonly delegate* unmanaged</* OUT */uint* /*HighCount*/, EFI_STATUS> /*EFI_GET_NEXT_HIGH_MONO_COUNT*/ GetNextHighMonotonicCount;
  public readonly delegate* unmanaged</* IN */EFI_RESET_TYPE /*ResetType*/,/* IN */EFI_STATUS /*ResetStatus*/,/* IN */ulong /*DataSize*/,/* IN */void* /*ResetData*/, EFI_STATUS> /*EFI_RESET_SYSTEM*/ ResetSystem;

  //
  // UEFI 2.0 Capsule Services
  //
  public readonly delegate* unmanaged</* IN */EFI_CAPSULE_HEADER** /*CapsuleHeaderArray*/,/* IN */ulong /*CapsuleCount*/,/* IN */EFI_PHYSICAL_ADDRESS /*ScatterGatherList*/, EFI_STATUS> /*EFI_UPDATE_CAPSULE*/ UpdateCapsule;
  public readonly delegate* unmanaged</* IN */EFI_CAPSULE_HEADER** /*CapsuleHeaderArray*/,/* IN */ulong /*CapsuleCount*/,/* OUT */ulong* /*MaximumCapsuleSize*/,/* OUT */EFI_RESET_TYPE* /*ResetType*/, EFI_STATUS> /*EFI_QUERY_CAPSULE_CAPABILITIES*/ QueryCapsuleCapabilities;

  //
  // Miscellaneous UEFI 2.0 Service
  //
  public readonly delegate* unmanaged</* IN */uint /*Attributes*/,/* OUT */ulong* /*MaximumVariableStorageSize*/,/* OUT */ulong* /*RemainingVariableStorageSize*/,/* OUT */ulong* /*MaximumVariableSize*/, EFI_STATUS> /*EFI_QUERY_VARIABLE_INFO*/ QueryVariableInfo;
}
...
public unsafe struct EFI_BOOT_SERVICES
{
  ...
  //
  public readonly delegate* unmanaged</* IN */EFI_TPL /*NewTpl*/, EFI_STATUS> /*EFI_RAISE_TPL*/ RaiseTPL;
  public readonly delegate* unmanaged</* IN */EFI_TPL /*OldTpl*/, EFI_STATUS> /*EFI_RESTORE_TPL*/ RestoreTPL;

  //
  // Memory Services
  //
  public readonly delegate* unmanaged</* IN */EFI_ALLOCATE_TYPE /*Type*/,/* IN */EFI_MEMORY_TYPE /*MemoryType*/,/* IN */ulong /*Pages*/,/* IN OUT */EFI_PHYSICAL_ADDRESS* /*Memory*/, EFI_STATUS> /*EFI_ALLOCATE_PAGES*/ AllocatePages;
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*Memory*/,/* IN */ulong /*Pages*/, EFI_STATUS> /*EFI_FREE_PAGES*/ FreePages;
  public readonly delegate* unmanaged</* IN OUT */ulong* /*MemoryMapSize*/,/* OUT */EFI_MEMORY_DESCRIPTOR* /*MemoryMap*/,/* OUT */ulong* /*MapKey*/,/* OUT */ulong* /*DescriptorSize*/,/* OUT */uint* /*DescriptorVersion*/, EFI_STATUS> /*EFI_GET_MEMORY_MAP*/ GetMemoryMap;
  public readonly delegate* unmanaged</* IN */EFI_MEMORY_TYPE /*PoolType*/,/* IN */ulong /*Size*/,/* OUT */void** /*Buffer*/, EFI_STATUS> /*EFI_ALLOCATE_POOL*/ AllocatePool;
  public readonly delegate* unmanaged</* IN */void* /*Buffer*/, EFI_STATUS> /*EFI_FREE_POOL*/ FreePool;

  //
  // Event & Timer Services
  //
  public readonly delegate* unmanaged</* IN */uint /*Type*/,/* IN */EFI_TPL /*NotifyTpl*/,/* IN */delegate* unmanaged</* IN */EFI_EVENT /*Event*/,/* IN */void* /*Context*/, void> /*NotifyFunction*/,/* IN */void* /*NotifyContext*/,/* OUT */EFI_EVENT* /*Event*/, EFI_STATUS> /*EFI_CREATE_EVENT*/ CreateEvent;
  public readonly delegate* unmanaged</* IN */EFI_EVENT /*Event*/,/* IN */EFI_TIMER_DELAY /*Type*/,/* IN */ulong /*TriggerTime*/, EFI_STATUS> /*EFI_SET_TIMER*/ SetTimer;
  public readonly delegate* unmanaged</* IN */ulong /*NumberOfEvents*/,/* IN */EFI_EVENT* /*Event*/,/* OUT */ulong* /*Index*/, EFI_STATUS> /*EFI_WAIT_FOR_EVENT*/ WaitForEvent;
  public readonly delegate* unmanaged</* IN */EFI_EVENT /*Event*/, EFI_STATUS> /*EFI_SIGNAL_EVENT*/ SignalEvent;
  public readonly delegate* unmanaged</* IN */EFI_EVENT /*Event*/, EFI_STATUS> /*EFI_CLOSE_EVENT*/ CloseEvent;
  public readonly delegate* unmanaged</* IN */EFI_EVENT /*Event*/, EFI_STATUS> /*EFI_CHECK_EVENT*/ CheckEvent;

  //
  // Protocol Handler Services
  //
  public readonly delegate* unmanaged</* IN OUT */EFI_HANDLE* /*Handle*/,/* IN */EFI_GUID* /*Protocol*/,/* IN */EFI_INTERFACE_TYPE /*InterfaceType*/,/* IN */void* /*Interface*/, EFI_STATUS> /*EFI_INSTALL_PROTOCOL_INTERFACE*/ InstallProtocolInterface;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*Handle*/,/* IN */EFI_GUID* /*Protocol*/,/* IN */void* /*OldInterface*/,/* IN */void* /*NewInterface*/, EFI_STATUS> /*EFI_REINSTALL_PROTOCOL_INTERFACE*/ ReinstallProtocolInterface;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*Handle*/,/* IN */EFI_GUID* /*Protocol*/,/* IN */void* /*Interface*/, EFI_STATUS> /*EFI_UNINSTALL_PROTOCOL_INTERFACE*/ UninstallProtocolInterface;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*Handle*/,/* IN */EFI_GUID* /*Protocol*/,/* OUT */void** /*Interface*/, EFI_STATUS> /*EFI_HANDLE_PROTOCOL*/ HandleProtocol;
  public void* Reserved;
  public readonly delegate* unmanaged</* IN */EFI_GUID* /*Protocol*/,/* IN */EFI_EVENT /*Event*/,/* OUT */void** /*Registration*/, EFI_STATUS> /*EFI_REGISTER_PROTOCOL_NOTIFY*/ RegisterProtocolNotify;
  public readonly delegate* unmanaged</* IN */EFI_LOCATE_SEARCH_TYPE /*SearchType*/,/* IN */EFI_GUID* /*Protocol*/,/* IN */void* /*SearchKey*/,/* IN OUT */ulong* /*BufferSize*/,/* OUT */EFI_HANDLE* /*Buffer*/, EFI_STATUS> /*EFI_LOCATE_HANDLE*/ LocateHandle;
  public readonly delegate* unmanaged</* IN */EFI_GUID* /*Protocol*/,/* IN OUT */EFI_DEVICE_PATH_PROTOCOL** /*DevicePath*/,/* OUT */EFI_HANDLE* /*Device*/, EFI_STATUS> /*EFI_LOCATE_DEVICE_PATH*/ LocateDevicePath;
  public readonly delegate* unmanaged</* IN */EFI_GUID* /*Guid*/,/* IN */void* /*Table*/, EFI_STATUS> /*EFI_INSTALL_CONFIGURATION_TABLE*/ InstallConfigurationTable;

  //
  // Image Services
  //
  public readonly delegate* unmanaged</* IN */bool /*BootPolicy*/,/* IN */EFI_HANDLE /*ParentImageHandle*/,/* IN */EFI_DEVICE_PATH_PROTOCOL* /*DevicePath*/,/* IN */void* /*SourceBuffer*/,/* IN */ulong /*SourceSize*/,/* OUT */EFI_HANDLE* /*ImageHandle*/, EFI_STATUS> /*EFI_IMAGE_LOAD*/ LoadImage;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*ImageHandle*/,/* OUT */ulong* /*ExitDataSize*/,/* OUT */char** /*ExitData*/, EFI_STATUS> /*EFI_IMAGE_START*/ StartImage;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*ImageHandle*/,/* IN */EFI_STATUS /*ExitStatus*/,/* IN */ulong /*ExitDataSize*/,/* IN */char* /*ExitData*/, EFI_STATUS> /*EFI_EXIT*/ Exit;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*ImageHandle*/, EFI_STATUS> /*EFI_IMAGE_UNLOAD*/ UnloadImage;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*ImageHandle*/,/* IN */ulong /*MapKey*/, EFI_STATUS> /*EFI_EXIT_BOOT_SERVICES*/ ExitBootServices;

  //
  // Miscellaneous Services
  //
  public readonly delegate* unmanaged</* OUT */ulong* /*Count*/, EFI_STATUS> /*EFI_GET_NEXT_MONOTONIC_COUNT*/ GetNextMonotonicCount;
  public readonly delegate* unmanaged</* IN */ulong /*Microseconds*/, EFI_STATUS> /*EFI_STALL*/ Stall;
  public readonly delegate* unmanaged</* IN */ulong /*Timeout*/,/* IN */ulong /*WatchdogCode*/,/* IN */ulong /*DataSize*/,/* IN */char* /*WatchdogData*/, EFI_STATUS> /*EFI_SET_WATCHDOG_TIMER*/ SetWatchdogTimer;

  //
  // DriverSupport Services
  //
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*ControllerHandle*/,/* IN */EFI_HANDLE* /*DriverImageHandle*/,/* IN */EFI_DEVICE_PATH_PROTOCOL* /*RemainingDevicePath*/,/* IN */bool /*Recursive*/, EFI_STATUS> /*EFI_CONNECT_CONTROLLER*/ ConnectController;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*ControllerHandle*/,/* IN */EFI_HANDLE /*DriverImageHandle*/,/* IN */EFI_HANDLE /*ChildHandle*/, EFI_STATUS> /*EFI_DISCONNECT_CONTROLLER*/ DisconnectController;

  //
  // Open and Close Protocol Services
  //
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*Handle*/,/* IN */EFI_GUID* /*Protocol*/,/* OUT */void** /*Interface*/,/* IN */EFI_HANDLE /*AgentHandle*/,/* IN */EFI_HANDLE /*ControllerHandle*/,/* IN */uint /*Attributes*/, EFI_STATUS> /*EFI_OPEN_PROTOCOL*/ OpenProtocol;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*Handle*/,/* IN */EFI_GUID* /*Protocol*/,/* IN */EFI_HANDLE /*AgentHandle*/,/* IN */EFI_HANDLE /*ControllerHandle*/, EFI_STATUS> /*EFI_CLOSE_PROTOCOL*/ CloseProtocol;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*Handle*/,/* IN */EFI_GUID* /*Protocol*/,/* OUT */EFI_OPEN_PROTOCOL_INFORMATION_ENTRY** /*EntryBuffer*/,/* OUT */ulong* /*EntryCount*/, EFI_STATUS> /*EFI_OPEN_PROTOCOL_INFORMATION*/ OpenProtocolInformation;

  //
  // Library Services
  //
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*Handle*/,/* OUT */EFI_GUID*** /*ProtocolBuffer*/,/* OUT */ulong* /*ProtocolBufferCount*/, EFI_STATUS> /*EFI_PROTOCOLS_PER_HANDLE*/ ProtocolsPerHandle;
  public readonly delegate* unmanaged</* IN */EFI_LOCATE_SEARCH_TYPE /*SearchType*/,/* IN */EFI_GUID* /*Protocol*/,/* IN */void* /*SearchKey*/,/* OUT */ulong* /*NoHandles*/,/* OUT */EFI_HANDLE** /*Buffer*/, EFI_STATUS> /*EFI_LOCATE_HANDLE_BUFFER*/ LocateHandleBuffer;
  public readonly delegate* unmanaged</* IN */EFI_GUID* /*Protocol*/,/* IN */void* /*Registration*/,/* OUT */void** /*Interface*/, EFI_STATUS> /*EFI_LOCATE_PROTOCOL*/ LocateProtocol;
  public readonly delegate* unmanaged</* IN OUT */EFI_HANDLE* /*Handle*/, EFI_STATUS> /*EFI_INSTALL_MULTIPLE_PROTOCOL_INTERFACES*/ InstallMultipleProtocolInterfaces;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*Handle*/, EFI_STATUS> /*EFI_UNINSTALL_MULTIPLE_PROTOCOL_INTERFACES*/ UninstallMultipleProtocolInterfaces;

  //
  // 32-bit CRC Services
  //
  public readonly delegate* unmanaged</* IN */void* /*Data*/,/* IN */ulong /*DataSize*/,/* OUT */uint* /*Crc32*/, EFI_STATUS> /*EFI_CALCULATE_CRC32*/ CalculateCrc32;

  //
  // Miscellaneous Services
  //
  public readonly delegate* unmanaged</* IN */void* /*Destination*/,/* IN */void* /*Source*/,/* IN */ulong /*Length*/, EFI_STATUS> /*EFI_COPY_MEM*/ CopyMem;
  public readonly delegate* unmanaged</* IN */void* /*Buffer*/,/* IN */ulong /*Size*/,/* IN */byte /*Value*/, EFI_STATUS> /*EFI_SET_MEM*/ SetMem;
  public readonly delegate* unmanaged</* IN */uint /*Type*/,/* IN */EFI_TPL /*NotifyTpl*/,/* IN */delegate* unmanaged</* IN */EFI_EVENT /*Event*/,/* IN */void* /*Context*/, void> /*NotifyFunction*/,/* IN CONST */void* /*NotifyContext*/,/* IN CONST */EFI_GUID* /*EventGroup*/,/* OUT */EFI_EVENT* /*Event*/, EFI_STATUS> /*EFI_CREATE_EVENT_EX*/ CreateEventEx;
}
