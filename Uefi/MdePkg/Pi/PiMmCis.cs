...
public unsafe partial class EFI
{
  ...
  ///
  //public const ulong MM_MMST_SIGNATURE = SIGNATURE_32 ('S', 'M', 'S', 'T');
  ///
  /// The Management Mode System Table (MMST) revision is 1.6
  ///
  public const ulong MM_SPECIFICATION_MAJOR_REVISION = 1;
  public const ulong MM_SPECIFICATION_MINOR_REVISION = 60;
  public const ulong EFI_MM_SYSTEM_TABLE_REVISION = ((MM_SPECIFICATION_MAJOR_REVISION << 16) | (MM_SPECIFICATION_MINOR_REVISION));
  ...
  //   IN OUT ulong       *CommBufferSize  OPTIONAL
  //   );
...
public unsafe struct EFI_MM_ENTRY_CONTEXT
{
  public readonly delegate* unmanaged</* IN */delegate* unmanaged<void*, void> /*Procedure*/,/* IN */ulong /*CpuNumber*/,/* IN OUT */void* /*ProcArguments*/, EFI_STATUS> /*EFI_MM_STARTUP_THIS_AP*/ MmStartupThisAp;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_MM_SYSTEM_TABLE
{
  ///
  ...
  ///
  public char* MmFirmwareVendor;
  ///
  /// The particular revision of the firmware.
  ///
  public uint MmFirmwareRevision;

  public readonly delegate* unmanaged</* IN CONST */EFI_MM_SYSTEM_TABLE* /*SystemTable*/,/* IN CONST */EFI_GUID* /*Guid*/,/* IN */void* /*Table*/,/* IN */ulong /*TableSize*/, EFI_STATUS> /*EFI_MM_INSTALL_CONFIGURATION_TABLE*/ MmInstallConfigurationTable;

  ///
  /// I/O Service
  ///
  public EFI_MM_CPU_IO_PROTOCOL MmIo;

  ///
  /// Runtime memory services
  ///
  public EFI_ALLOCATE_POOL MmAllocatePool;
  public EFI_FREE_POOL MmFreePool;
  public EFI_ALLOCATE_PAGES MmAllocatePages;
  public EFI_FREE_PAGES MmFreePages;
  ...
  ///
  public EFI_CONFIGURATION_TABLE* MmConfigurationTable;

  ///
  /// Protocol services
  ///
  public EFI_INSTALL_PROTOCOL_INTERFACE MmInstallProtocolInterface;
  public EFI_UNINSTALL_PROTOCOL_INTERFACE MmUninstallProtocolInterface;
  public EFI_HANDLE_PROTOCOL MmHandleProtocol;
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID*,/* IN */delegate* unmanaged</* IN CONST */EFI_GUID* /*Protocol*/,/* IN */void* /*Interface*/,/* IN */EFI_HANDLE /*Handle*/, EFI_STATUS> /*Function*/,/* OUT */void** /*Registration*/, EFI_STATUS> /*EFI_MM_REGISTER_PROTOCOL_NOTIFY*/ MmRegisterProtocolNotify;
  public EFI_LOCATE_HANDLE MmLocateHandle;
  public EFI_LOCATE_PROTOCOL MmLocateProtocol;

  ///
  /// MMI Management functions
  ///
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID* /*HandlerType*/,/* IN CONST */void* /*Context*/,/* IN OUT */void* /*CommBuffer*/,/* IN OUT */ulong* /*CommBufferSize*/, EFI_STATUS> /*EFI_MM_INTERRUPT_MANAGE*/ MmiManage;
  public readonly delegate* unmanaged</* IN */delegate* unmanaged</* IN */EFI_HANDLE /*DispatchHandle*/,/* IN CONST */void* /*Context*/,/* IN OUT */void* /*CommBuffer*/,/* IN OUT */ulong* /*CommBufferSize*/, EFI_STATUS> /*Handler*/,/* IN CONST */EFI_GUID*,/* OUT */EFI_HANDLE* /*DispatchHandle*/, EFI_STATUS> /*EFI_MM_INTERRUPT_REGISTER*/ MmiHandlerRegister;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*DispatchHandle*/, EFI_STATUS> /*EFI_MM_INTERRUPT_UNREGISTER*/ MmiHandlerUnRegister;
}
