...
public unsafe struct EFI_PEI_FV_HANDLE { void* Value; public static implicit operator EFI_PEI_FV_HANDLE(void* value) => new EFI_PEI_FV_HANDLE() { Value = value }; public static implicit operator void*(EFI_PEI_FV_HANDLE value) => value.Value; }

///
/// The handles of EFI FFS.
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PEI_FILE_HANDLE { void* Value; public static implicit operator EFI_PEI_FILE_HANDLE(void* value) => new EFI_PEI_FILE_HANDLE() { Value = value }; public static implicit operator void*(EFI_PEI_FILE_HANDLE value) => value.Value; }
...
public unsafe partial class EFI
{
  ...
  //
  public const ulong EFI_PEI_PPI_DESCRIPTOR_PIC = 0x00000001;
  public const ulong EFI_PEI_PPI_DESCRIPTOR_PPI = 0x00000010;
  public const ulong EFI_PEI_PPI_DESCRIPTOR_NOTIFY_CALLBACK = 0x00000020;
  public const ulong EFI_PEI_PPI_DESCRIPTOR_NOTIFY_DISPATCH = 0x00000040;
  public const ulong EFI_PEI_PPI_DESCRIPTOR_NOTIFY_TYPES = 0x00000060;
  public const ulong EFI_PEI_PPI_DESCRIPTOR_TERMINATE_LIST = 0x80000000;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PEI_PPI_DESCRIPTOR
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PEI_NOTIFY_DESCRIPTOR
{
  ///
  ...
  ///
  public readonly delegate* unmanaged</* IN */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PEI_NOTIFY_DESCRIPTOR* /*NotifyDescriptor*/,/* IN */void* /*Ppi*/, EFI_STATUS> /*EFI_PEIM_NOTIFY_ENTRY_POINT*/ Notify;
}
...
public unsafe struct EFI_PEI_DESCRIPTOR
{
  ///
  /// The typedef structure of the notification descriptor.
  ///
  [FieldOffset(0)] public EFI_PEI_NOTIFY_DESCRIPTOR Notify;
  ///
  /// The typedef structure of the PPI descriptor.
  ///
  [FieldOffset(0)] public EFI_PEI_PPI_DESCRIPTOR Ppi;
}
...
//   IN CONST EFI_PEI_SERVICES            **PeiServices,
//   IN EFI_SECTION_TYPE                  SectionType,
//   IN ulong                             SectionInstance,
//   IN EFI_PEI_FILE_HANDLE               FileHandle,
//   OUT void                             **SectionData,
//   OUT uint                           *AuthenticationStatus
//   );
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_FV_FILE_INFO
{
  ///
  /// Name of the file.
  ///
  ...
  /// File type.
  ///
  public EFI_FV_FILETYPE FileType;
  ///
  /// Attributes of the file.
  ///
  public EFI_FV_FILE_ATTRIBUTES FileAttributes;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_FV_FILE_INFO2
{
  ///
  /// Name of the file.
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_FV_INFO
{
  ///
  /// Attributes of the firmware volume.
  ///
  public EFI_FVB_ATTRIBUTES_2 FvAttributes;
  ///
...
public unsafe partial class EFI
{
  ...
  //
  public const ulong PEI_SPECIFICATION_MAJOR_REVISION = 1;
  public const ulong PEI_SPECIFICATION_MINOR_REVISION = 70;
  ///
  ...
  // PEI Services Table
  //
  public const ulong PEI_SERVICES_SIGNATURE = 0x5652455320494550;
  ///
  /// Specification inconsistency here:
  /// In the PI1.0 specification, there is a typo error in PEI_SERVICES_REVISION. In the specification the defintion is
  //public const ulong  = ((PEI_SPECIFICATION_MAJOR_REVISION<<16) |(PEI_SPECIFICATION_MINOR_REVISION));
  /// and it should be as follows:
  ///
  public const ulong PEI_SERVICES_REVISION = ((PEI_SPECIFICATION_MAJOR_REVISION << 16) | (PEI_SPECIFICATION_MINOR_REVISION));
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_PEI_SERVICES
{
  ///
  ...
  // PPI Functions
  //
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN CONST */EFI_PEI_PPI_DESCRIPTOR* /*PpiList*/, EFI_STATUS> /*EFI_PEI_INSTALL_PPI*/ InstallPpi;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN CONST */EFI_PEI_PPI_DESCRIPTOR* /*OldPpi*/,/* IN CONST */EFI_PEI_PPI_DESCRIPTOR* /*NewPpi*/, EFI_STATUS> /*EFI_PEI_REINSTALL_PPI*/ ReInstallPpi;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN CONST */EFI_GUID* /*Guid*/,/* IN */ulong /*Instance*/,/* IN OUT */EFI_PEI_PPI_DESCRIPTOR** /*PpiDescriptor*/,/* IN OUT */void** /*Ppi*/, EFI_STATUS> /*EFI_PEI_LOCATE_PPI*/ LocatePpi;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN CONST */EFI_PEI_NOTIFY_DESCRIPTOR* /*NotifyList*/, EFI_STATUS> /*EFI_PEI_NOTIFY_PPI*/ NotifyPpi;

  //
  // Boot Mode Functions
  //
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* OUT */EFI_BOOT_MODE* /*BootMode*/, EFI_STATUS> /*EFI_PEI_GET_BOOT_MODE*/ GetBootMode;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_BOOT_MODE /*BootMode*/, EFI_STATUS> /*EFI_PEI_SET_BOOT_MODE*/ SetBootMode;

  //
  // HOB Functions
  //
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* OUT */void** /*HobList*/, EFI_STATUS> /*EFI_PEI_GET_HOB_LIST*/ GetHobList;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */ushort /*Type*/,/* IN */ushort /*Length*/,/* IN OUT */void** /*Hob*/, EFI_STATUS> /*EFI_PEI_CREATE_HOB*/ CreateHob;

  //
  // Firmware Volume Functions
  //
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */ulong /*Instance*/,/* OUT */EFI_PEI_FV_HANDLE* /*VolumeHandle*/, EFI_STATUS> /*EFI_PEI_FFS_FIND_NEXT_VOLUME2*/ FfsFindNextVolume;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_FV_FILETYPE /*SearchType*/,/* IN CONST */EFI_PEI_FV_HANDLE /*FvHandle*/,/* IN OUT */EFI_PEI_FILE_HANDLE* /*FileHandle*/, EFI_STATUS> /*EFI_PEI_FFS_FIND_NEXT_FILE2*/ FfsFindNextFile;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_SECTION_TYPE /*SectionType*/,/* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/,/* OUT */void** /*SectionData*/, EFI_STATUS> /*EFI_PEI_FFS_FIND_SECTION_DATA2*/ FfsFindSectionData;

  //
  // PEI Memory Functions
  //
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PHYSICAL_ADDRESS /*MemoryBegin*/,/* IN */ulong /*MemoryLength*/, EFI_STATUS> /*EFI_PEI_INSTALL_PEI_MEMORY*/ InstallPeiMemory;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_MEMORY_TYPE /*MemoryType*/,/* IN */ulong /*Pages*/,/* OUT */EFI_PHYSICAL_ADDRESS* /*Memory*/, EFI_STATUS> /*EFI_PEI_ALLOCATE_PAGES*/ AllocatePages;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */ulong /*Size*/,/* OUT */void** /*Buffer*/, EFI_STATUS> /*EFI_PEI_ALLOCATE_POOL*/ AllocatePool;
  public readonly delegate* unmanaged</* IN */void* /*Destination*/,/* IN */void* /*Source*/,/* IN */ulong /*Length*/, EFI_STATUS> /*EFI_PEI_COPY_MEM*/ CopyMem;
  public readonly delegate* unmanaged</* IN */void* /*Buffer*/,/* IN */ulong /*Size*/,/* IN */byte /*Value*/, EFI_STATUS> /*EFI_PEI_SET_MEM*/ SetMem;

  //
  // Status Code
  //
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_STATUS_CODE_TYPE /*Type*/,/* IN */EFI_STATUS_CODE_VALUE /*Value*/,/* IN */uint /*Instance*/,/* IN CONST */EFI_GUID* /*CallerId*/,/* IN CONST */EFI_STATUS_CODE_DATA* /*Data*/, EFI_STATUS> /*EFI_PEI_REPORT_STATUS_CODE*/ ReportStatusCode;

  //
  // Reset
  //
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/, EFI_STATUS> /*EFI_PEI_RESET_SYSTEM*/ ResetSystem;

  //
  // (the following interfaces are installed by publishing PEIM)
  // I/O Abstractions
  //
  public EFI_PEI_CPU_IO_PPI* CpuIo;
  public EFI_PEI_PCI_CFG2_PPI* PciCfg;

  //
  // Future Installed Services
  //
  public readonly delegate* unmanaged</* IN CONST */EFI_GUID*,/* IN */EFI_PEI_FV_HANDLE /*VolumeHandle*/,/* OUT */EFI_PEI_FILE_HANDLE* /*FileHandle*/, EFI_STATUS> /*EFI_PEI_FFS_FIND_BY_NAME*/ FfsFindFileByName;
  public readonly delegate* unmanaged</* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/,/* OUT */EFI_FV_FILE_INFO* /*FileInfo*/, EFI_STATUS> /*EFI_PEI_FFS_GET_FILE_INFO*/ FfsGetFileInfo;
  public readonly delegate* unmanaged</* IN */EFI_PEI_FV_HANDLE /*VolumeHandle*/,/* OUT */EFI_FV_INFO* /*VolumeInfo*/, EFI_STATUS> /*EFI_PEI_FFS_GET_VOLUME_INFO*/ FfsGetVolumeInfo;
  public readonly delegate* unmanaged</* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/, EFI_STATUS> /*EFI_PEI_REGISTER_FOR_SHADOW*/ RegisterForShadow;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_SECTION_TYPE /*SectionType*/,/* IN */ulong /*SectionInstance*/,/* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/,/* OUT */void** /*SectionData*/,/* OUT */uint* /*AuthenticationStatus*/, EFI_STATUS> /*EFI_PEI_FFS_FIND_SECTION_DATA3*/ FindSectionData3;
  public readonly delegate* unmanaged</* IN */EFI_PEI_FILE_HANDLE /*FileHandle*/,/* OUT */EFI_FV_FILE_INFO2* /*FileInfo*/, EFI_STATUS> /*EFI_PEI_FFS_GET_FILE_INFO2*/ FfsGetFileInfo2;
  public readonly delegate* unmanaged</* IN */EFI_RESET_TYPE /*ResetType*/,/* IN */EFI_STATUS /*ResetStatus*/,/* IN */ulong /*DataSize*/,/* IN */void* /*ResetData*/, EFI_STATUS> /*EFI_PEI_RESET2_SYSTEM*/ ResetSystem2;
  public readonly delegate* unmanaged</* IN CONST */EFI_PEI_SERVICES** /*PeiServices*/,/* IN */EFI_PHYSICAL_ADDRESS /*Memory*/,/* IN */ulong /*Pages*/, EFI_STATUS> /*EFI_PEI_FREE_PAGES*/ FreePages;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_SEC_PEI_HAND_OFF
{
  ///
  ...
  /// PEI modules.
  ///
  public void* BootFirmwareVolumeBase;

  ///
  /// Size of the boot firmware volume, in bytes.
  ///
  public ulong BootFirmwareVolumeSize;

  ///
  /// Points to the first byte of the temporary RAM.
  ///
  public void* TemporaryRamBase;

  ///
  /// Size of the temporary RAM, in bytes.
  ///
  public ulong TemporaryRamSize;
