...
public unsafe partial class EFI
{
  ...
  ///
  public const ulong I2C_ADDRESSING_10_BIT = 0x80000000;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_I2C_DEVICE
{
  ///
...
public unsafe partial class EFI
{
  ...
  public const ulong I2C_FLAG_READ = 0x00000001;
  ...
  /// SMBus operation
  public const ulong I2C_FLAG_SMBUS_OPERATION = 0x00010000;
  ...
  ///   optional PEC value.
  public const ulong I2C_FLAG_SMBUS_BLOCK = 0x00020000;

  /// SMBus process call operation
  public const ulong I2C_FLAG_SMBUS_PROCESS_CALL = 0x00040000;
  ...
  ///
  public const ulong I2C_FLAG_SMBUS_PEC = 0x00080000;
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_I2C_OPERATION
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_I2C_REQUEST_PACKET
{
  ///
  ...
  ///
  public EFI_I2C_OPERATION[/*1*/] Operation;
}
