...
///
public enum EFI_GCD_MEMORY_TYPE
{
  ///
...
///
public enum EFI_GCD_ALLOCATE_TYPE
{
  ///
...
public unsafe struct EFI_GCD_MEMORY_SPACE_DESCRIPTOR
{
  ///
  ...
  ///
  public EFI_GCD_MEMORY_TYPE GcdMemoryType;
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_GCD_IO_SPACE_DESCRIPTOR
{
  ///
  ...
  ///
  public EFI_GCD_IO_TYPE GcdIoType;
...
public unsafe partial class EFI
{
  ...
  // DXE Services Table
  //
  public const ulong DXE_SERVICES_SIGNATURE = 0x565245535f455844;
  public const ulong DXE_SPECIFICATION_MAJOR_REVISION = 1;
  public const ulong DXE_SPECIFICATION_MINOR_REVISION = 70;
  public const ulong DXE_SERVICES_REVISION = ((DXE_SPECIFICATION_MAJOR_REVISION << 16) | (DXE_SPECIFICATION_MINOR_REVISION));
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct DXE_SERVICES
{
  ///
  ...
  //
  public readonly delegate* unmanaged</* IN */EFI_GCD_MEMORY_TYPE /*GcdMemoryType*/,/* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* IN */ulong /*Length*/,/* IN */ulong /*Capabilities*/, EFI_STATUS> /*EFI_ADD_MEMORY_SPACE*/ AddMemorySpace;
  public readonly delegate* unmanaged</* IN */EFI_GCD_ALLOCATE_TYPE /*GcdAllocateType*/,/* IN */EFI_GCD_MEMORY_TYPE /*GcdMemoryType*/,/* IN */ulong /*Alignment*/,/* IN */ulong /*Length*/,/* IN OUT */EFI_PHYSICAL_ADDRESS* /*BaseAddress*/,/* IN */EFI_HANDLE /*ImageHandle*/,/* IN */EFI_HANDLE /*DeviceHandle*/, EFI_STATUS> /*EFI_ALLOCATE_MEMORY_SPACE*/ AllocateMemorySpace;
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* IN */ulong /*Length*/, EFI_STATUS> /*EFI_FREE_MEMORY_SPACE*/ FreeMemorySpace;
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* IN */ulong /*Length*/, EFI_STATUS> /*EFI_REMOVE_MEMORY_SPACE*/ RemoveMemorySpace;
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* OUT */EFI_GCD_MEMORY_SPACE_DESCRIPTOR* /*Descriptor*/, EFI_STATUS> /*EFI_GET_MEMORY_SPACE_DESCRIPTOR*/ GetMemorySpaceDescriptor;
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* IN */ulong /*Length*/,/* IN */ulong /*Attributes*/, EFI_STATUS> /*EFI_SET_MEMORY_SPACE_ATTRIBUTES*/ SetMemorySpaceAttributes;
  public readonly delegate* unmanaged</* OUT */ulong* /*NumberOfDescriptors*/,/* OUT */EFI_GCD_MEMORY_SPACE_DESCRIPTOR** /*MemorySpaceMap*/, EFI_STATUS> /*EFI_GET_MEMORY_SPACE_MAP*/ GetMemorySpaceMap;
  public readonly delegate* unmanaged</* IN */EFI_GCD_IO_TYPE /*GcdIoType*/,/* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* IN */ulong /*Length*/, EFI_STATUS> /*EFI_ADD_IO_SPACE*/ AddIoSpace;
  public readonly delegate* unmanaged</* IN */EFI_GCD_ALLOCATE_TYPE /*GcdAllocateType*/,/* IN */EFI_GCD_IO_TYPE /*GcdIoType*/,/* IN */ulong /*Alignment*/,/* IN */ulong /*Length*/,/* IN OUT */EFI_PHYSICAL_ADDRESS* /*BaseAddress*/,/* IN */EFI_HANDLE /*ImageHandle*/,/* IN */EFI_HANDLE /*DeviceHandle*/, EFI_STATUS> /*EFI_ALLOCATE_IO_SPACE*/ AllocateIoSpace;
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* IN */ulong /*Length*/, EFI_STATUS> /*EFI_FREE_IO_SPACE*/ FreeIoSpace;
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* IN */ulong /*Length*/, EFI_STATUS> /*EFI_REMOVE_IO_SPACE*/ RemoveIoSpace;
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* OUT */EFI_GCD_IO_SPACE_DESCRIPTOR* /*Descriptor*/, EFI_STATUS> /*EFI_GET_IO_SPACE_DESCRIPTOR*/ GetIoSpaceDescriptor;
  public readonly delegate* unmanaged</* OUT */ulong* /*NumberOfDescriptors*/,/* OUT */EFI_GCD_IO_SPACE_DESCRIPTOR** /*IoSpaceMap*/, EFI_STATUS> /*EFI_GET_IO_SPACE_MAP*/ GetIoSpaceMap;

  //
  // Dispatcher Services
  //
  public readonly delegate* unmanaged<EFI_STATUS> /*EFI_DISPATCH*/ Dispatch;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*FirmwareVolumeHandle*/,/* IN CONST */EFI_GUID* /*FileName*/, EFI_STATUS> /*EFI_SCHEDULE*/ Schedule;
  public readonly delegate* unmanaged</* IN */EFI_HANDLE /*FirmwareVolumeHandle*/,/* IN CONST */EFI_GUID* /*FileName*/, EFI_STATUS> /*EFI_TRUST*/ Trust;
  //
  // Service to process a single firmware volume found in a capsule
  //
  public readonly delegate* unmanaged</* IN CONST */void* /*FirmwareVolumeHeader*/,/* IN */ulong /*Size*/,/* OUT */EFI_HANDLE* /*FirmwareVolumeHandle*/, EFI_STATUS> /*EFI_PROCESS_FIRMWARE_VOLUME*/ ProcessFirmwareVolume;
  //
  // Extensions to Global Coherency Domain Services
  //
  public readonly delegate* unmanaged</* IN */EFI_PHYSICAL_ADDRESS /*BaseAddress*/,/* IN */ulong /*Length*/,/* IN */ulong /*Capabilities*/, EFI_STATUS> /*EFI_SET_MEMORY_SPACE_CAPABILITIES*/ SetMemorySpaceCapabilities;
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DXE_SERVICES { DXE_SERVICES Value; public static implicit operator EFI_DXE_SERVICES(DXE_SERVICES value) => new EFI_DXE_SERVICES() { Value = value }; public static implicit operator DXE_SERVICES(EFI_DXE_SERVICES value) => value.Value; }
