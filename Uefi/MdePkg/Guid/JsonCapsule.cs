...
public unsafe partial class EFI
{
  ...
  //
  public static EFI_GUID EFI_JSON_CONFIG_DATA_TABLE_GUID => new GUID(0x87367f87, 0x1119, 0x41ce,
      0xaa, 0xec, 0x8b, 0xe0, 0x11, 0x1f, 0x55, 0x8a);
  public static EFI_GUID EFI_JSON_CAPSULE_DATA_TABLE_GUID => new GUID(0x35e7a725, 0x8dd2, 0x4cac,
      0x80, 0x11, 0x33, 0xcd, 0xa8, 0x10, 0x90, 0x56);
  public static EFI_GUID EFI_JSON_CAPSULE_RESULT_TABLE_GUID => new GUID(0xdbc461c3, 0xb3de, 0x422a,
      0xb9, 0xb4, 0x98, 0x86, 0xfd, 0x49, 0xa1, 0xe5);
  public static EFI_GUID EFI_JSON_CAPSULE_ID_GUID => new GUID(0x67d6f4cd, 0xd6b8, 0x4573,
...
public unsafe struct EFI_JSON_CAPSULE_HEADER
{
  ///
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_JSON_CONFIG_DATA_ITEM
{
  ///
  /// The length of the following ConfigData, in bytes.
  ///
  public uint ConfigDataLength;
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_JSON_CAPSULE_CONFIG_DATA
{
  ///
  /// Version of the structure, initially 0x00000001.
  ///
  ...
  ///
  public EFI_JSON_CONFIG_DATA_ITEM[] ConfigDataList;
}
