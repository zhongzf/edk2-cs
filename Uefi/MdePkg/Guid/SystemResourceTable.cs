...
{
  public static EFI_GUID EFI_SYSTEM_RESOURCE_TABLE_GUID => new GUID(
      0xb122a263, 0x3661, 0x4f68, 0x99, 0x29, 0x78, 0xf8, 0xb0, 0xd6, 0x21, 0x80);

  ///
  /// Current Entry Version
  ///
  public const ulong EFI_SYSTEM_RESOURCE_TABLE_FIRMWARE_RESOURCE_VERSION = 1;

  ///
  /// Firmware Type Definitions
  ///
  public const ulong ESRT_FW_TYPE_UNKNOWN = 0x00000000;
  public const ulong ESRT_FW_TYPE_SYSTEMFIRMWARE = 0x00000001;
  public const ulong ESRT_FW_TYPE_DEVICEFIRMWARE = 0x00000002;
  public const ulong ESRT_FW_TYPE_UEFIDRIVER = 0x00000003;

  ///
  /// Last Attempt Status Values
  ///
  public const ulong LAST_ATTEMPT_STATUS_SUCCESS = 0x00000000;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_UNSUCCESSFUL = 0x00000001;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_INSUFFICIENT_RESOURCES = 0x00000002;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_INCORRECT_VERSION = 0x00000003;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_INVALID_FORMAT = 0x00000004;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_AUTH_ERROR = 0x00000005;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_PWR_EVT_AC = 0x00000006;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_PWR_EVT_BATT = 0x00000007;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_UNSATISFIED_DEPENDENCIES = 0x00000008;
  ...
  /// removed.
  ///
  public const ulong LAST_ATTEMPT_STATUS_ERROR_UNSUCCESSFUL_VENDOR_RANGE_MIN = 0x00001000;
  public const ulong LAST_ATTEMPT_STATUS_ERROR_UNSUCCESSFUL_VENDOR_RANGE_MAX = 0x00003FFF;
}

[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_SYSTEM_RESOURCE_ENTRY
{
  ///
  ...
  ///
  public uint LowestSupportedFwVersion;
  ///
