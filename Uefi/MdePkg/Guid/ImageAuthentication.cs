...
{
  public static EFI_GUID EFI_IMAGE_SECURITY_DATABASE_GUID => new GUID(
  ...
  ///
  public const string EFI_IMAGE_SECURITY_DATABASE = "db";
  ///
  /// Varialbe name with guid EFI_IMAGE_SECURITY_DATABASE_GUID
  /// for the forbidden signature database.
  ///
  public const string EFI_IMAGE_SECURITY_DATABASE1 = "dbx";
  ///
  /// Variable name with guid EFI_IMAGE_SECURITY_DATABASE_GUID
  /// for the timestamp signature database.
  ///
  public const string EFI_IMAGE_SECURITY_DATABASE2 = "dbt";

  public const ulong SECURE_BOOT_MODE_ENABLE = 1;
  public const ulong SECURE_BOOT_MODE_DISABLE = 0;

  public const ulong SETUP_MODE = 1;
  public const ulong USER_MODE = 0;
...
public unsafe struct EFI_SIGNATURE_DATA
{
  ///
  /// An identifier which identifies the agent which added the signature to the list.
  ///
  public EFI_GUID SignatureOwner;
  ///
  /// The format of the signature is defined by the SignatureType.
  ///
  public fixed byte SignatureData[1];
}
...
//[StructLayout(LayoutKind.Sequential)]
//public unsafe struct EFI_CERT_X509_SHA256
//{
//  ///
//  /// The SHA256 hash of an X.509 certificate's To-Be-Signed contents.
//  ///
//  public EFI_SHA256_HASH ToBeSignedHash;
//  ///
//  /// The time that the certificate shall be considered to be revoked.
//  ///
//  public EFI_TIME TimeOfRevocation;
//}

//[StructLayout(LayoutKind.Sequential)]
//public unsafe struct EFI_CERT_X509_SHA384
//{
//  ///
//  /// The SHA384 hash of an X.509 certificate's To-Be-Signed contents.
//  ///
//  public EFI_SHA384_HASH ToBeSignedHash;
//  ///
//  /// The time that the certificate shall be considered to be revoked.
//  ///
//  public EFI_TIME TimeOfRevocation;
...
//[StructLayout(LayoutKind.Sequential)]
//public unsafe struct EFI_CERT_X509_SHA512
//{
//  ///
//  /// The SHA512 hash of an X.509 certificate's To-Be-Signed contents.
//  ///
//  public EFI_SHA512_HASH ToBeSignedHash;
//  ///
//  /// The time that the certificate shall be considered to be revoked.
//  ///
//  public EFI_TIME TimeOfRevocation;
...
public unsafe partial class EFI
{
  ...
  /// 32 bytes.
  ///
  public static EFI_GUID EFI_CERT_SHA256_GUID => new GUID(
  ...
  ///
  public static EFI_GUID EFI_CERT_RSA2048_GUID => new GUID(
  ...
  ///
  public static EFI_GUID EFI_CERT_RSA2048_SHA256_GUID => new GUID(
  ...
  ///
  public static EFI_GUID EFI_CERT_SHA1_GUID => new GUID(
  ...
  /// SignatureOwner component) + 256 bytes.
  ///
  public static EFI_GUID EFI_CERT_RSA2048_SHA1_GUID => new GUID(
  ...
  ///
  public static EFI_GUID EFI_CERT_X509_GUID => new GUID(
  ...
  /// 28 bytes.
  ///
  public static EFI_GUID EFI_CERT_SHA224_GUID => new GUID(
  ...
  /// 48 bytes.
  ///
  public static EFI_GUID EFI_CERT_SHA384_GUID => new GUID(
  ...
  /// 64 bytes.
  ///
  public static EFI_GUID EFI_CERT_SHA512_GUID => new GUID(
  ...
  ///
  public static EFI_GUID EFI_CERT_X509_SHA256_GUID => new GUID(
  ...
  /// otherwise the certificate shall be considered to always be revoked.
  ///
  public static EFI_GUID EFI_CERT_X509_SHA384_GUID => new GUID(
  ...
  /// otherwise the certificate shall be considered to always be revoked.
  ///
  public static EFI_GUID EFI_CERT_X509_SHA512_GUID => new GUID(
  ...
  /// SignedData value.
  ///
  public static EFI_GUID EFI_CERT_TYPE_PKCS7_GUID => new GUID(
...
// ***********************************************************************
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_IMAGE_EXECUTION_ACTION { uint Value; public static implicit operator EFI_IMAGE_EXECUTION_ACTION(uint value) => new EFI_IMAGE_EXECUTION_ACTION() { Value = value }; public static implicit operator uint(EFI_IMAGE_EXECUTION_ACTION value) => value.Value; }

public unsafe partial class EFI
{
  public const ulong EFI_IMAGE_EXECUTION_AUTHENTICATION = 0x00000007;
  public const ulong EFI_IMAGE_EXECUTION_AUTH_UNTESTED = 0x00000000;
  public const ulong EFI_IMAGE_EXECUTION_AUTH_SIG_FAILED = 0x00000001;
  public const ulong EFI_IMAGE_EXECUTION_AUTH_SIG_PASSED = 0x00000002;
  public const ulong EFI_IMAGE_EXECUTION_AUTH_SIG_NOT_FOUND = 0x00000003;
  public const ulong EFI_IMAGE_EXECUTION_AUTH_SIG_FOUND = 0x00000004;
  public const ulong EFI_IMAGE_EXECUTION_POLICY_FAILED = 0x00000005;
  public const ulong EFI_IMAGE_EXECUTION_INITIALIZED = 0x00000008;
}
...
//
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_IMAGE_EXECUTION_INFO
{
  ///
  /// Describes the action taken by the firmware regarding this image.
  ///
  public EFI_IMAGE_EXECUTION_ACTION Action;
  ///
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_IMAGE_EXECUTION_INFO_TABLE
{
  ///
  /// Number of EFI_IMAGE_EXECUTION_INFO structures.
  ///
  public ulong NumberOfImages;
  ///
