...
public unsafe partial class EFI
{
  ...
  ///
  public static EFI_GUID EFI_STATUS_CODE_DATA_TYPE_STRING_GUID => new GUID(0x92D11080, 0x496F, 0x4D95, 0xBE, 0x7E, 0x03, 0x74, 0x88, 0x38, 0x2B, 0x0A);
}

public enum EFI_STRING_TYPE
{
  ///
...
public unsafe struct EFI_STATUS_CODE_STRING_TOKEN
{
  ///
  ...
  ///
  public EFI_STRING_ID Token;
}

[StructLayout(LayoutKind.Explicit)]
public unsafe struct EFI_STATUS_CODE_STRING
{
  ///
  /// ASCII formatted string.
  ///
  [FieldOffset(0)] public byte* Ascii;
  ///
  /// Unicode formatted string.
  ///
  [FieldOffset(0)] public char* Unicode;
  ///
  /// HII handle/token pair.
  ///
  [FieldOffset(0)] public EFI_STATUS_CODE_STRING_TOKEN Hii;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_STATUS_CODE_STRING_DATA
{
  ///
...
public unsafe partial class EFI
{
  ...
  ///
  public static EFI_GUID EFI_STATUS_CODE_SPECIFIC_DATA_GUID => new GUID(0x335984bd, 0xe805, 0x409a, 0xb8, 0xf8, 0xd2, 0x7e, 0xce, 0x5f, 0xf7, 0xa6);
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DEVICE_PATH_EXTENDED_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DEVICE_HANDLE_EXTENDED_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_RESOURCE_ALLOC_FAILURE_ERROR_DATA
{
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_EXP_BASE10_DATA
{
  ///
  /// The short number by which to multiply the base-2 representation.
  ///
  public short Value;
  ///
  /// The short number by which to raise the base-2 calculation.
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_COMPUTING_UNIT_VOLTAGE_ERROR_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  ///
  public EFI_EXP_BASE10_DATA Voltage;
  ///
  /// The voltage threshold.
  ///
  public EFI_EXP_BASE10_DATA Threshold;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_COMPUTING_UNIT_MICROCODE_UPDATE_ERROR_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_COMPUTING_UNIT_TIMER_EXPIRED_ERROR_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  ///
  public EFI_EXP_BASE10_DATA TimerLimit;
}
...
public unsafe partial class EFI
{
  ...
  ///
  ///@{
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_SPEED = 0x0001;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_FSB_SPEED = 0x0002;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_FAMILY = 0x0004;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_MODEL = 0x0008;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_STEPPING = 0x0010;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_CACHE_SIZE = 0x0020;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_OEM1 = 0x1000;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_OEM2 = 0x2000;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_OEM3 = 0x4000;
  public const ulong EFI_COMPUTING_UNIT_MISMATCH_OEM4 = 0x8000;
  ///@}
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_HOST_PROCESSOR_MISMATCH_ERROR_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_COMPUTING_UNIT_THERMAL_ERROR_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  ///
  public EFI_EXP_BASE10_DATA Temperature;
  ///
...
///
public enum EFI_INIT_CACHE_TYPE
{
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_CACHE_INIT_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  /// The type of cache.
  ///
  public EFI_INIT_CACHE_TYPE Type;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_CPU_STATE_CHANGE_CAUSE { uint Value; public static implicit operator EFI_CPU_STATE_CHANGE_CAUSE(uint value) => new EFI_CPU_STATE_CHANGE_CAUSE() { Value = value }; public static implicit operator uint(EFI_CPU_STATE_CHANGE_CAUSE value) => value.Value; }
...
public unsafe partial class EFI
{
  ...
  ///
  ///@{
  public const ulong EFI_CPU_CAUSE_INTERNAL_ERROR = 0x0001;
  public const ulong EFI_CPU_CAUSE_THERMAL_ERROR = 0x0002;
  public const ulong EFI_CPU_CAUSE_SELFTEST_FAILURE = 0x0004;
  public const ulong EFI_CPU_CAUSE_PREBOOT_TIMEOUT = 0x0008;
  public const ulong EFI_CPU_CAUSE_FAILED_TO_START = 0x0010;
  public const ulong EFI_CPU_CAUSE_CONFIG_ERROR = 0x0020;
  public const ulong EFI_CPU_CAUSE_USER_SELECTION = 0x0080;
  public const ulong EFI_CPU_CAUSE_BY_ASSOCIATION = 0x0100;
  public const ulong EFI_CPU_CAUSE_UNSPECIFIED = 0x8000;
  ///@}
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_COMPUTING_UNIT_CPU_DISABLED_ERROR_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_MEMORY_ERROR_GRANULARITY { byte Value; public static implicit operator EFI_MEMORY_ERROR_GRANULARITY(byte value) => new EFI_MEMORY_ERROR_GRANULARITY() { Value = value }; public static implicit operator byte(EFI_MEMORY_ERROR_GRANULARITY value) => value.Value; }
...
public unsafe partial class EFI
{
  ...
  ///
  ///@{
  public const ulong EFI_MEMORY_ERROR_OTHER = 0x01;
  public const ulong EFI_MEMORY_ERROR_UNKNOWN = 0x02;
  public const ulong EFI_MEMORY_ERROR_DEVICE = 0x03;
  public const ulong EFI_MEMORY_ERROR_PARTITION = 0x04;
  ///@}
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_MEMORY_ERROR_OPERATION { byte Value; public static implicit operator EFI_MEMORY_ERROR_OPERATION(byte value) => new EFI_MEMORY_ERROR_OPERATION() { Value = value }; public static implicit operator byte(EFI_MEMORY_ERROR_OPERATION value) => value.Value; }
...
public unsafe partial class EFI
{
  ...
  ///
  ///@{
  public const ulong EFI_MEMORY_OPERATION_OTHER = 0x01;
  public const ulong EFI_MEMORY_OPERATION_UNKNOWN = 0x02;
  public const ulong EFI_MEMORY_OPERATION_READ = 0x03;
  public const ulong EFI_MEMORY_OPERATION_WRITE = 0x04;
  public const ulong EFI_MEMORY_OPERATION_PARTIAL_WRITE = 0x05;
  ///@}
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_MEMORY_EXTENDED_ERROR_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  ///
  public EFI_MEMORY_ERROR_GRANULARITY Granularity;
  ///
  /// The operation that resulted in the error being detected.
  ///
  public EFI_MEMORY_ERROR_OPERATION Operation;
  ///
  ...
  ///
  public EFI_PHYSICAL_ADDRESS Address;
  ///
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_STATUS_CODE_DIMM_NUMBER
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_MEMORY_MODULE_MISMATCH_ERROR_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  ///
  public EFI_STATUS_CODE_DIMM_NUMBER Instance;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_MEMORY_RANGE_EXTENDED_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  ///
  public EFI_PHYSICAL_ADDRESS Start;
  ///
  /// The length in bytes of the memory range.
  ///
  public EFI_PHYSICAL_ADDRESS Length;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_DEBUG_ASSERT_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  ///
  public EFI_STATUS_CODE_STRING_DATA* FileName;
}
...
///
[StructLayout(LayoutKind.Explicit)]
public unsafe struct EFI_STATUS_CODE_EXCEP_SYSTEM_CONTEXT
{
  /////
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_STATUS_CODE_EXCEP_EXTENDED_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  /// The system context.
  ///
  public EFI_STATUS_CODE_EXCEP_SYSTEM_CONTEXT Context;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_STATUS_CODE_START_EXTENDED_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_LEGACY_OPROM_EXTENDED_DATA
{
  ///
  /// The data header identifying the data. DataHeader.HeaderSize should be
  /// sizeof (EFI_STATUS_CODE_DATA), DataHeader.Size should be
  ...
  ///
  public EFI_PHYSICAL_ADDRESS RomImageBase;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct EFI_RETURN_STATUS_EXTENDED_DATA
{
  ///
  ...
  ///
  public EFI_STATUS ReturnStatus;
}
