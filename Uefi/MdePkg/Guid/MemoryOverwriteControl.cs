...
{
  public static EFI_GUID MEMORY_ONLY_RESET_CONTROL_GUID => new GUID(
  ...
  ///
  public const string MEMORY_OVERWRITE_REQUEST_VARIABLE_NAME = "MemoryOverwriteRequestControl";

  ///
  /// 0 = Firmware MUST clear the MOR bit
  /// 1 = Firmware MUST set the MOR bit
  ///
  public const ulong MOR_CLEAR_MEMORY_BIT_MASK = 0x01;
  ...
  ///
  public const ulong MOR_DISABLEAUTODETECT_BIT_MASK = 0x10;

  ///
  /// MOR field bit offset
  ///
  public const ulong MOR_CLEAR_MEMORY_BIT_OFFSET = 0;
  public const ulong MOR_DISABLEAUTODETECT_BIT_OFFSET = 4;
  ...
  **/
  //public const ulong MOR_CLEAR_MEMORY_VALUE = (mor)(((byte)(mor) & MOR_CLEAR_MEMORY_BIT_MASK) >> MOR_CLEAR_MEMORY_BIT_OFFSET);
  ...
  **/
  //public const ulong MOR_DISABLE_AUTO_DETECT_VALUE = (mor)(((byte)(mor) & MOR_DISABLEAUTODETECT_BIT_MASK) >> MOR_DISABLEAUTODETECT_BIT_OFFSET);
